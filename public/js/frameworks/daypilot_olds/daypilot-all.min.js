...
if(typeof DayPilot==='undefined'){var DayPilot={};};if(typeof DayPilot.Global==='undefined'){DayPilot.Global={};};if(typeof DayPilotNavigator==='undefined'){var DayPilotNavigator=DayPilot.NavigatorVisible={};};(function(){if(typeof DayPilot.Navigator!=='undefined'){return;};DayPilotNavigator={};DayPilot.Navigator=function(id,$a){this.v='1925';var $b=this;this.id=id;this.api=2;this.isNavigator=true;this.weekStarts='Auto';this.selectMode='day';this.titleHeight=20;this.dayHeaderHeight=20;this.cellWidth=20;this.cellHeight=20;this.cssOnly=true;this.cssClassPrefix="navigator_default";this.selectionStart=new DayPilot.Date().getDatePart();this.selectionEnd=null;this.selectionDay=null;this.showMonths=1;this.skipMonths=1;this.command="navigate";this.year=new DayPilot.Date().getYear();this.month=new DayPilot.Date().getMonth()+1;this.showWeekNumbers=false;this.weekNumberAlgorithm='Auto';this.rowsPerMonth='Six';this.orientation="Vertical";this.locale="en-us";this.visible=true;this.timeRangeSelectedHandling="Bind";this.visibleRangeChangedHandling="Enabled";this.nav={};this.$0j={};this.$0k=function(){this.root.dp=this;if(this.cssOnly){this.root.className=this.$0l('_main');}else{this.root.className=this.$0l('main');};if(this.orientation==="Horizontal"){this.root.style.width=this.showMonths*($c.cellWidth()*7+this.$0m())+'px';this.root.style.height=(this.cellHeight*6+this.titleHeight+this.dayHeaderHeight)+'px';}else{this.root.style.width=($c.cellWidth()*7+this.$0m())+'px';};this.root.style.position="relative";if(!this.visible){this.root.style.display="none";};var $d=document.createElement("input");$d.type='hidden';$d.name=$b.id+"_state";$d.id=$d.name;this.root.appendChild($d);this.state=$d;if(!this.startDate){this.startDate=DayPilot.Date.fromYearMonthDay(this.year,this.month);}else{this.startDate=new DayPilot.Date(this.startDate).firstDayOfMonth();};this.calendars=[];this.selected=[];this.months=[];};this.$0n=function(){return $b.api===2;};this.$0o=function(){this.root.innerHTML='';};this.$0l=function($e){var $f=this.theme||this.cssClassPrefix;if($f){return $f+$e;}else{return "";}};this.$0p=function($g,name){var $h=this.cssOnly?this.$0l("_"+name):this.$0l(name);DayPilot.Util.addClass($g,$h);};this.$0q=function($g,name){var $h=this.cssOnly?this.$0l("_"+name):this.$0l(name);DayPilot.Util.removeClass($g,$h);};this.$0r=function(j,$i){var $j={};$j.cells=[];$j.days=[];$j.weeks=[];var $k=this.startDate.addMonths(j);var $l=$i.before;var $m=$i.after;var $n=$k.firstDayOfMonth();var $o=$n.firstDayOfWeek($c.weekStarts());var $p=$n.addMonths(1);var $q=DayPilot.DateUtil.daysDiff($o,$p);var $r=(this.rowsPerMonth==="Auto")?Math.ceil($q/7):6;$j.rowCount=$r;var $s=(new DayPilot.Date()).getDatePart();var $t=$c.cellWidth()*7+this.$0m();var $u=this.cellHeight*$r+this.titleHeight+this.dayHeaderHeight;$j.height=$u;var $v=document.createElement("div");$v.style.width=($t)+'px';$v.style.height=($u)+'px';if(this.orientation==="Horizontal"){$v.style.position="absolute";$v.style.left=($t*j)+"px";$v.style.top="0px";}else{$v.style.position='relative';};if(this.cssOnly){$v.className=this.$0l('_month');}else{$v.className=this.$0l('month');};$v.style.cursor='default';$v.style.MozUserSelect='none';$v.style.KhtmlUserSelect='none';$v.style.WebkitUserSelect='none';$v.month=$j;this.root.appendChild($v);var $w=this.titleHeight+this.dayHeaderHeight;var tl=document.createElement("div");tl.style.position='absolute';tl.style.left='0px';tl.style.top='0px';tl.style.width=$c.cellWidth()+'px';tl.style.height=this.titleHeight+'px';tl.style.lineHeight=this.titleHeight+'px';tl.setAttribute("unselectable","on");if(this.cssOnly){tl.className=this.$0l('_titleleft');}else{tl.className=this.$0l('titleleft');};if($i.left){tl.style.cursor='pointer';tl.innerHTML="<span>&lt;</span>";tl.onclick=this.$0s;};$v.appendChild(tl);this.tl=tl;var ti=document.createElement("div");ti.style.position='absolute';ti.style.left=$c.cellWidth()+'px';ti.style.top='0px';ti.style.width=($c.cellWidth()*5+this.$0m())+'px';ti.style.height=this.titleHeight+'px';ti.style.lineHeight=this.titleHeight+'px';ti.setAttribute("unselectable","on");if(this.cssOnly){ti.className=this.$0l('_title');}else{ti.className=this.$0l('title');};ti.innerHTML=$c.locale().monthNames[$k.getMonth()]+' '+$k.getYear();$v.appendChild(ti);this.ti=ti;var tr=document.createElement("div");tr.style.position='absolute';tr.style.left=($c.cellWidth()*6+this.$0m())+'px';tr.style.top='0px';tr.style.width=$c.cellWidth()+'px';tr.style.height=this.titleHeight+'px';tr.style.lineHeight=this.titleHeight+'px';tr.setAttribute("unselectable","on");if(this.cssOnly){tr.className=this.$0l('_titleright');}else{tr.className=this.$0l('titleright');};if($i.right){tr.style.cursor='pointer';tr.innerHTML="<span>&gt;</span>";tr.onclick=this.$0t;};$v.appendChild(tr);this.tr=tr;var $x=this.$0m();if(this.showWeekNumbers){for(var y=0;y<$r;y++){var $y=$o.addDays(y*7);var $z=null;switch(this.weekNumberAlgorithm){case "Auto":$z=($c.weekStarts()===0)?$y.weekNumber():$y.weekNumberISO();break;case "US":$z=$y.weekNumber();break;case "ISO8601":$z=$y.weekNumberISO();break;default:throw "Unknown weekNumberAlgorithm value.";};var dh=document.createElement("div");dh.style.position='absolute';dh.style.left=(0)+'px';dh.style.top=(y*this.cellHeight+$w)+'px';dh.style.width=$c.cellWidth()+'px';dh.style.height=this.cellHeight+'px';dh.style.lineHeight=this.cellHeight+'px';dh.setAttribute("unselectable","on");if(this.cssOnly){dh.className=this.$0l('_weeknumber');}else{dh.className=this.$0l('weeknumber');};dh.innerHTML="<span>"+$z+"</span>";$v.appendChild(dh);$j.weeks.push(dh);}};for(var x=0;x<7;x++){$j.cells[x]=[];var dh=document.createElement("div");dh.style.position='absolute';dh.style.left=(x*$c.cellWidth()+$x)+'px';dh.style.top=this.titleHeight+'px';dh.style.width=$c.cellWidth()+'px';dh.style.height=this.dayHeaderHeight+'px';dh.style.lineHeight=this.dayHeaderHeight+'px';dh.setAttribute("unselectable","on");if(this.cssOnly){dh.className=this.$0l('_dayheader');}else{dh.className=this.$0l('dayheader');};dh.innerHTML="<span>"+this.$0u(x)+"</span>";$v.appendChild(dh);$j.days.push(dh);for(var y=0;y<$r;y++){var $y=$o.addDays(y*7+x);var $A=this.$0v($y)&&this.$0w()!=='none';var $B=$y.firstDayOfMonth()===$k;var $C=$y<$k;var $D=$y>=$k.addMonths(1);if(this.$0w()==="month"||this.$0w()==="day"){$A=$A&&$B;}else if(this.$0w()==="week"){var sd=this.selectionDay||this.selectionStart;var $E=sd.firstDayOfMonth()===$k;$A=$A&&($E||($l&&$C)||($m&&$D));};var dc=document.createElement("div");$j.cells[x][y]=dc;dc.day=$y;dc.x=x;dc.y=y;dc.isCurrentMonth=$B;if(this.cssOnly){dc.className=this.$0l(($B?'_day':'_dayother'));}else{dc.className=this.$0l(($B?'day':'dayother'));};$b.$0p(dc,"cell");if($y.getTime()===$s.getTime()&&$B){this.$0p(dc,'today');};if($y.dayOfWeek()===0||$y.dayOfWeek()===6){this.$0p(dc,'weekend');};dc.style.position='absolute';dc.style.left=(x*$c.cellWidth()+$x)+'px';dc.style.top=(y*this.cellHeight+$w)+'px';dc.style.width=$c.cellWidth()+'px';dc.style.height=this.cellHeight+'px';dc.style.lineHeight=this.cellHeight+'px';var $F=document.createElement("div");$F.style.position='absolute';if(this.cssOnly){$F.className=($y.getTime()===$s.getTime()&&$B)?this.$0l('_todaybox'):this.$0l('_daybox');}else{$F.className=($y.getTime()===$s.getTime()&&$B)?this.$0l('todaybox'):this.$0l('daybox');};$b.$0p($F,"cell_box");$F.style.left='0px';$F.style.top='0px';$F.style.right='0px';$F.style.bottom='0px';dc.appendChild($F);var $G=null;if(this.cells&&this.cells[$y.toStringSortable()]){$G=this.cells[$y.toStringSortable()];};if(typeof $b.onBeforeCellRender==="function"){var $H={};$H.cell={};$H.cell.day=$y;$H.cell.isCurrentMonth=$B;$H.cell.isToday=$y.getTime()===$s.getTime()&&$B;$H.cell.isWeekend=$y.dayOfWeek()===0||$y.dayOfWeek()===6;$H.cell.html=$y.getDay();$H.cell.cssClass=null;$b.onBeforeCellRender($H);$G=$H.cell;};if($G){DayPilot.Util.addClass(dc,$G.cssClass||$G.css);};if($B||($l&&$C)||($m&&$D)){var $I=document.createElement("div");$I.innerHTML=$y.getDay();$I.style.position="absolute";$I.style.left='0px';$I.style.top='0px';$I.style.right='0px';$I.style.bottom='0px';$b.$0p($I,"cell_text");dc.style.cursor='pointer';dc.isClickable=true;if($G&&$G.html){$I.innerHTML=$G.html;};dc.appendChild($I);};dc.setAttribute("unselectable","on");dc.onclick=this.$0x;dc.onmousedown=this.$0y;dc.onmousemove=this.$0z;$v.appendChild(dc);if($A){$b.$0A($v,x,y);this.selected.push(dc);}}};var $J=document.createElement("div");$J.style.position='absolute';$J.style.left='0px';$J.style.top=($w-2)+'px';$J.style.width=($c.cellWidth()*7+this.$0m())+'px';$J.style.height='1px';$J.style.fontSize='1px';$J.style.lineHeight='1px';if(this.cssOnly){$J.className=this.$0l("_line");}else{$J.className=this.$0l("line");};$v.appendChild($J);this.months.push($j);};this.$0A=function($v,x,y){var $K=$v.month.cells[x][y];$b.$0p($K,'select');};this.$0B=function($v,x,y){var $K=$v.month.cells[x][y];$b.$0q($K,'select');};this.$0m=function(){if(this.showWeekNumbers){return $c.cellWidth();};return 0;};this.$0C=function(){if(!this.items){return;};for(var j=0;j<this.showMonths;j++){for(var x=0;x<7;x++){for(var y=0;y<6;y++){var $G=this.months[j].cells[x][y];if(!$G){continue;};if(this.items[$G.day.toStringSortable()]===1){this.$0p($G,'busy');}else{this.$0q($G,'busy');}}}}};this.$0D=function(){var s={};s.startDate=$b.startDate;s.selectionStart=$b.selectionStart;s.selectionEnd=$b.selectionEnd.addDays(1);$b.state.value=DayPilot.JSON.stringify(s);};this.$0w=function(){var $L=this.selectMode||"";return $L.toLowerCase();};this.$0E=function(){var $M=this.selectionDay||this.selectionStart;var $M=new DayPilot.Date($M);switch(this.$0w()){case 'day':this.selectionDay=$M;this.selectionEnd=$M;break;case 'week':this.selectionDay=$M;this.selectionStart=$M.firstDayOfWeek($c.weekStarts());this.selectionEnd=this.selectionStart.addDays(6);break;case 'month':this.selectionDay=$M;this.selectionStart=$M.firstDayOfMonth();this.selectionEnd=this.selectionStart.lastDayOfMonth();break;case 'none':this.selectionEnd=$M;break;default:throw "Unknown selectMode value.";}};this.select=function($N){var $O=true;var $P=this.selectionStart;var $Q=this.selectionEnd;this.selectionStart=new DayPilot.Date($N).getDatePart();this.selectionDay=this.selectionStart;var $R=false;if($O){var $S=this.startDate;if(this.selectionStart<this.$0F()||this.selectionStart>=this.$0G()){$S=this.selectionStart.firstDayOfMonth();};if($S.toStringSortable()!==this.startDate.toStringSortable()){$R=true;};this.startDate=$S;};this.$0E();this.$0o();this.$0k();this.$0H();this.$0C();this.$0D();if(!$P.equals(this.selectionStart)||!$Q.equals(this.selectionEnd)){this.$0I();};if($R){this.$0J();}};this.update=function(){if(!$b.cssOnly){$b.cssOnly=true;DayPilot.Util.log("DayPilot: cssOnly = false mode is not supported since DayPilot Pro 8.0.");};this.$0o();this.$0k();this.$0E();this.$0H();this.$0K();this.$0C();this.$0D();if(this.visible){this.show();}else{this.hide();}};this.$0L=function($T,$U,$V){var $W={};$W.action=$T;$W.parameters=$V;$W.data=$U;$W.header=this.$0M();var $X="JSON"+DayPilot.JSON.stringify($W);var $Y=null;if(this.backendUrl){DayPilot.request(this.backendUrl,this.$0N,$X,this.$0O);}else{WebForm_DoCallback(this.uniqueID,$X,this.$0P,$Y,this.callbackError,true);}};this.$0O=function($Z){if(typeof $b.onAjaxError==='function'){var $H={};$H.request=$Z;$b.onAjaxError($H);}else if(typeof $b.ajaxError==='function'){$b.ajaxError($Z);}};this.$0N=function($00){$b.$0P($00.responseText);};this.$0Q=function($T,$U,$V){var $W={};$W.action=$T;$W.parameters=$V;$W.data=$U;$W.header=this.$0M();var $X="JSON"+DayPilot.JSON.stringify($W);__doPostBack($b.uniqueID,$X);};this.$0M=function(){var h={};h.v=this.v;h.startDate=this.startDate;h.selectionStart=this.selectionStart;return h;};this.$0R=function($T,$U){if($T==='refresh'){this.$0J();}};this.$0u=function(i){var x=i+$c.weekStarts();if(x>6){x-=7;};return $c.locale().dayNamesShort[x];};this.$0v=function($N){if(this.selectionStart===null||this.selectionEnd===null){return false;};if(this.selectionStart.getTime()<=$N.getTime()&&$N.getTime()<=this.selectionEnd.getTime()){return true;};return false;};this.$0y=function(ev){};this.$0z=function(ev){};this.$0x=function(ev){var $v=this.parentNode;var $j=this.parentNode.month;var x=this.x;var y=this.y;var $y=$j.cells[x][y].day;if(!$j.cells[x][y].isClickable){return;};$b.clearSelection();$b.selectionDay=$y;var $y=$b.selectionDay;switch($b.$0w()){case 'none':$b.selectionStart=$y;$b.selectionEnd=$y;break;case 'day':var s=$j.cells[x][y];$b.$0A($v,x,y);$b.selected.push(s);$b.selectionStart=s.day;$b.selectionEnd=s.day;break;case 'week':for(var j=0;j<7;j++){$b.$0A($v,j,y);$b.selected.push($j.cells[j][y]);};$b.selectionStart=$j.cells[0][y].day;$b.selectionEnd=$j.cells[6][y].day;break;case 'month':var $01=null;var end=null;for(var y=0;y<6;y++){for(var x=0;x<7;x++){var s=$j.cells[x][y];if(!s){continue;};if(s.day.getYear()===$y.getYear()&&s.day.getMonth()===$y.getMonth()){$b.$0A($v,x,y);$b.selected.push(s);if($01===null){$01=s.day;};end=s.day;}}};$b.selectionStart=$01;$b.selectionEnd=end;break;default:throw 'unknown selectMode';};$b.$0D();$b.$0I();};this.$0I=function(){var $01=$b.selectionStart;var end=$b.selectionEnd.addDays(1);var $q=DayPilot.DateUtil.daysDiff($01,end);var $y=$b.selectionDay;if($b.$0n()){var $H={};$H.start=$01;$H.end=end;$H.day=$y;$H.days=$q;$H.preventDefault=function(){this.preventDefault.value=true;};if(typeof $b.onTimeRangeSelect==='function'){$b.onTimeRangeSelect($H);if($H.preventDefault.value){return;}};switch($b.timeRangeSelectedHandling){case 'Bind':var $02=DayPilot.Util.evalVariable($b.bound);if($02){var $03={};$03.start=$01;$03.end=end;$03.days=$q;$03.day=$y;$02.commandCallBack($b.command,$03);};break;case 'None':break;case 'PostBack':$b.timeRangeSelectedPostBack($01,end,$y);break;};if(typeof $b.onTimeRangeSelected==='function'){$b.onTimeRangeSelected($H);}}else{switch($b.timeRangeSelectedHandling){case 'Bind':var $02=DayPilot.Util.evalVariable($b.bound);if($02){var $03={};$03.start=$01;$03.end=end;$03.days=$q;$03.day=$y;$02.commandCallBack($b.command,$03);};break;case 'JavaScript':$b.onTimeRangeSelected($01,end,$y);break;case 'None':break;case 'PostBack':$b.timeRangeSelectedPostBack($01,end,$y);break;}}};this.timeRangeSelectedPostBack=function($01,end,$U,$y){var $04={};$04.start=$01;$04.end=end;$04.day=$y;this.$0Q('TimeRangeSelected',$U,$04);};this.$0t=function(ev){$b.$0S($b.skipMonths);};this.$0s=function(ev){$b.$0S(-$b.skipMonths);};this.$0S=function(i){this.startDate=this.startDate.addMonths(i);this.$0o();this.$0k();this.$0H();this.$0D();this.$0J();this.$0C();};this.$0F=function(){return $b.startDate.firstDayOfMonth();};this.$0G=function(){return $b.startDate.firstDayOfMonth().addMonths(this.showMonths);};this.visibleStart=function(){return $b.startDate.firstDayOfMonth().firstDayOfWeek($c.weekStarts());};this.visibleEnd=function(){return $b.startDate.firstDayOfMonth().addMonths(this.showMonths-1).firstDayOfWeek($c.weekStarts()).addDays(42);};this.$0J=function(){var $01=this.visibleStart();var end=this.visibleEnd();if($b.$0n()){var $H={};$H.start=$01;$H.end=end;$H.preventDefault=function(){this.preventDefault.value=true;};if(typeof $b.onVisibleRangeChange==='function'){$b.onVisibleRangeChange($H);if($H.preventDefault.value){return;}};switch(this.visibleRangeChangedHandling){case "CallBack":this.visibleRangeChangedCallBack(null);break;case "PostBack":this.visibleRangeChangedPostBack(null);break;case "Disabled":break;};if(typeof $b.onVisibleRangeChanged==='function'){$b.onVisibleRangeChanged($H);}}else{switch(this.visibleRangeChangedHandling){case "CallBack":this.visibleRangeChangedCallBack(null);break;case "PostBack":this.visibleRangeChangedPostBack(null);break;case "JavaScript":this.onVisibleRangeChanged($01,end);break;case "Disabled":break;}}};this.visibleRangeChangedCallBack=function($U){var $V={};this.$0L("Visible",$U,$V);};this.visibleRangeChangedPostBack=function($U){var $V={};this.$0Q("Visible",$U,$V);};this.$0P=function($05,$Y){var $05=DayPilot.Util.parseJSON($05);$b.items=$05.Items;$b.cells=$05.Cells;$b.$0C();};this.$0H=function(){for(var j=0;j<this.showMonths;j++){var $i=this.$0T(j);this.$0r(j,$i);};this.root.style.height=this.$0U()+"px";};this.$0U=function(){if(this.orientation==="Horizontal"){var $06=0;for(var i=0;i<this.months.length;i++){var $j=this.months[i];if($j.height>$06){$06=$j.height;}};return $06;}else{var $07=0;for(var i=0;i<this.months.length;i++){var $j=this.months[i];$07+=$j.height;};return $07;}};this.$0T=function(j){if(this.internal.showLinks){return this.internal.showLinks;};var $i={};$i.left=(j===0);$i.right=(j===0);$i.before=j===0;$i.after=j===this.showMonths-1;if(this.orientation==="Horizontal"){$i.right=(j===this.showMonths-1);};return $i;};this.$0V={};this.$0V.scope=null;this.$0V.notify=function(){if($b.$0V.scope){$b.$0V.scope["$apply"]();}};this.internal={};this.internal.initialized=function(){return $b.$0W;};this.$0X={};var $c=this.$0X;$c.locale=function(){return DayPilot.Locale.find($b.locale);};$c.weekStarts=function(){if($b.weekStarts==='Auto'){var $08=$c.locale();if($08){return $08.weekStarts;}else{return 0;}}else{return $b.weekStarts;}};$c.cellWidth=function(){if($b.$0j.cellWidth){return $b.$0j.cellWidth;};var $t=$b.$0Y("_cell_dimensions").width;if(!$t){$t=$b.cellWidth;};$b.$0j.cellWidth=$t;return $t;};this.clearSelection=function(){for(var j=0;j<this.selected.length;j++){var $K=this.selected[j];$b.$0B($K.parentNode,$K.x,$K.y);};this.selected=[];};this.$0Z=function(){if(this.backendUrl){return(typeof $b.items==='undefined')||(!$b.items);}else{return false;}};this.events={};this.$0K=function(){if(!DayPilot.isArray(this.events.list)){return;};this.items={};for(var i=0;i<this.events.list.length;i++){var e=this.events.list[i];var $q=this.$10(e);for(var name in $q){this.items[name]=1;}}};this.$0Y=function($09){var $K=document.createElement("div");$K.style.position="absolute";$K.style.top="-2000px";$K.style.left="-2000px";$K.className=this.$0l($09);var $0a=$b.root||document.body;$0a.appendChild($K);var $u=$K.offsetHeight;var $t=$K.offsetWidth;$0a.removeChild($K);var $05={};$05.height=$u;$05.width=$t;return $05;};this.$10=function(e){var $01=new DayPilot.Date(e.start);var end=new DayPilot.Date(e.end);var $q={};var d=$01.getDatePart();while(d.getTime()<end.getTime()){$q[d.toStringSortable()]=1;d=d.addDays(1);};return $q;};this.show=function(){$b.visible=true;$b.root.style.display='';};this.hide=function(){$b.visible=false;$b.root.style.display='none';};this.$11=function(){if(this.id&&this.id.tagName){this.nav.top=this.id;}else if(typeof this.id==="string"){this.nav.top=document.getElementById(this.id);if(!this.nav.top){throw "DayPilot.Navigator: The placeholder element not found: '"+id+"'.";}}else{throw "DayPilot.Navigator() constructor requires the target element or its ID as a parameter";};this.root=this.nav.top;};this.init=function(){this.$11();if(this.root.dp){return;};if(!$b.cssOnly){$b.cssOnly=true;DayPilot.Util.log("DayPilot: cssOnly = false mode is not supported since DayPilot Pro 8.0.");};this.$0E();this.$0k();this.$0H();this.$0K();this.$0C();this.$12();var $0b=this.$0Z();if($0b){this.$0J();};this.$0W=true;};this.dispose=function(){var c=$b;if(!c.root){return;};c.root.removeAttribute("style");c.root.removeAttribute("class");c.root.dp=null;c.root.innerHTML=null;c.root=null;};this.$12=function(){this.root.dispose=this.dispose;};this.Init=this.init;};DayPilot.NavigatorVisible.Navigator=DayPilotNavigator.Navigator;if(typeof jQuery!=='undefined'){(function($){$.fn.daypilotNavigator=function($a){var $o=null;var j=this.each(function(){if(this.daypilot){return;};var $0c=new DayPilot.Navigator(this.id);this.daypilot=$0c;for(var name in $a){$0c[name]=$a[name];};$0c.Init();if(!$o){$o=$0c;}});if(this.length===1){return $o;}else{return j;}};})(jQuery);};(function registerAngularModule(){var $0d=DayPilot.am();if(!$0d){return;};$0d.directive("daypilotNavigator",function(){return{"restrict":"E","template":"<div id='{{id}};'></div>","compile":function compile(element,$0e){element.replaceWith(this["template"].replace("{{id}};",$0e["id"]));return function link($0f,element,$0e){var $b=new DayPilot.Navigator(element[0]);$b.$0V.scope=$0f;$b.init();var $0g=$0e["id"];if($0g){$0f[$0g]=$b;};var $0h=$0f["$watch"];$0h.call($0f,$0e["daypilotConfig"],function($0i){for(var name in $0i){$b[name]=$0i[name];};$b.update();},true);$0h.call($0f,$0e["daypilotEvents"],function($0i){$b.events.list=$0i;$b.$0K();$b.$0C();},true);};}};});})();if(typeof Sys!=='undefined'&&Sys.Application&&Sys.Application.notifyScriptLoaded){Sys.Application.notifyScriptLoaded();}})();


if(typeof DayPilot==='undefined'){var DayPilot={};};if(typeof DayPilot.Global==='undefined'){DayPilot.Global={};};if(typeof DayPilotScheduler==='undefined'){var DayPilotScheduler=DayPilot.SchedulerVisible={};};(function(){if(typeof DayPilot.Scheduler!=='undefined'){return;};var $a=(function(){var $b=navigator.userAgent;return(($b.indexOf('Mozilla/5.0')>-1&&$b.indexOf('Android ')>-1&&$b.indexOf('AppleWebKit')>-1)&&!($b.indexOf('Chrome')>-1));})();var DayPilotScheduler={};var $c=function(){};var debug=false;var $d=function($e){if(!debug){return;};window.console&&window.console.log($e);};var $f=function($e){if(typeof $g==="undefined"){return;};$d($e);};var console={"log":$d};DayPilot.Scheduler=function(id,$h){this.v='1925';var $i=this;this.id=id;this.isScheduler=true;this.hideUntilInit=true;this.api=2;this.allowDefaultContextMenu=false;this.allowEventOverlap=true;this.allowMultiMove=false;this.allowMultiRange=false;this.allowMultiResize=false;this.allowMultiSelect=true;this.multiSelectRectangle="Disabled";this.autoRefreshCommand='refresh';this.autoRefreshEnabled=false;this.autoRefreshInterval=60;this.autoRefreshMaxCount=20;this.autoScroll="Drag";this.blockOnCallBack=false;this.businessBeginsHour=9;this.businessEndsHour=18;this.businessWeekends=false;this.cellDuration=60;this.cellGroupBy='Day';this.cellWidth=40;this.cellWidthMin=1;this.cellWidthSpec="Fixed";this.groupConcurrentEvents=false;this.groupConcurrentEventsLimit=1;this.$8W=true;this.$8X=false;this.cellSweeping=true;this.cellSweepingCacheSize=1000;this.crosshairColor='Gray';this.crosshairOpacity=20;this.crosshairType='Header';this.$8Y=false;this.doubleClickTimeout=300;this.dragOutAllowed=false;this.durationBarHeight=3;this.durationBarVisible=true;this.durationBarMode="Duration";this.durationBarDetached=false;this.days=1;this.drawBlankCells=true;this.dynamicEventRendering='Progressive';this.dynamicEventRenderingMargin=50;this.dynamicEventRenderingMarginX=null;this.dynamicEventRenderingMarginY=null;this.dynamicEventRenderingCacheSweeping=false;this.dynamicEventRenderingCacheSize=200;this.dynamicLoading=false;this.eventBorderColor="#000000";this.eventBorderVisible=true;this.eventBackColor="#FFFFFF";this.eventEndSpec="DateTime";this.eventFontFamily="Tahoma, Arial";this.eventFontSize='8pt';this.eventFontColor='#000000';this.eventHeight=25;this.eventMoveMargin=5;this.eventMoveToPosition=false;this.eventResizeMargin=5;this.eventStackingLineHeight=100;this.eventTapAndHoldHandling="Move";this.eventTextWrappingEnabled=false;this.$8Z=false;this.headerFontColor="#000000";this.headerFontFamily="Tahoma, Arial";this.headerFontSize='8pt';this.headerHeight=20;this.heightSpec='Auto';this.hideBorderFor100PctHeight=false;this.hourFontFamily="Tahoma, Arial";this.hourFontSize='10pt';this.hourNameBackColor="#ECE9D8";this.hourNameBorderColor="#ACA899";this.$90=10;this.$91=30;this.$92=true;this.layout='Auto';this.linkCreateHandling="Disabled";this.linkBottomMargin=10;this.linkPointSize=10;this.locale="en-us";this.loadingLabelText="Loading...";this.loadingLabelVisible=true;this.loadingLabelBackColor="orange";this.loadingLabelFontColor="#ffffff";this.loadingLabelFontFamily="Tahoma";this.loadingLabelFontSize="10pt";this.messageHideAfter=5000;this.messageHideOnMouseOut=true;this.multiMoveVerticalMode="Disabled";this.moveBy='Full';this.notifyCommit='Immediate';this.numberFormat="0.00";this.progressiveRowRendering=true;this.progressiveRowRenderingPreload=25;this.tapAndHoldTimeout=300;this.timeHeaders=[{"groupBy":"Default"},{"groupBy":"Cell"}];this.treePreventParentUsage=false;this.treeAutoExpand=true;this.rowHeaderHideIconEnabled=false;this.rowHeaderWidth=80;this.rowHeaderScrolling=false;this.rowHeaderSplitterWidth=3;this.rowHeaderWidthAutoFit=true;this.rowHeaderCols=null;this.rowMarginBottom=0;this.rowMarginTop=0;this.rowMinHeight=0;this.scale="CellDuration";this.scrollDelayDynamic=500;this.scrollDelayEvents=200;this.scrollDelayCells=0;this.scrollDelayFloats=0;this.scrollX=0;this.scrollY=0;this.selectedRows=[];this.shadow="Fill";this.showBaseTimeHeader=true;this.showNonBusiness=true;this.showToolTip=true;this.snapToGrid=true;this.startDate=new DayPilot.Date().getDatePart();this.syncResourceTree=false;this.timeBreakColor='#000000';this.timeHeaderTextWrappingEnabled=false;this.treeEnabled=false;this.treeIndent=20;this.treeImageMarginLeft=5;this.treeImageMarginTop=5;this.timeFormat="Auto";this.useEventBoxes='Always';this.viewType='Resources';this.visible=true;this.weekStarts='Auto';this.width=null;this.floatingEvents=true;this.floatingTimeHeaders=true;this.eventCorners='Regular';this.separators=[];this.cornerHtml='';this.$93=-1;this.$94=-1;this.eventClickHandling='Enabled';this.eventDeleteHandling="Disabled";this.eventHoverHandling='Bubble';this.eventDoubleClickHandling='Disabled';this.eventEditHandling='Update';this.eventMoveHandling='Update';this.eventResizeHandling='Update';this.eventRightClickHandling='ContextMenu';this.eventSelectHandling='Update';this.rowClickHandling='Enabled';this.rowDoubleClickHandling="Disabled";this.rowCreateHandling="Disabled";this.rowEditHandling='Update';this.rowHeaderColumnResizedHandling="Update";this.rowSelectHandling='Update';this.rowMoveHandling="Disabled";this.timeRangeDoubleClickHandling='Disabled';this.timeRangeSelectedHandling='Enabled';this.eventMovingStartEndEnabled=false;this.eventMovingStartEndFormat="MMMM d, yyyy";this.timeRangeSelectingStartEndEnabled=false;this.timeRangeSelectingStartEndFormat="MMMM d, yyyy";this.eventResizingStartEndEnabled=false;this.eventResizingStartEndFormat="MMMM d, yyyy";this.cssOnly=true;this.cssClassPrefix="scheduler_default";this.eventVersionsEnabled=false;this.eventVersionHeight=25;this.eventVersionMargin=2;this.backendUrl=null;if($i.api===1){this.onEventMove=function(){};this.onEventResize=function(){};this.onResourceExpand=function(){};this.onResourceCollapse=function(){};};this.onBeforeTimeHeaderRender=null;this.onEventMove=null;this.onEventMoved=null;this.onEventMoving=null;this.onEventResize=null;this.onEventResized=null;this.onEventResizing=null;this.onEventMouseOver=null;this.onEventMouseOut=null;this.onTimeRangeSelect=null;this.onTimeRangeSelected=null;this.onTimeRangeSelecting=null;this.onRowHeaderResized=null;this.onBeforeCellRender=null;this.onCellMouseOver=null;this.onCellMouseOut=null;this.onRectangleEventSelecting=null;this.onRectangleEventSelect=null;this.onRectangleEventSelected=null;this.$95=0;this.$96=0;this.rowlist=DayPilot.list();this.itline=DayPilot.list();this.timeline=null;this.events={};this.cells={};this.elements={};this.elements.events=[];this.elements.bars=[];this.elements.text=[];this.elements.cells=[];this.elements.linesVertical=[];this.elements.separators=[];this.elements.range=[];this.elements.breaks=[];this.elements.links=[];this.elements.linkpoints=[];this.elements.rectangle=[];this.$97={};this.$97.cells=[];this.$97.linesVertical={};this.$97.linesHorizontal={};this.$97.timeHeaderGroups=[];this.$97.timeHeader={};this.$97.pixels=[];this.$97.breaks=[];this.$97.events=[];this.clientState={};this.members={};this.members.obsolete=["Init","cleanSelection","cssClassPrefix","getHScrollPosition","setHScrollPosition","getVScrollPosition","setVScrollPosition","showBaseTimeHeader"];this.members.ignoreFilter=function(name){if(name.indexOf("div")===0){return true;};return false;};this.members.ignore=["internal","nav","debug","temp","elements","members","cellProperties","itline","rowlist","timeHeader"];this.members.noCssOnly=["borderColor","cellBackColor","cellBackColorNonBusiness","cellBorderColor","cellSelectColor","durationBarColor","eventBackColor","eventBorderColor","eventBorderVisible","eventCorners","eventFontColor","eventFontFamily","eventFontSize","headerFontColor","headerFontFamily","headerFontSize","hourFontFamily","hourFontSize","hourNameBackColor","hourNameBorderColor","loadingLabelBackColor","loadingLabelFontColor","loadingLabelFontFamily","loadingLabelFontSize","shadow","timeBreakColor"];this.nav={};this.$98=function($j,$k){var $j=DayPilot.Util.parseJSON($j);$i.onScrollCalled=false;if(typeof $i.onCallBackResult==="function"){var $l={};$l.result=$j;$l.preventDefault=function(){$l.preventDefault.value=true;};$i.onCallBackResult($l);if($l.preventDefault.value){$i.$99();$i.$9a();$i.$9b();if($j.Message){if($i.message){$i.message($j.Message);}};$i.$9c($j.CallBackData,true);$i.$9d();$i.$9e();return;}};if($j.BubbleGuid){var $m=$j.BubbleGuid;var $n=this.bubbles[$m];delete this.bubbles[$m];$i.$9a();if(typeof $j.Result.BubbleHTML!=='undefined'&&$n){$n.updateView($j.Result.BubbleHTML,$n);};$i.$9d();return;};if($j.CallBackRedirect){document.location.href=$j.CallBackRedirect;return;};if(typeof DayPilot.Bubble!=="undefined"){DayPilot.Bubble.hideActive();};if(typeof $j.ClientState!=='undefined'){if($j.ClientState===null){$i.clientState={};}else{$i.clientState=$j.ClientState;}};if($j.UpdateType==="None"){$i.$9a();$i.$9d();if($j.Message){$i.message($j.Message);};$i.$9c($j.CallBackData,true);return;};if($j.VsUpdate){var $o=document.createElement("input");$o.type='hidden';$o.name=$i.id+"_vsupdate";$o.id=$o.name;$o.value=$j.VsUpdate;$i.$9f.innerHTML='';$i.$9f.appendChild($o);};if(typeof $j.TagFields!=='undefined'){$i.tagFields=$j.TagFields;};if(typeof $j.SortDirections!=='undefined'){$i.sortDirections=$j.SortDirections;};$i.$97.drawArea=null;if($j.UpdateType==="Full"){$i.resources=$j.Resources;$i.colors=$j.Colors;$i.palette=$j.Palette;$i.dirtyColors=$j.DirtyColors;$i.cellProperties=$j.CellProperties;$i.cellConfig=$j.CellConfig;$i.separators=$j.Separators;$i.timeline=$j.Timeline;$i.timeHeader=$j.TimeHeader;$i.timeHeaders=$j.TimeHeaders;if(typeof $j.Links!=="undefined"){$i.links.list=$j.Links;};if(typeof $j.RowHeaderColumns!=='undefined')$i.rowHeaderColumns=$j.RowHeaderColumns;$i.startDate=$j.StartDate?new DayPilot.Date($j.StartDate):$i.startDate;$i.days=$j.Days?$j.Days:$i.days;$i.cellDuration=$j.CellDuration?$j.CellDuration:$i.cellDuration;$i.cellGroupBy=$j.CellGroupBy?$j.CellGroupBy:$i.cellGroupBy;$i.cellWidth=$j.CellWidth?$j.CellWidth:$i.cellWidth;$i.viewType=$j.ViewType?$j.ViewType:$i.viewType;$i.hourNameBackColor=$j.HourNameBackColor?$j.HourNameBackColor:$i.hourNameBackColor;if(typeof $j.ShowNonBusiness!=='undefined')$i.showNonBusiness=$j.ShowNonBusiness;$i.businessBeginsHour=$j.BusinessBeginsHour?$j.BusinessBeginsHour:$i.businessBeginsHour;$i.businessEndsHour=$j.BusinessEndsHour?$j.BusinessEndsHour:$i.businessEndsHour;if(typeof $j.DynamicLoading!=='undefined')$i.dynamicLoading=$j.DynamicLoading;if(typeof $j.TreeEnabled!=='undefined')$i.treeEnabled=$j.TreeEnabled;$i.backColor=$j.BackColor?$j.BackColor:$i.backColor;$i.nonBusinessBackColor=$j.NonBusinessBackColor?$j.NonBusinessBackColor:$i.nonBusinessBackColor;$i.locale=$j.Locale?$j.Locale:$i.locale;if(typeof $j.TimeZone!=='undefined')$i.timeZone=$j.TimeZone;$i.timeFormat=$j.TimeFormat?$j.TimeFormat:$i.timeFormat;$i.rowHeaderCols=$j.RowHeaderCols?$j.RowHeaderCols:$i.rowHeaderCols;if(typeof $j.DurationBarMode!=="undefined")$i.durationBarMode=$j.DurationBarMode;$i.cornerBackColor=$j.CornerBackColor?$j.CornerBackColor:$i.cornerBackColor;if(typeof $j.CornerHTML!=='undefined'){$i.cornerHtml=$j.CornerHTML;};$i.hashes=$j.Hashes;$i.$9g();$i.$9h();$i.$9i();$i.$9j();};if($j.Action!=="Scroll"){$i.$9k($j.Events);};if($j.UpdateType==='Full'){$i.$9l();$i.$9m();};$i.$9n();$i.$9o();$i.$9p();$i.$97.drawArea=null;if($j.Action!=="Scroll"){$i.$9q();$i.$9r();if($i.heightSpec==='Auto'||$i.heightSpec==='Max'){$i.$9s();};$i.$9t();$i.$9u();$i.$9v();$i.multiselect.clear(true);$i.multiselect.$9w($j.SelectedEvents);$i.$9x();$i.$9y();$i.$9z();}else{$i.multiselect.clear(true);$i.multiselect.$9w($j.SelectedEvents);$i.$9A($j.Events);};if($i.timeRangeSelectedHandling!=="HoldForever"){$i.$9B();};if($j.UpdateType==="Full"){$i.setScroll($j.ScrollX,$j.ScrollY);$i.$9C();};$i.$9D();$i.$99();if($j.SelectedRows){$i.$9E($j.SelectedRows);};$i.$9a();if($j.UpdateType==='Full'&&navigator.appVersion.indexOf("MSIE 7.")!==-1){window.setTimeout(function(){$i.$9l();$i.$9s();},0);};$i.$9b();if($j.Message){if($i.message){$i.message($j.Message);}};$i.$9c($j.CallBackData,true);$i.$9d();$i.$9e();if($j.UpdateType==='Full'&&$j.Action!=="Scroll"&&!$i.onScrollCalled){setTimeout(function(){$i.$9F();},0);}};this.$99=function(){if($i.todo){if($i.todo.del){var $p=$i.todo.del;$p.parentNode.removeChild($p);$i.todo.del=null;}}};this.$9c=function($q,$r){var $s=function($q,$t){return function(){if($i.$9G()){if(typeof $i.onAfterRender==='function'){var $l={};$l.isCallBack=$t;$l.data=$q;$i.onAfterRender($l);}}else{if($i.afterRender){$i.afterRender($q,$t);}}};};window.setTimeout($s($q,$r),0);};this.scrollTo=function($u,$v,$w){if(!$u){return;};var $x;if($u instanceof DayPilot.Date){$x=this.getPixels($u).left;}else if(typeof $u==="string"){$x=this.getPixels(new DayPilot.Date($u)).left;}else if(typeof $u==="number"){$x=$u;}else{throw "Invalid scrollTo() parameter. Accepted parameters: string (ISO date), number (pixels), DayPilot.Date object";};var $y=this.$9H.clientWidth;var $z=this.nav.scroll.clientWidth;$w=$w||"left";switch($w.toLowerCase()){case "left":break;case "middle":$x-=$z/2;break;case "right":$x-=$z;break;};if($x<0){$x=0;};if($x>$y-$z){$x=$y-$z;};if(!$v){this.setScrollX($x);return;};var $A=Math.abs($i.nav.scroll.scrollLeft-$x);var $B=$A/$y;var $C=50;if(typeof $v==="number"){$C=$v;}else if(typeof $v==="string"){switch($v){case "fast":$C=30;break;case "normal":$C=50;break;case "slow":$C=100;break;case "linear":$C=Math.floor(100*$B);break;}};if($B>.6){$C=Math.min($C,80);};this.$9I($x,$C);};this.$9I=function($x,$C){var $D={};$D.steps=[];$D.index=0;$D.delay=10;$D.next=function(){var $E=$D.steps[$D.index];$D.index+=1;return $E;};$D.finished=function(){$i.$9F();};var $F=$i.getScrollX();var $C=$C||100;var $G=$x-$F;for(var i=0;i<$C;i++){var x=i/$C;var $H=((x-.5)*2)/(Math.pow(((x-0.5)*2),2)+1)+.5;$D.steps.push($F+$G*$H);};$D.steps.push($x);scrollStep($D);function scrollStep($D){var $E=$D.next();if(typeof $E==="undefined"){$D.finished&&$D.finished();return;};$i.setScrollX($E);window.clearTimeout($i.refreshTimeout);setTimeout(function(){scrollStep($D);},$D.delay);};};this.scrollToResource=function(id){DayPilot.complete(function(){var $I=$i.$9J(id);if(!$I){return;};setTimeout(function(){var scrollY=$I.top;$i.nav.scroll.scrollTop=scrollY;},100);});};this.$9K=function(){if(!this.cssOnly){return;};if(!this.floatingTimeHeaders){return;};if(!this.timeHeader){return;};var $J=this.$9L();if(!$J){return;};this.$9M();var $K=$J.pixels.left+$L.shiftX;var end=$J.pixels.right+$L.shiftX;var $M=[];for(var y=0;y<this.timeHeader.length;y++){for(var x=0;x<this.timeHeader[y].length;x++){var h=this.timeHeader[y][x];var $N=h.left;var $O=h.left+h.width;var $P=null;if($N<$K&&$K<$O){$P={};$P.x=x;$P.y=y;$P.marginLeft=$K-$N;$P.marginRight=0;$P.div=this.$97.timeHeader[x+"_"+y];$M.push($P);};if($N<end&&end<$O){if(!$P){$P={};$P.x=x;$P.y=y;$P.marginLeft=0;$P.div=this.$97.timeHeader[x+"_"+y];$M.push($P);};$P.marginRight=$O-end;break;}}};for(var i=0;i<$M.length;i++){var $P=$M[i];this.$9N($P.div,$P.marginLeft,$P.marginRight);}};this.$9D=function(){this.$9K();this.$9O();};this.$9P={};var $Q=this.$9P;$Q.eventsInRectangle=function(x,y,$z,$R){var $S=x;var $T=x+$z;var $U=y;var $V=y+$R;return DayPilot.list($i.elements.events).filter(function(e){var $q=e.event;var $N=$q.part.left;var $O=$q.part.left+$q.part.width;var $I=$i.rowlist[$q.part.dayIndex];var top=$I.top+$q.part.top;var $W=top+$q.part.height;if(DayPilot.Util.overlaps($N,$O,$S,$T)&&DayPilot.Util.overlaps(top,$W,$U,$V)){return true;}});};$Q.events=function($X){var $Y=[];var $X=$X||"All";var $J=$i.$9L();if(!$J){return DayPilot.list($Y);};var $K=$J.pixels.left;var end=$J.pixels.right;for(var i=0;i<$i.elements.events.length;i++){var e=$i.elements.events[i];var $q=e.event;var $N=$q.part.left;var $O=$q.part.left+$q.part.width;switch($X){case "Left":if($N<$K&&$K<$O){$Y.push(e);};break;case "All":if(DayPilot.Util.overlaps($N,$O,$K,end)){$Y.push(e);};break;}};return DayPilot.list($Y).addProps({"area":$J});};this.$9O=function(){if(!this.cssOnly){return;};if(!this.floatingEvents){return;};var $Z=$Q.events("Left");this.$9Q();$Z.each(function($00){var $N=$Z.area.pixels.left;var $q=$00.event;var $K=$q.part.left;var $01=$N-$K;$i.$9R($00,$01,0);});};this.elements.sections=[];this.elements.hsections=[];this.$9N=function($02,$01,$03){var $04=document.createElement("div");$04.setAttribute("unselectable","on");$04.className=this.$9S("_timeheader_float");$04.style.position="absolute";$04.style.left=$01+"px";$04.style.right=$03+"px";$04.style.top="0px";$04.style.bottom="0px";$04.style.overflow="hidden";var $05=document.createElement("div");$05.className=this.$9S("_timeheader_float_inner");$05.setAttribute("unselectable","on");$05.innerHTML=$02.cell.th.innerHTML;$04.appendChild($05);$02.section=$04;$02.insertBefore($04,$02.firstChild.nextSibling);$02.firstChild.innerHTML='';this.elements.hsections.push($02);};this.$9M=function(){for(var i=0;i<this.elements.hsections.length;i++){var e=this.elements.hsections[i];var $q=e.cell;if($q&&e.firstChild){e.firstChild.innerHTML=$q.th.innerHTML;};DayPilot.de(e.section);e.section=null;};this.elements.hsections=[];};this.$9R=function($02,$01,$03){var $04=document.createElement("div");$04.setAttribute("unselectable","on");$04.className=this.$9S("_event_float");$04.style.position="absolute";$04.style.left=$01+"px";$04.style.right=$03+"px";$04.style.top="0px";$04.style.bottom="0px";$04.style.overflow="hidden";var $05=document.createElement("div");$05.className=this.$9S("_event_float_inner");$05.setAttribute("unselectable","on");$05.innerHTML=$02.event.client.html();if($02.event.data.fontColor){$05.style.color=$02.event.data.fontColor;};$04.appendChild($05);$02.section=$04;$02.insertBefore($04,$02.firstChild.nextSibling);$02.firstChild.innerHTML='';var $h={"offsetX":parseInt(new DayPilot.StyleReader($05).get("padding-left"))};DayPilot.Areas.attach($04,$02.event,$h);DayPilot.Areas.disable($02);this.elements.sections.push($02);};this.$9Q=function(){for(var i=0;i<this.elements.sections.length;i++){var e=this.elements.sections[i];var $q=e.event;if($q){e.firstChild.innerHTML=$q.client.html();};DayPilot.de(e.section);DayPilot.Areas.enable(e);e.section=null;};this.elements.sections=[];};this.setScrollX=function(scrollX){var scroll=$i.nav.scroll;var $06=$i.$9T()*$i.cellWidth;if(scroll.clientWidth+scrollX>$06){scrollX=$06-scroll.clientWidth;};$i.divTimeScroll.scrollLeft=scrollX;scroll.scrollLeft=scrollX;};this.setScrollY=function(scrollY){var scroll=$i.nav.scroll;var $07=$i.$96;if(scroll.clientHeight+scrollY>$07){scrollY=$07-scroll.clientHeight;};$i.divResScroll.scrollTop=scrollY;scroll.scrollTop=scrollY;};this.setScroll=function(scrollX,scrollY){$i.setScrollX(scrollX);$i.setScrollY(scrollY);};this.message=function($08,$09){if($08===null){return;};var $h={};if(typeof arguments[1]==="object"){$h=arguments[1];$09=$h.delay;};var $09=$09||this.messageHideAfter||2000;var top=this.$9U()+1;var $N=this.$9V()+$0a.splitterWidth();var $O=DayPilot.sw($i.nav.scroll)+1;var $W=DayPilot.sh($i.nav.scroll)+1;var $02;if(!this.nav.message){$02=document.createElement("div");$02.style.position="absolute";$02.style.left=$N+"px";$02.style.right=$O+"px";$02.style.display='none';DayPilot.re($02,DayPilot.touch.start,function(e){$i.nav.message.style.display='none';e.preventDefault();e.stopPropagation();});$02.onmousemove=function(){if(!$i.messageHideOnMouseOut){return;};if($02.messageTimeout&&!$02.status){clearTimeout($02.messageTimeout);}};$02.onmouseout=function(){if(!$i.messageHideOnMouseOut){return;};if($i.nav.message.style.display!=='none'){$02.messageTimeout=setTimeout($i.$9W,500);}};var $05=document.createElement("div");$05.onclick=function(){$i.nav.message.style.display='none';};$05.className=this.$9S("_message");$02.appendChild($05);var close=document.createElement("div");close.style.position="absolute";close.className=this.$9S("_message_close");close.onclick=function(){$i.nav.message.style.display='none';};$02.appendChild(close);this.nav.top.appendChild($02);this.nav.message=$02;}else{$02=$i.nav.message;};var $0b=function(){var $02=$i.nav.message;if($h.cssClass){DayPilot.Util.addClass($02.firstChild,$h.cssClass);};var $05=$i.nav.message.firstChild;$05.innerHTML=$08;var $O=DayPilot.sw($i.nav.scroll)+1;$i.nav.message.style.right=$O+"px";var $w=$i.messageBarPosition||"Top";if($w==="Bottom"){$i.nav.message.style.bottom=$W+"px";$i.nav.message.style.top="";}else if($w==="Top"){$i.nav.message.style.bottom="";$i.nav.message.style.top=top+"px";};var end=function(){$02.messageTimeout=setTimeout($i.$9W,$09);};DayPilot.fade($i.nav.message,0.2,end);};clearTimeout($02.messageTimeout);if(this.nav.message.style.display!=='none'){DayPilot.fade($i.nav.message,-0.2,$0b);}else{$0b();}};this.$9W=function(){if(!$i.nav.message){return;};var end=function(){$i.nav.message.style.display='none';};DayPilot.fade($i.nav.message,-0.2,end);};this.message.show=function($08){$i.message($08);};this.message.hide=function(){$i.$9W();};this.$9X=null;this.$9s=function(){if(this.nav.scroll){var $0c=1;if(this.$9X!==null){this.nav.top.style.border=this.$9X;this.$9X=null;};if(this.heightSpec==='Parent100Pct'){this.nav.top.style.height="100%";if(this.hideBorderFor100PctHeight){this.$9X=this.nav.top.style.border;this.nav.top.style.border="0 none";};this.height=parseInt(this.nav.top.clientHeight,10)-(this.$9U())-$0c;};this.nav.scroll.style.height='30px';var $R=this.$9Y();var $0d=$R+this.$9U()+$0c;if($R>=0){this.nav.scroll.style.height=($R)+'px';this.$9Z.style.height=($R)+'px';};if(this.nav.divider){if(!$0d||isNaN($0d)||$0d<0){$0d=0;};this.nav.divider.style.height=($0d)+"px";};if(this.heightSpec!=="Parent100Pct"){this.nav.top.style.height=($0d)+"px";};if($i.nav.resScrollSpace){$i.nav.resScrollSpace.style.height=($R+20)+"px";};for(var i=0;i<this.elements.separators.length;i++){this.elements.separators[i].style.height=this.$96+'px';};for(var i=0;i<this.elements.linesVertical.length;i++){this.elements.linesVertical[i].style.height=this.$96+'px';}}};this.$9h=function(){this.startDate=new DayPilot.Date(this.startDate).getDatePart();this.$97.pixels=[];this.itline=DayPilot.list();var $0e=this.cellWidthSpec==="Auto";var $0f=function(){if(!$0e){return;};var $0g=0;if($i.timeHeader){if($i.timeline){$0g=$i.timeline.length;}else{}}else{if($i.scale==="Manual"){$0g=$i.timeline.length;}else{$i.$a0();$0g=$i.itline.length;$i.itline=DayPilot.list();}};var $z=$i.$a1();if($0g>0&&$z>0){$i.cellWidth=$z/$0g;}};$0f();if(this.$a2()&&this.timeline){if(this.timeline){this.itline=DayPilot.list();var $0h=null;var $N=0;for(var i=0;i<this.timeline.length;i++){var $0i=this.timeline[i];var $P={};$P.start=new DayPilot.Date($0i.start);$P.end=$0i.end?new DayPilot.Date($0i.end):$P.start.addMinutes(this.cellDuration);if(!$0i.width){var $O=Math.floor($N+this.cellWidth);var $z=$O-Math.floor($N);$P.left=Math.floor($N);$P.width=$z;$N+=this.cellWidth;}else{$P.left=$0i.left||$N;$P.width=$0i.width||this.cellWidth;$N+=$P.width;};$P.breakBefore=$0h&&$0h.ticks!==$P.start.ticks;$0h=$P.end;this.itline.push($P);}};if($0e){this.$a3();}}else{this.timeHeader=[];if(this.scale==="Manual"){this.itline=DayPilot.list();var $N=0;var $0h=null;for(var i=0;i<this.timeline.length;i++){var $0i=this.timeline[i];var $P={};$P.start=new DayPilot.Date($0i.start);$P.end=$0i.end?new DayPilot.Date($0i.end):$P.start.addMinutes(this.cellDuration);var w=$0i.width||this.cellWidth;var $O=Math.floor($N+w);var $z=$O-Math.floor($N);$P.left=Math.floor($N);$P.width=$z;$N+=w;$P.breakBefore=$0h&&$0h.ticks!==$P.start.ticks;$0h=$P.end;this.itline.push($P);}}else{this.$a0();};this.$a4();}};this.$a5={};var $L=this.$a5;$L.shiftX=0;$L.active=false;$L.updateRowStarts=function(){DayPilot.list($i.rowlist).each(function($I,i){$I.start=$i.$a6();$I.data=null;$i.$a7(i);});};$L.isEnabled=function(){return $i.temp.infiniteScrolling;};$L.shiftTo=function($0j){var $0j=new DayPilot.Date($0j);var $K=$0j.addDays(-$i.$91).getDatePart();var $G=new DayPilot.Duration($K.getTime()-$i.startDate.getDatePart().getTime()).totalDays();$L.shiftStart($G,$0j);};$L.shiftStart=function($0k,scrollTo){var $x;$L.active=true;var $0l=$i.startDate;var $0m=$i.startDate.addDays($0k);if($0k>0){$x=-$i.getPixels($0m).left;};$i.startDate=$i.startDate.addDays($0k);$i.itline=DayPilot.list();$i.$97.pixels=[];$i.$a0();$L.updateRowStarts();if($0k<0){$x=$i.getPixels($0l).left;};$i.timeHeader=[];$i.$a4();$i.$9m();$i.cellProperties={};$i.$9t();$i.$9v();$i.$9k();$i.$9u();if(typeof scrollTo!=='undefined'){$i.scrollTo(new DayPilot.Date(scrollTo));$i.$9F();}else{$i.nav.scroll.scrollLeft+=$x;};$i.$9z();$L.active=false;};this.$a0=function(){var $0n=(this.viewType!=='Days')?this.startDate.addDays(this.days):this.startDate.addDays(1);var $K=this.startDate;var end=this.$a8($K);var $0o=false;var $N=0;while(end.ticks<=$0n.ticks&&end.ticks>$K.ticks){if(this.$a9($K,end)){var $O=Math.floor($N+this.cellWidth);var $z=$O-Math.floor($N);var $0p={};$0p.start=$K;$0p.end=end;$0p.left=Math.floor($N);$0p.width=$z;$0p.breakBefore=$0o;this.itline.push($0p);$N+=this.cellWidth;$0o=false;}else{$0o=true;};$K=end;end=this.$a8($K);}};this.$a3=function(){if(!this.timeHeader){return;};for(var y=0;y<this.timeHeader.length;y++){var $I=this.timeHeader[y];for(var x=0;x<$I.length;x++){var h=$I[x];h.left=this.getPixels(new DayPilot.Date(h.start)).left;var $O=this.getPixels(new DayPilot.Date(h.end)).left;var $z=$O-h.left;h.width=$z;}}};this.$a4=function(){var $0q=this.timeHeaders;if(!$0q){$0q=[{"groupBy":this.cellGroupBy},{"groupBy":"Cell"}];};var $0r=$i.$aa();for(var i=0;i<$0q.length;i++){var $0s=$0q[i].groupBy;var $0t=$0q[i].format;if($0s==="Default"){$0s=this.cellGroupBy;};var $0u=[];var $K=this.$a6();while($K.ticks<$0r.ticks){var h={};h.start=$K;h.end=this.$ab(h.start,$0s);if(h.start.ticks===h.end.ticks){break;};h.left=this.getPixels(h.start).left;var $O=this.getPixels(h.end).left;var $z=$O-h.left;h.width=$z;h.colspan=Math.ceil($z/(1.0*this.cellWidth));if($0t){h.innerHTML=h.start.toString($0t,$0a.locale());}else{h.innerHTML=this.$ac(h,$0s);};if($z>0){if(typeof this.onBeforeTimeHeaderRender==='function'){var $P={};$P.start=h.start;$P.end=h.end;$P.html=h.innerHTML;$P.toolTip=h.innerHTML;$P.backColor=null;if(!this.cssOnly){$P.backColor=this.hourNameBackColor;};$P.level=this.timeHeader.length;var $l={};$l.header=$P;this.onBeforeTimeHeaderRender($l);h.innerHTML=$P.html;h.backColor=$P.backColor;h.toolTip=$P.toolTip;h.areas=$P.areas;};$0u.push(h);};$K=h.end;};this.timeHeader.push($0u);}};this.$a9=function($K,end){if(typeof this.onIncludeTimeCell==='function'){var $P={};$P.start=$K;$P.end=end;$P.visible=true;var $l={};$l.cell=$P;this.onIncludeTimeCell($l);return $P.visible;};if(this.showNonBusiness){return true;};return this.isBusiness({"start":$K,"end":end});};this.getPixels=function($u){var $0v=$u.ticks;var $0w=this.$97.pixels[$0v];if($0w){return $0w;};var $0x=null;var $0y=221876841600000;if(this.itline.length===0||$0v<this.itline[0].start.ticks){var $j={};$j.cut=false;$j.left=0;$j.boxLeft=$j.left;$j.boxRight=$j.left;$j.i=null;return $j;};for(var i=0;i<this.itline.length;i++){var $P=this.itline[i];var $0z=$P.start.ticks;var $0A=$P.end.ticks;if($0z<$0v&&$0v<$0A){var $0B=$0v-$0z;var $j={};$j.cut=false;$j.left=$P.left+this.$ad($P,$0B);$j.boxLeft=$P.left;$j.boxRight=$P.left+$P.width;$j.i=i;break;}else if($0z===$0v){var $j={};$j.cut=false;$j.left=$P.left;$j.boxLeft=$j.left;$j.boxRight=$j.left+$P.width;$j.i=i;break;}else if($0A===$0v){var $j={};$j.cut=false;$j.left=$P.left+$P.width;$j.boxLeft=$j.left;$j.boxRight=$j.left;$j.i=i+1;break;}else if($0v<$0z&&$0v>$0y){var $j={};$j.cut=true;$j.left=$P.left;$j.boxLeft=$j.left;$j.boxRight=$j.left;$j.i=i;break;};$0y=$0A;};if(!$j){var $0C=this.itline[this.itline.length-1];var $j={};$j.cut=true;$j.left=$0C.left+$0C.width;$j.boxLeft=$j.left;$j.boxRight=$j.left;$j.i=null;};this.$97.pixels[$0v]=$j;return $j;};this.getDate=function($N,$0D,$0E){var $w=this.$ae($N,$0E);if(!$w){return null;};var x=$w.x;var $0F=this.itline[x];if(!$0F){return null;};var $K=($0E&&!$0D)?$0F.end:$0F.start;if(!$0D){return $K;}else{return $K.addTime(this.$af($w.cell,$w.offset));}};this.$ae=function($x,$0E){if(this.itline.length===0){return null;};var $F=0;var $0x=0;for(var i=0;i<this.itline.length;i++){var $P=this.itline[i];var $z=$P.width||this.cellWidth;$F+=$z;if(($x<$F)||($0E&&$x===$F)){var $j={};$j.x=i;$j.offset=$x-$0x;$j.cell=$P;return $j;};$0x=$F;};var $P=$i.itline.last();var $j={};$j.x=this.itline.length-1;$j.offset=$P.width||this.cellWidth;$j.cell=$P;return $j;};this.$ag=function($0G){var $F=new DayPilot.Date($0G);for(var i=0;i<this.itline.length;i++){var $P=this.itline[i];if($P.start.ticks<=$F.ticks&&$F.ticks<$P.end.ticks){var $j={};$j.hidden=false;$j.current=$P;return $j;};if($F.ticks<$P.start.ticks){var $j={};$j.hidden=true;$j.previous=i>0?this.itline[i-1]:null;$j.current=null;$j.next=this.itline[i];return $j;}};var $j={};$j.past=true;$j.previous=this.itline[this.itline.length-1];return $j;};this.$ad=function($P,$0v){var $z=$P.width||this.cellWidth;var $0H=$P.end.ticks-$P.start.ticks;return Math.floor(($z*$0v)/($0H));};this.$af=function($P,$x){var $0H=$P.end.ticks-$P.start.ticks;var $z=$P.width||this.cellWidth;return Math.floor($x/$z*$0H);};this.$ah=function(ev){if($0I.start){return;};$0J={};$i.$ai(this,ev);};this.eventClickPostBack=function(e,$q){this.$aj('EventClick',e,$q);};this.eventClickCallBack=function(e,$q){this.$ak('EventClick',e,$q);};this.$ai=function($02,ev){var e=$02.event;var ev=ev||window.event;if(typeof(DayPilotBubble)!=='undefined'){DayPilotBubble.hideActive();};if(!e.client.doubleClickEnabled()){$i.$al($02,ev);return;};if(!$i.timeouts.click){$i.timeouts.click=[];};var $0K=function($02,ev){return function(){$i.$al($02,ev);};};$i.timeouts.click.push(window.setTimeout($0K($02,ev),$i.doubleClickTimeout));};this.$am=function(x){return $i.itline[x];};this.$al=function($02,ev){if(typeof ev==="boolean"){throw "Invalid _eventClickSingle parameters";};var e=$02.event;var $0L=ev.ctrlKey;var $0M=ev.metaKey;if(!e.client.clickEnabled()){return;};if($i.$9G()){var $l={};$l.e=e;$l.div=$02;$l.originalEvent=ev;$l.ctrl=$0L;$l.meta=$0M;$l.preventDefault=function(){this.preventDefault.value=true;};if(typeof $i.onEventClick==='function'){$i.onEventClick($l);if($l.preventDefault.value){return;}};switch($i.eventClickHandling){case 'PostBack':$i.eventClickPostBack(e);break;case 'CallBack':$i.eventClickCallBack(e);break;case 'Edit':$i.$an($02);break;case 'Select':$i.$ao($02,e,$0L,$0M);break;case 'ContextMenu':var $0N=e.client.contextMenu();if($0N){$0N.show(e);}else{if($i.contextMenu){$i.contextMenu.show(e);}};break;case 'Bubble':if($i.bubble){$i.bubble.showEvent(e);};break;case "RectangleSelect":if($i.multiSelectRectangle!=="Disabled"){$0O.start();return false;};break;};if(typeof $i.onEventClicked==='function'){$i.onEventClicked($l);}}else{switch($i.eventClickHandling){case 'PostBack':$i.eventClickPostBack(e);break;case 'CallBack':$i.eventClickCallBack(e);break;case 'JavaScript':$i.onEventClick(e);break;case 'Edit':$i.$an($02);break;case 'Select':$i.$ao($02,e,$0L,$0M);break;case 'ContextMenu':var $0N=e.client.contextMenu();if($0N){$0N.show(e);}else{if($i.contextMenu){$i.contextMenu.show(e);}};break;case 'Bubble':if($i.bubble){$i.bubble.showEvent(e);};break;case "RectangleSelect":if($i.multiSelectRectangle!=="Disabled"){$0O.start();return false;};break;}}};this.$ap=function(e){if($i.$9G()){var $l={};$l.e=e;$l.preventDefault=function(){this.preventDefault.value=true;};if(typeof $i.onEventDelete==='function'){$i.onEventDelete($l);if($l.preventDefault.value){return;}};switch($i.eventDeleteHandling){case 'PostBack':$i.eventDeletePostBack(e);break;case 'CallBack':$i.eventDeleteCallBack(e);break;case 'Update':$i.events.remove(e);break;};if(typeof $i.onEventDeleted==='function'){$i.onEventDeleted($l);}}else{switch($i.eventDeleteHandling){case 'PostBack':$i.eventDeletePostBack(e);break;case 'CallBack':$i.eventDeleteCallBack(e);break;case 'JavaScript':$i.onEventDelete(e);break;}}};this.eventDeletePostBack=function(e,$q){this.$aj('EventDelete',e,$q);};this.eventDeleteCallBack=function(e,$q){this.$ak('EventDelete',e,$q);};this.setHScrollPosition=function($x){this.nav.scroll.scrollLeft=$x;};this.getScrollX=function(){return this.nav.scroll.scrollLeft;};this.getHScrollPosition=this.getScrollX;this.getScrollY=function(){return this.nav.scroll.scrollTop;};this.$ao=function($02,e,$0L,$0M){$i.$aq($02,e,$0L,$0M);};this.eventSelectPostBack=function(e,$0P,$q){var $0Q={};$0Q.e=e;$0Q.change=$0P;this.$aj('EventSelect',$0Q,$q);};this.eventSelectCallBack=function(e,$0P,$q){var $0Q={};$0Q.e=e;$0Q.change=$0P;this.$ak('EventSelect',$0Q,$q);};this.$aq=function($02,e,$0L,$0M){var m=$i.multiselect;var $0R=false;var $0S=m.isSelected(e);var $0T=$0L||$0M;if(!$0T&&$0S&&!$0R&&m.list.length===1){return;};if($i.$9G()){m.previous=m.events();var $l={};$l.e=e;$l.selected=$0S;$l.ctrl=$0L;$l.meta=$0M;$l.preventDefault=function(){this.preventDefault.value=true;};if(typeof $i.onEventSelect==='function'){$i.onEventSelect($l);if($l.preventDefault.value){return;}};switch($i.eventSelectHandling){case 'PostBack':$i.eventSelectPostBack(e,$0P);break;case 'CallBack':if(typeof WebForm_InitCallback!=='undefined'){window.__theFormPostData="";window.__theFormPostCollection=[];WebForm_InitCallback();};$i.eventSelectCallBack(e,$0P);break;case 'Update':m.$ar($02,$0L,$0M);break;};if(typeof $i.onEventSelected==='function'){$l.change=m.isSelected(e)?"selected":"deselected";$l.selected=m.isSelected(e);$i.onEventSelected($l);}}else{m.previous=m.events();m.$ar($02,$0L,$0M);var $0P=m.isSelected(e)?"selected":"deselected";switch($i.eventSelectHandling){case 'PostBack':$i.eventSelectPostBack(e,$0P);break;case 'CallBack':if(typeof WebForm_InitCallback!=='undefined'){window.__theFormPostData="";window.__theFormPostCollection=[];WebForm_InitCallback();};$i.eventSelectCallBack(e,$0P);break;case 'JavaScript':$i.onEventSelect(e,$0P);break;}}};this.eventRightClickPostBack=function(e,$q){this.$aj('EventRightClick',e,$q);};this.eventRightClickCallBack=function(e,$q){this.$ak('EventRightClick',e,$q);};this.$as=function(ev){var e=this.event;ev=ev||window.event;ev.cancelBubble=true;if(!this.event.client.rightClickEnabled()){return false;};if($i.$9G()){var $l={};$l.e=e;$l.div=this;$l.originalEvent=ev;$l.preventDefault=function(){this.preventDefault.value=true;};if(typeof $i.onEventRightClick==='function'){$i.onEventRightClick($l);if($l.preventDefault.value){return false;}};switch($i.eventRightClickHandling){case 'PostBack':$i.eventRightClickPostBack(e);break;case 'CallBack':$i.eventRightClickCallBack(e);break;case 'ContextMenu':var $0N=e.client.contextMenu();if($0N){$0N.show(e);}else{if($i.contextMenu){$i.contextMenu.show(this.event);}};break;case 'Bubble':if($i.bubble){$i.bubble.showEvent(e);};break;};if(typeof $i.onEventRightClicked==='function'){$i.onEventRightClicked($l);}}else{switch($i.eventRightClickHandling){case 'PostBack':$i.eventRightClickPostBack(e);break;case 'CallBack':$i.eventRightClickCallBack(e);break;case 'JavaScript':$i.onEventRightClick(e);break;case 'ContextMenu':var $0N=e.client.contextMenu();if($0N){$0N.show(e);}else{if($i.contextMenu){$i.contextMenu.show(this.event);}};break;case 'Bubble':if($i.bubble){$i.bubble.showEvent(e);};break;}};return false;};this.eventDoubleClickPostBack=function(e,$q){this.$aj('EventDoubleClick',e,$q);};this.eventDoubleClickCallBack=function(e,$q){this.$ak('EventDoubleClick',e,$q);};this.$at=function(ev){if(typeof(DayPilotBubble)!=='undefined'){DayPilotBubble.hideActive();};if($i.timeouts.click){for(var $0U in $i.timeouts.click){window.clearTimeout($i.timeouts.click[$0U]);};$i.timeouts.click=null;};var ev=ev||window.event;var e=this.event;ev.stopPropagation&&ev.stopPropagation();ev.cancelBubble=true;if($i.$9G()){var $l={};$l.e=e;$l.originalEvent=ev;$l.preventDefault=function(){this.preventDefault.value=true;};if(typeof $i.onEventDoubleClick==='function'){$i.onEventDoubleClick($l);if($l.preventDefault.value){return;}};switch($i.eventDoubleClickHandling){case 'PostBack':$i.eventDoubleClickPostBack(e);break;case 'CallBack':$i.eventDoubleClickCallBack(e);break;case 'Edit':$i.$an(this);break;case 'Select':$i.$ao($02,e,ev.ctrlKey,ev.metaKey);break;case 'Bubble':if($i.bubble){$i.bubble.showEvent(e);};break;case 'ContextMenu':var $0N=e.client.contextMenu();if($0N){$0N.show(e);}else{if($i.contextMenu){$i.contextMenu.show(e);}};break;};if(typeof $i.onEventDoubleClicked==='function'){$i.onEventDoubleClicked($l);}}else{switch($i.eventDoubleClickHandling){case 'PostBack':$i.eventDoubleClickPostBack(e);break;case 'CallBack':$i.eventDoubleClickCallBack(e);break;case 'JavaScript':$i.onEventDoubleClick(e);break;case 'Edit':$i.$an(this);break;case 'Select':$i.$ao($02,e,ev.ctrlKey,ev.metaKey);break;case 'Bubble':if($i.bubble){$i.bubble.showEvent(e);};break;case 'ContextMenu':var $0N=e.client.contextMenu();if($0N){$0N.show(e);}else{if($i.contextMenu){$i.contextMenu.show(e);}};break;}}};this.eventResizePostBack=function(e,$0m,$0V,$q){this.$au("PostBack",e,$0m,$0V,$q);};this.eventResizeCallBack=function(e,$0m,$0V,$q){this.$au("CallBack",e,$0m,$0V,$q);};this.$au=function($X,e,$0m,$0V,$q){var $0Q={};$0Q.e=e;$0Q.newStart=$0m;$0Q.newEnd=$0V;this.$av($X,"EventResize",$0Q,$q);};this.$aw=function(e,$0m,$0V){if(this.eventResizeHandling==='Disabled'){return;};$0V=$i.$ax($0V);if($i.$9G()){var $l={};var $0W=function(){$0X.hide();if($l.preventDefault.value){return;};$0m=$l.newStart;$0V=$l.newEnd;switch($i.eventResizeHandling){case 'PostBack':$i.eventResizePostBack(e,$0m,$0V);break;case 'CallBack':$i.eventResizeCallBack(e,$0m,$0V);break;case 'Notify':$i.eventResizeNotify(e,$0m,$0V);break;case 'Update':$i.$ay($l);break;};if(typeof $i.onEventResized==='function'){$i.onEventResized($l);}};$l.e=e;$l.async=false;$l.loaded=function(){$0W();};$l.newStart=$0m;$l.newEnd=$0V;$l.preventDefault=function(){this.preventDefault.value=true;};$l.multiresize=DayPilot.list($0Y.list);var $0Z={};$0Z.event=e;$0Z.start=$0m;$0Z.end=$0V;$l.multiresize.splice(0,0,$0Z);if(typeof $i.onEventResize==='function'){$i.onEventResize($l);};if(!$l.async){$0W();}else{if($i.blockOnCallBack){$0X.show();}}}else{switch($i.eventResizeHandling){case 'PostBack':$i.eventResizePostBack(e,$0m,$0V);break;case 'CallBack':$i.eventResizeCallBack(e,$0m,$0V);break;case 'JavaScript':$i.onEventResize(e,$0m,$0V);break;case 'Notify':$i.eventResizeNotify(e,$0m,$0V);break;case 'Update':$i.$ay($l);break;}}};this.eventMovePostBack=function(e,$0m,$0V,$10,$q,$0u){this.$az("PostBack",e,$0m,$0V,$10,$q,$0u);};this.eventMoveCallBack=function(e,$0m,$0V,$10,$q,$0u){this.$az("CallBack",e,$0m,$0V,$10,$q,$0u);};this.$az=function($X,e,$0m,$0V,$10,$q,$0u){var $11=e&&!!e.preventDefault;var $0Q={};if($11){var $l=e;$0Q.e=$l.e;$0Q.newStart=$l.newStart;$0Q.newEnd=$l.newEnd;$0Q.newResource=$l.newResource;$0Q.position=$l.position;$0Q.multimove=[];$l.multimove.each(function($00){var $12={};$12.e=$00.event;$12.newStart=$00.start;$12.newEnd=$00.end;$12.newResource=$00.event.resource();if($12.e===$l.e||$12.e.data.id==$l.e.data.id){$12.newResource=$l.newResource;}else if(mm.rowoffset){var ri=$00.event.part.dayIndex+mm.rowoffset;$12.newResource=$i.rowlist[ri].id;};$0Q.multimove.push($12);});}else{$0Q.e=e;$0Q.newStart=$0m;$0Q.newEnd=$0V;$0Q.newResource=$10;$0Q.position=$0u;};this.$av($X,"EventMove",$0Q,$q);};this.$aA=function($X,$l,$q){var $0Q={};$0Q.start=$l.start;$0Q.end=$l.end;$0Q.resource=$l.resource;$0Q.multirange=[];$l.multirange.each(function($00){var $13={};$13.start=$00.start;$13.end=$00.end;$13.resource=$00.resource;$0Q.multirange.push($13);});this.$av($X,"TimeRangeSelected",$0Q,$q);};this.$av=function($X,$14,$0Q,$q){if($X==='PostBack'){$i.$aj($14,$0Q,$q);}else if($X==='CallBack'){$i.$ak($14,$0Q,$q,"CallBack");}else if($X==='Immediate'){$i.$ak($14,$0Q,$q,"Notify");}else if($X==='Queue'){$i.queue.add(new DayPilot.Action(this,$14,$0Q,$q));}else if($X==='Notify'){if($0a.notifyType()==='Notify'){$i.$ak($14,$0Q,$q,"Notify");}else{$i.queue.add(new DayPilot.Action($i,$14,$0Q,$q));}}else{throw "Invalid event invocation type";}};this.eventMoveNotify=function(e,$0m,$0V,$10,$q,$0u){var $11=e&&!!e.preventDefault;if($11){var $l=e;$l.old=new DayPilot.Event($l.e.copy(),$i);$l.multimove.each(function($00){$00.old=new DayPilot.Event($00.event.copy(),$i);});$i.$ay($l);$l.e=$l.old;delete $l.old;$l.multimove.each(function($00){$00.event=$00.old;delete $00.old;});}else{e=new DayPilot.Event(e.copy(),$i);var $15=$i.events.$aB(e.data);e.start($0m);e.end($0V);e.resource($10);e.commit();$15=$15.concat($i.events.$aC(e.data));$i.$aD($15);$i.$aE();$i.$aF($15);};this.$az("Notify",e,$0m,$0V,$10,$q,$0u);};this.eventResizeNotify=function(e,$0m,$0V,$q){var $16=new DayPilot.Event(e.copy(),this);var $15=$i.events.$aB(e.data);e.start($0m);e.end($0V);e.commit();$15=$15.concat($i.events.$aC(e.data));$i.$aD($15);$i.$aE();$i.$aF($15);this.$au("Notify",$16,$0m,$0V,$q);};this.multiselect={};this.multiselect.list=[];this.multiselect.divs=[];this.multiselect.previous=[];this.multiselect.$9w=function($Y){$i.multiselect.list=DayPilot.list($Y).map(function($00){return new DayPilot.Event($00,$i);});};this.multiselect.$aG=function(){var m=$i.multiselect;return DayPilot.JSON.stringify(m.events());};this.multiselect.events=function(){var m=$i.multiselect;var $Z=DayPilot.list();$Z.ignoreToJSON=true;for(var i=0;i<m.list.length;i++){$Z.push(m.list[i]);};return $Z;};this.multiselect.$aH=function(){};this.multiselect.$ar=function($02,$17,$18){var m=$i.multiselect;if(m.isSelected($02.event)){if($i.allowMultiSelect){if($17||$18){m.remove($02.event,true);}else{var $0g=m.list.length;m.clear();if($0g>1){m.add($02.event,true);}}}else{m.clear();}}else{if($i.allowMultiSelect){if($17||$18){m.add($02.event,true);}else{m.clear();m.add($02.event,true);}}else{m.clear();m.add($02.event,true);}};m.$aI($02);m.$aH();};this.multiselect.$aJ=function(ev){var m=$i.multiselect;return m.$aK(ev,m.initList);};this.multiselect.$aL=function(){var m=$i.multiselect;var $Y=[];for(var i=0;i<m.list.length;i++){var event=m.list[i];$Y.push(event.value());};alert($Y.join("\n"));};this.multiselect.add=function(ev,$19){var m=$i.multiselect;if(m.indexOf(ev)===-1){m.list.push(ev);};if($19){return;};m.redraw();};this.multiselect.remove=function(ev,$19){var m=$i.multiselect;var i=m.indexOf(ev);if(i!==-1){m.list.splice(i,1);};if($19){return;};m.redraw();};this.multiselect.clear=function($19){var m=$i.multiselect;m.list=[];if($19){return;};m.redraw();};this.multiselect.redraw=function(){var m=$i.multiselect;m.divs=[];for(var i=0;i<$i.elements.events.length;i++){var $02=$i.elements.events[i];if(!$02.event){continue;};if(!$02.event.isEvent){continue;};if(m.isSelected($02.event)){m.$aM($02);}else{m.$aN($02);}}};this.multiselect.$aO=function(ev){var m=$i.multiselect;var $02=null;for(var i=0;i<$i.elements.events.length;i++){if(m.isSelected($i.elements.events[i].event)){$02=$i.elements.events[i];break;}};m.$aI($02);};this.multiselect.$aI=function($02){if(!$02){return;};var m=$i.multiselect;if(m.isSelected($02.event)){m.$aM($02);}else{m.$aN($02);}};this.multiselect.$aM=function($02){var m=$i.multiselect;var cn=$i.cssOnly?$i.$9S("_selected"):$i.$9S("selected");var $02=m.$aP($02);DayPilot.Util.addClass($02,cn);m.divs.push($02);};this.multiselect.$aP=function($02){return $02;};this.multiselect.$aQ=function(){var m=$i.multiselect;for(var i=0;i<m.divs.length;i++){var $02=m.divs[i];m.$aN($02,true);};m.divs=[];};this.multiselect.$aN=function($02,$1a){var m=$i.multiselect;var cn=$i.cssOnly?$i.$9S("_selected"):$i.$9S("selected");DayPilot.Util.removeClass($02,cn);if($1a){return;};var i=DayPilot.indexOf(m.divs,$02);if(i!==-1){m.divs.splice(i,1);}};this.multiselect.isSelected=function(ev){if(!ev){return false;};if(!ev.isEvent){return false;};return $i.multiselect.$aK(ev,$i.multiselect.list);};this.multiselect.indexOf=function(ev){var $q=ev.data;for(var i=0;i<$i.multiselect.list.length;i++){var $00=$i.multiselect.list[i];if($00.data===$q){return i;}};return -1;};this.multiselect.$aK=function(e,$Y){if(!$Y){return false;};for(var i=0;i<$Y.length;i++){var ei=$Y[i];if(e===ei){return true;};if(typeof ei.id==='function'){if(ei.id()!==null&&e.id()!==null&&ei.id()===e.id()){return true;};if(ei.id()===null&&e.id()===null&&ei.recurrentMasterId()===e.recurrentMasterId()&&e.start().toStringSortable()===ei.start().toStringSortable()){return true;}}else{if(ei.id!==null&&e.id()!==null&&ei.id===e.id()){return true;};if(ei.id===null&&e.id()===null&&ei.recurrentMasterId===e.recurrentMasterId()&&e.start().toStringSortable()===ei.start){return true;}}};return false;};this.multiselect.startRectangle=function(){$0O.start();};this.$aR=function(){this.$9v();this.$9y();};this.$aI=function($l){var $l=$l||{};var $1b=!$l.eventsOnly;if(!$i.cssOnly){$i.cssOnly=true;DayPilot.Util.log("DayPilot: cssOnly = false mode is not supported since DayPilot Pro 8.0.")};if($1b){if(!this.$a2()){$i.timeHeader=null;$i.cellProperties={};};$i.$9g();$i.$9h();if(!$l||!$l.dontLoadResources){$i.$9i();}};this.$9k();if($1b){$i.$aS();$i.$9l();$i.$9m();$i.$9E($i.selectedRows);};$i.$9n();$i.$9q();$i.$aT();$i.$9r();$1c.hideLinkpoints();this.$9u();this.$9t();this.$9e();this.$9j();this.$9x();this.$aR();$i.$9s();if($l.immediateEvents||$l.eventsOnly){$i.$9z();}else{setTimeout(function(){$i.$9z();},100);};if(this.visible){this.show();}else{this.hide();};this.$9D();this.$9F();};this.update=function($h){if($i.$8Y){throw "You are trying to update a DayPilot.Scheduler object that has been disposed already. Calling .dispose() destroys the object and makes it unusable.";};$1d.request($h);};var $1d={};$1d.timeout=null;$1d.options=null;$1d.request=function($h){clearTimeout($1d.timeout);$1d.mergeOptions($h);$1d.timeout=setTimeout($1d.doit);};$1d.mergeOptions=function($h){if(!$h){return;};if(!$1d.options){$1d.options={};};for(var name in $h){$1d.options[name]=$h[name];}};$1d.doit=function(){var $h=$1d.options;$1d.options=null;if(!$h){$i.$aU&&$i.$aI({"immediateEvents":true});return;};if($h.events){$i.events.list=$h.events;$i.$aU&&$i.$aI({"eventsOnly":true});}else if($h.separators){$i.separators=$h.separators;$i.$aU&&$i.$aR();}};this.$aF=function($15,$1e,$1f){$15=DayPilot.ua($15);for(var i=0;i<$15.length;i++){var ri=$15[i];$i.$aV(ri);};if(this.$aW){this.$9n();this.$9q();this.$9t();this.$9v();for(var i=0;i<$15.length;i++){var ri=$15[i];this.$aX(ri);};for(var i=0;i<$15.length;i++){var ri=$15[i];this.$aY(ri);};this.$9x();this.$9y();this.$aZ();}else{var $1g=true;if($1g){var $1h=function(i){if(i>=$15.length){return;};var ri=$15[i];if(!$1e){$i.$aX(ri);};$i.$aY(ri);if(i+1<$15.length){setTimeout(function(){$1h(i+1);},10);}else{$i.$9O();$1c.load();$i.multiselect.redraw();if($1f){$1f();}}};$1h(0);}else{for(var i=0;i<$15.length;i++){var ri=$15[i];if(!$1e){this.$aX(ri);};this.$aY(ri);}};DayPilot.list($15).each(function(y){$i.$b0(y);});$i.$9x();};$i.$9O();$1c.load();$i.multiselect.redraw();if($1f){$1f();};this.$9e();};this.$ax=function($u){if($i.eventEndSpec==="DateTime"){return $u;};if($u.getDatePart().ticks===$u.ticks){return $u.addDays(-1);};return $u.getDatePart();};this.$b1=function($u){if($i.eventEndSpec==="DateTime"){return $u;};return $u.getDatePart().addDays(1);};this.$b2=function($u){if($i.eventEndSpec==="DateTime"){return $u;};return $u.getDatePart();};this.$b3=function(e,$0m,$0V,$10,external,ev,$0u){if($i.eventMoveHandling==='Disabled'){return;};$0V=$i.$ax($0V);var $l={};$l.e=e;$l.newStart=$0m;$l.newEnd=$0V;$l.newResource=$10;$l.external=external;$l.ctrl=false;$l.meta=false;$l.shift=false;if(ev){$l.shift=ev.shiftKey;$l.ctrl=ev.ctrlKey;$l.meta=ev.metaKey;};$l.multimove=DayPilot.list(mm.list);var $0Z={};$0Z.event=e;$0Z.start=$0m;$0Z.end=$0V;$l.multimove.splice(0,0,$0Z);$l.position=$0u;$l.preventDefault=function(){this.preventDefault.value=true;};if($i.$9G()){var $0W=function(){$0X.hide();if($l.preventDefault.value){$i.$b4();return;};$0m=$l.newStart;$0V=$l.newEnd;switch($i.eventMoveHandling){case 'PostBack':$i.eventMovePostBack($l);break;case 'CallBack':$i.eventMoveCallBack($l);break;case 'Notify':$i.eventMoveNotify($l);break;case 'Update':$i.$ay($l);break;};$i.$b4();if(typeof $i.onEventMoved==='function'){$i.onEventMoved($l);}};$l.async=false;$l.loaded=function(){$0W();};if(typeof $i.onEventMove==='function'){$i.onEventMove($l);};if(!$l.async){$0W();}else{if($i.blockOnCallBack){$0X.show();}}}else{switch($i.eventMoveHandling){case 'PostBack':$i.eventMovePostBack($l);break;case 'CallBack':$i.eventMoveCallBack($l);break;case 'JavaScript':$i.onEventMove(e,$0m,$0V,$10,external,ev?ev.ctrlKey:false,ev?ev.shiftKey:false,$0u);break;case 'Notify':$i.eventMoveNotify($l);break;case 'Update':$i.$ay($l);break;};$i.$b4();}};this.$ay=function($l){var e=$l.e;var $0m=$l.newStart;var $0V=$l.newEnd;var $10=$l.newResource;var external=$l.external;e.start($0m);e.end($0V);e.resource($10);if(external){e.commit();$i.events.add(e);}else{$i.events.update(e);};if($l.multimove&&!$l.multimove.isEmpty()){$l.multimove.each(function($00){if($00.event===e){return;};$00.event.start($00.start);$00.event.end($00.end);if(mm.rowoffset){var ri=$00.event.part.dayIndex+mm.rowoffset;var $10=$i.rowlist[ri].id;$00.event.resource($10);};$00.event.commit();$i.events.update($00.event);});};if($l.multiresize&&!$l.multiresize.isEmpty()){$l.multiresize.each(function($00){if($00.event===e){return;};$00.event.start($00.start);$00.event.end($00.end);$00.event.commit();$i.events.update($00.event);});};$i.$99();};this.$b5=function($l,$n){var $m=$i.$b6($n);var $0Q={};$0Q.args=$l;$0Q.guid=$m;$i.$ak("Bubble",$0Q);};this.$b6=function($n){var $m=DayPilot.guid();if(!this.bubbles){this.bubbles=[];};this.bubbles[$m]=$n;return $m;};this.eventMenuClickPostBack=function(e,$1i,$q){var $0Q={};$0Q.e=e;$0Q.command=$1i;this.$aj('EventMenuClick',$0Q,$q);};this.eventMenuClickCallBack=function(e,$1i,$q){var $0Q={};$0Q.e=e;$0Q.command=$1i;this.$ak('EventMenuClick',$0Q,$q);};this.$b7=function($1i,e,$1j){switch($1j){case 'PostBack':$i.eventMenuClickPostBack(e,$1i);break;case 'CallBack':$i.eventMenuClickCallBack(e,$1i);break;}};this.timeRangeSelectedPostBack=function($K,end,$1k,$q){var $1l={};$1l.start=$K;$1l.end=end;$1l.resource=$1k;this.$aj('TimeRangeSelected',$1l,$q);};this.timeRangeSelectedCallBack=function($K,end,$1k,$q){var $1l={};$1l.start=$K;$1l.end=end;$1l.resource=$1k;this.$ak('TimeRangeSelected',$1l,$q);};this.$b8=function($1l){if(!$1l){return;};if($1l.disabled){$i.clearSelection();return;};var $1m=$i.$b9($1l);if(!$1m){return;};$i.$ba($1m.start,$1m.end,$1m.resource);};this.$ba=function($K,end,$1k){if($i.timeRangeSelectedHandling==='Disabled'){return;};var $1n=end;end=$i.$ax($1n);var $l={};$l.start=$K;$l.end=end;$l.resource=$1k;$l.preventDefault=function(){this.preventDefault.value=true;};$l.multirange=DayPilot.list(mr.list).map(function($00){return $i.$b9($00);});if($l.multirange.isEmpty()){$l.multirange.push({"start":$l.start,"end":$l.end,"resource":$l.resource});};if($i.$9G()){if(typeof $i.onTimeRangeSelect==='function'){$i.onTimeRangeSelect($l);if($l.preventDefault.value){return;};$K=$l.start;end=$l.end;};$i.$bb(DayPilotScheduler.rangeHold,$K,end,$l.multirange);$i.$bc(DayPilotScheduler.rangeHold,true);switch($i.timeRangeSelectedHandling){case 'PostBack':$i.$aA("PostBack",$l);break;case 'CallBack':$i.$aA("CallBack",$l);break;};if(typeof $i.onTimeRangeSelected==='function'){$i.onTimeRangeSelected($l);}}else{switch($i.timeRangeSelectedHandling){case 'PostBack':$i.$aA("PostBack",$l);break;case 'CallBack':$i.$aA("CallBack",$l);break;case 'JavaScript':$i.onTimeRangeSelected($K,end,$1k,$l.multirange);break;case 'Hold':break;}}};this.$bb=function($1l,$K,end,$1o){if(!$1l||($1o&&$1o.length>1)){return;};var $1n=$i.$b1(end);var $0F,$P;var $1p=0;if($i.viewType==="Days"){var $I=$i.$bd($K);$1p=$I.start.getTime()-$i.$a6().getTime();};if($K.getTime()<$i.itline[0].start.getTime()){$1l.start.x=0;}else{$0F=$i.$ag($K.addTime(-$1p));$P=$0F.current||$0F.previous;$1l.start.x=DayPilot.indexOf($i.itline,$P);};$0F=$i.$ag($1n.addSeconds(-1).addTime(-$1p));if($0F.past){$1l.end.x=$i.itline.length-1;}else{$P=$0F.current||$0F.next;$1l.end.x=DayPilot.indexOf($i.itline,$P);}};this.$bd=function($K){var $0j=$K.getDatePart();return DayPilot.list($i.rowlist).find(function($00){return $00.start.getDatePart()===$0j;});};this.timeRangeDoubleClickPostBack=function($K,end,$1k,$q){var $1l={};$1l.start=$K;$1l.end=end;$1l.resource=$1k;this.$aj('TimeRangeDoubleClick',$1l,$q);};this.timeRangeDoubleClickCallBack=function($K,end,$1k,$q){var $1l={};$1l.start=$K;$1l.end=end;$1l.resource=$1k;this.$ak('TimeRangeDoubleClick',$1l,$q);};this.$be=function($K,end,$1k){end=$i.$ax(end);if($i.$9G()){var $l={};$l.start=$K;$l.end=end;$l.resource=$1k;$l.preventDefault=function(){this.preventDefault.value=true;};if(typeof $i.onTimeRangeDoubleClick==='function'){$i.onTimeRangeDoubleClick($l);if($l.preventDefault.value){return;}};switch($i.timeRangeDoubleClickHandling){case 'PostBack':$i.timeRangeDoubleClickPostBack($K,end,$1k);break;case 'CallBack':$i.timeRangeDoubleClickCallBack($K,end,$1k);break;};if(typeof $i.onTimeRangeDoubleClicked==='function'){$i.onTimeRangeDoubleClicked($l);}}else{switch($i.timeRangeDoubleClickHandling){case 'PostBack':$i.timeRangeDoubleClickPostBack($K,end,$1k);break;case 'CallBack':$i.timeRangeDoubleClickCallBack($K,end,$1k);break;case 'JavaScript':$i.onTimeRangeDoubleClick($K,end,$1k);break;}}};this.timeRangeMenuClickPostBack=function(e,$1i,$q){var $0Q={};$0Q.selection=e;$0Q.command=$1i;this.$aj("TimeRangeMenuClick",$0Q,$q);};this.timeRangeMenuClickCallBack=function(e,$1i,$q){var $0Q={};$0Q.selection=e;$0Q.command=$1i;this.$ak("TimeRangeMenuClick",$0Q,$q);};this.$bf=function($1i,e,$1j){switch($1j){case 'PostBack':$i.timeRangeMenuClickPostBack(e,$1i);break;case 'CallBack':$i.timeRangeMenuClickCallBack(e,$1i);break;}};this.linkMenuClickPostBack=function(e,$1i,$q){var $0Q={};$0Q.link=e;$0Q.command=$1i;this.$aj("LinkMenuClick",$0Q,$q);};this.linkMenuClickCallBack=function(e,$1i,$q){var $0Q={};$0Q.link=e;$0Q.command=$1i;this.$ak("LinkMenuClick",$0Q,$q);};this.$bg=function($1i,e,$1j){switch($1j){case 'PostBack':$i.linkMenuClickPostBack(e,$1i);break;case 'CallBack':$i.linkMenuClickCallBack(e,$1i);break;}};this.rowMenuClickPostBack=function(e,$1i,$q){var $0Q={};$0Q.resource=e;$0Q.command=$1i;this.$aj("RowMenuClick",$0Q,$q);};this.resourceHeaderMenuClickPostBack=this.rowMenuClickPostBack;this.rowMenuClickCallBack=function(e,$1i,$q){var $0Q={};$0Q.resource=e;$0Q.command=$1i;this.$ak("RowMenuClick",$0Q,$q);};this.resourceHeaderMenuClickCallBack=this.rowMenuClickCallBack;this.$bh=function($1i,e,$1j){switch($1j){case 'PostBack':$i.rowMenuClickPostBack(e,$1i);break;case 'CallBack':$i.rowMenuClickCallBack(e,$1i);break;}};this.$bi=function($I,$1q){var r=$1r.$bj($I);var c=r.cells[0];var $1s=c.textDiv;$1s.innerHTML=$1q;$I.Text=$1q;$I.html=$1q;};this.$bk=function($I,$1q){if(!$1q){return;};var $l={};$l.text=$1q;$l.preventDefault=function(){this.preventDefault.value=true;};if(typeof $i.onRowCreate==="function"){$i.onRowCreate($l);if($l.preventDefault.value){return;}};switch($i.rowCreateHandling){case "CallBack":$i.rowCreateCallBack($l.text);break;case "PostBack":$i.rowCreatePostBack($l.text);break;};if(typeof $i.onRowCreated==="function"){$i.onRowCreated($l);}};this.$bl=function($I,$1q){if($I.isNewRow){$i.$bk($I,$1q);return;};var $1t=DayPilot.indexOf($i.rowlist,$I);var e=$i.$bm($I,$1t);if($i.$9G()){var $l={};$l.resource=e;$l.newText=$1q;$l.preventDefault=function(){this.preventDefault.value=true;};if(typeof $i.onRowEdit==='function'){$i.onRowEdit($l);if($l.preventDefault.value){return;}};switch($i.rowEditHandling){case 'PostBack':$i.rowEditPostBack(e,$1q);break;case 'CallBack':$i.rowEditCallBack(e,$1q);break;case 'Update':$i.$bi($I,$1q);break;};if(typeof $i.onRowEdited==='function'){$i.onRowEdited($l);}}else{switch($i.rowEditHandling){case 'PostBack':$i.rowEditPostBack(e,$1q);break;case 'CallBack':$i.rowEditCallBack(e,$1q);break;case 'JavaScript':$i.onrowEdit(e,$1q);break;}}};this.rowCreatePostBack=function($1q,$q){var $0Q={};$0Q.text=$1q;this.$aj("RowCreate",$0Q,$q);};this.rowCreateCallBack=function($1q,$q){var $0Q={};$0Q.text=$1q;this.$ak("RowCreate",$0Q,$q);};this.rowEditPostBack=function(e,$1q,$q){var $0Q={};$0Q.resource=e;$0Q.newText=$1q;this.$aj("RowEdit",$0Q,$q);};this.rowEditCallBack=function(e,$1q,$q){var $0Q={};$0Q.resource=e;$0Q.newText=$1q;this.$ak("RowEdit",$0Q,$q);};this.rowMovePostBack=function($1u,$1v,$w,$q){var $0Q={};$0Q.source=$1u;$0Q.target=$1v;$0Q.position=$w;this.$aj("RowMove",$0Q,$q);};this.rowMoveCallBack=function($1u,$1v,$w,$q){var $0Q={};$0Q.source=$1u;$0Q.target=$1v;$0Q.position=$w;this.$ak("RowMove",$0Q,$q);};this.rowMoveNotify=function($1u,$1v,$w,$q){var $0Q={};$0Q.source=$1u;$0Q.target=$1v;$0Q.position=$w;this.$ak("RowMove",$0Q,$q,"Notify");};this.rowClickPostBack=function(e,$q){var $0Q={};$0Q.resource=e;this.$aj("RowClick",$0Q,$q);};this.resourceHeaderClickPostBack=this.rowClickPostBack;this.rowClickCallBack=function(e,$q){var $0Q={};$0Q.resource=e;this.$ak("RowClick",$0Q,$q);};this.resourceHeaderClickCallBack=this.rowClickCallBack;this.$bn=function(e,$17,$1w,$18){if($i.rowDoubleClickHandling==="Disabled"){$i.$bo(e,$17,$1w,$18);return;};if(!$i.timeouts.resClick){$i.timeouts.resClick=[];};var $1x=function(e,$17,$1w,$18){return function(){$i.$bo(e,$17,$1w,$18);};};$i.timeouts.resClick.push(window.setTimeout($1x(e,$17,$1w,$18),$i.doubleClickTimeout));};this.$bo=function(e,$17,$1w,$18){var $1y=$i.resourceHeaderClickHandling||$i.rowClickHandling;if($i.$9G()){var $l={};$l.resource=e;$l.row=e;$l.ctrl=$17;$l.shift=$1w;$l.meta=$18;$l.preventDefault=function(){this.preventDefault.value=true;};if(typeof $i.onRowClick==='function'){$i.onRowClick($l);if($l.preventDefault.value){return;}};if(typeof $i.onResourceHeaderClick==='function'){$i.onResourceHeaderClick($l);if($l.preventDefault.value){return;}};switch($1y){case 'PostBack':$i.rowClickPostBack(e);break;case 'CallBack':$i.rowClickCallBack(e);break;case 'Select':$i.$bp(e.$.row,$17,$1w,$18);break;case 'Edit':$i.$bq.edit(e.$.row);break;};if(typeof $i.onRowClicked==='function'){$i.onRowClicked($l);};if(typeof $i.onResourceHeaderClicked==='function'){$i.onResourceHeaderClicked($l);}}else{switch($1y){case 'PostBack':$i.rowClickPostBack(e);break;case 'CallBack':$i.rowClickCallBack(e);break;case 'JavaScript':$i.onRowClick(e);break;case 'Select':$i.$bp(e.$.row,$17,$1w);break;case 'Edit':$i.$bq.edit(e.$.row);break;}}};this.timeHeaderClickPostBack=function(e,$q){var $0Q={};$0Q.header=e;this.$aj("TimeHeaderClick",$0Q,$q);};this.timeHeaderClickCallBack=function(e,$q){var $0Q={};$0Q.header=e;this.$ak("TimeHeaderClick",$0Q,$q);};this.$br=function(e){if($i.$9G()){var $l={};$l.header=e;$l.preventDefault=function(){this.preventDefault.value=true;};if(typeof $i.onTimeHeaderClick==='function'){$i.onTimeHeaderClick($l);if($l.preventDefault.value){return;}};switch(this.timeHeaderClickHandling){case 'PostBack':$i.timeHeaderClickPostBack(e);break;case 'CallBack':$i.timeHeaderClickCallBack(e);break;};if(typeof $i.onTimeHeaderClicked==='function'){$i.onTimeHeaderClicked($l);}}else{switch(this.timeHeaderClickHandling){case 'PostBack':$i.timeHeaderClickPostBack(e);break;case 'CallBack':$i.timeHeaderClickCallBack(e);break;case 'JavaScript':$i.onTimeHeaderClick(e);break;}}};this.resourceCollapsePostBack=function(e,$q){var $0Q={};$0Q.resource=e;this.$aj("ResourceCollapse",$0Q,$q);};this.resourceCollapseCallBack=function(e,$q){var $0Q={};$0Q.resource=e;this.$ak("ResourceCollapse",$0Q,$q);};this.$bs=function(e){if($i.$9G()){var $l={};$l.resource=e;$l.preventDefault=function(){this.preventDefault.value=true;};if(typeof $i.onResourceCollapse==='function'){$i.onResourceCollapse($l);if($l.preventDefault.value){return;}};switch(this.resourceCollapseHandling){case 'PostBack':$i.resourceCollapsePostBack(e);break;case 'CallBack':$i.resourceCollapseCallBack(e);break;}}else{switch(this.resourceCollapseHandling){case 'PostBack':$i.resourceCollapsePostBack(e);break;case 'CallBack':$i.resourceCollapseCallBack(e);break;case 'JavaScript':$i.onResourceCollapse(e);break;}}};this.resourceExpandPostBack=function(e,$q){var $0Q={};$0Q.resource=e;this.$aj("ResourceExpand",$0Q,$q);};this.resourceExpandCallBack=function(e,$q){var $0Q={};$0Q.resource=e;this.$ak("ResourceExpand",$0Q,$q);};this.$bt=function(e){if($i.$9G()){var $l={};$l.resource=e;$l.preventDefault=function(){this.preventDefault.value=true;};if(typeof $i.onResourceExpand==='function'){$i.onResourceExpand($l);if($l.preventDefault.value){return;}};switch(this.resourceExpandHandling){case 'PostBack':$i.resourceExpandPostBack(e);break;case 'CallBack':$i.resourceExpandCallBack(e);break;}}else{switch(this.resourceExpandHandling){case 'PostBack':$i.resourceExpandPostBack(e);break;case 'CallBack':$i.resourceExpandCallBack(e);break;case 'JavaScript':$i.onResourceExpand(e);break;}}};this.eventEditPostBack=function(e,$1q,$q){var $0Q={};$0Q.e=e;$0Q.newText=$1q;this.$aj("EventEdit",$0Q,$q);};this.eventEditCallBack=function(e,$1q,$q){var $0Q={};$0Q.e=e;$0Q.newText=$1q;this.$ak("EventEdit",$0Q,$q);};this.$bu=function(e,$1q,$1z){if($i.$9G()){var $l={};$l.e=e;$l.newText=$1q;$l.canceled=$1z;$l.preventDefault=function(){this.preventDefault.value=true;};if(typeof $i.onEventEdit==='function'){$i.onEventEdit($l);if($l.preventDefault.value){return;}};if(!$1z){switch($i.eventEditHandling){case 'PostBack':$i.eventEditPostBack(e,$1q);break;case 'CallBack':$i.eventEditCallBack(e,$1q);break;case 'Update':e.text($1q);$i.events.update(e);break;}};if(typeof $i.onEventEdited==='function'){$i.onEventEdited($l);if($l.preventDefault.value){return;}}}else{switch($i.eventEditHandling){case 'PostBack':$i.eventEditPostBack(e,$1q);break;case 'CallBack':$i.eventEditCallBack(e,$1q);break;case 'JavaScript':$i.onEventEdit(e,$1q);break;}}};this.commandCallBack=function($1i,$q){this.$bv("CallBack",$1i,$q);};this.commandPostBack=function($1i,$q){this.$bv("PostBack",$1i,$q);};this.$bv=function($X,$1i,$q){var $0Q={};$0Q.command=$1i;this.$av($X,"Command",$0Q,$q);};this.$aj=function($14,$1A,$q){var $1B={};$1B.action=$14;$1B.type="PostBack";$1B.parameters=$1A;$1B.data=$q;$1B.header=this.$bw();var $1C="JSON"+DayPilot.JSON.stringify($1B);__doPostBack($i.uniqueID,$1C);};this.$ak=function($14,$1A,$q,$X){if(!$i.$a2()){$i.debug.message("Callback invoked without the server-side backend specified. Callback canceled.","warning");return;};if(typeof $X==='undefined'){$X="CallBack";};this.$bx();$i.$by();var $1B={};$1B.action=$14;$1B.type=$X;$1B.parameters=$1A;$1B.data=$q;$1B.header=this.$bw();var $1D=DayPilot.JSON.stringify($1B);var $1C;if(typeof Iuppiter!=='undefined'&&Iuppiter.compress){$1C="LZJB"+Iuppiter.Base64.encode(Iuppiter.compress($1D));}else{$1C="JSON"+$1D;};this.$bz($1B);var $k=null;if(this.backendUrl){DayPilot.request(this.backendUrl,this.$bA,$1C,this.$bB);}else if(typeof WebForm_DoCallback==='function'){WebForm_DoCallback(this.uniqueID,$1C,this.$98,$k,this.callbackError,true);}};this.$bz=function($1B){var $l={};if(typeof $i.onCallBackStart==='function'){$i.onCallBackStart($l);}};this.$9d=function(){var $l={};if(typeof $i.onCallBackEnd==='function'){setTimeout(function(){$i.onCallBackEnd($l);},0);}};this.$a2=function(){if(this.backendUrl){return true;};if(this.$bC()){return true;};return false;};this.$bC=function(){if(typeof WebForm_DoCallback==='function'&&this.uniqueID){return true;};return false;};this.$bB=function($1E){if(typeof $i.onAjaxError==='function'){var $l={};$l.request=$1E;$i.onAjaxError($l);}else if(typeof $i.ajaxError==='function'){$i.ajaxError($1E);}};this.$bA=function($1F){$i.$98($1F.responseText);};this.$bw=function(){var h={};h.v=this.v;h.control="dps";h.id=this.id;h.startDate=$i.startDate;h.days=$i.days;h.cellDuration=$i.cellDuration;h.cellGroupBy=$i.cellGroupBy;h.cellWidth=$i.cellWidth;h.cellWidthSpec=$i.cellWidthSpec;h.viewType=$i.viewType;h.hourNameBackColor=$i.hourNameBackColor;h.showNonBusiness=$i.showNonBusiness;h.businessBeginsHour=$i.businessBeginsHour;h.businessEndsHour=$i.businessEndsHour;h.weekStarts=$i.weekStarts;h.treeEnabled=$i.treeEnabled;h.locale=$i.locale;h.timeZone=$i.timeZone;h.tagFields=$i.tagFields;h.timeHeaders=$i.timeHeaders;h.cssOnly=$i.cssOnly;h.cssClassPrefix=$i.cssClassPrefix;h.durationBarMode=$i.durationBarMode;h.showBaseTimeHeader=true;h.rowHeaderColumns=$i.rowHeaderColumns;h.rowMarginBottom=$i.rowMarginBottom;h.rowMarginTop=$i.rowMarginTop;h.rowMinHeight=$i.rowMinHeight;h.scale=$i.scale;h.clientState=$i.clientState;if(this.nav.scroll){h.scrollX=this.nav.scroll.scrollLeft;h.scrollY=this.nav.scroll.scrollTop;};h.selected=$i.multiselect.events();h.selectedRows=$1r.$bD();h.hashes=$i.hashes;var $J=$i.$bE(h.scrollX,h.scrollY);var $1l=$i.$bF($J);var $1G=$i.$bG($J);h.rangeStart=$1l.start;h.rangeEnd=$1l.end;h.resources=$1G;h.dynamicLoading=$i.dynamicLoading;h.separators=this.separators;if(this.syncResourceTree&&this.viewType!="Days"){h.tree=this.$bH();};if(this.syncLinks){h.links=this.$bI();};if(this.scale==="Manual"){h.timeline=this.$bJ();};if(typeof $i.onCallBackHeader==="function"){var $l={};$l.header=h;$i.onCallBackHeader($l);};return h;};this.$bJ=function(){var $Y=[];DayPilot.list($i.timeline).each(function($00){var $1D={};$1D.start=$00.start;$1D.end=$00.end;$1D.width=$00.width;$Y.push($1D);});return $Y;};this.$bI=function(){var $Y=[];var $1H=function(link){var $j={};if(link.tags){for(var name in link.tags){$j[name]=""+link.tags[name];}};return $j;};if(!DayPilot.isArray($i.links.list)){return $Y;};for(var i=0;i<$i.links.list.length;i++){var link=$i.links.list[i];var $1D={};$1D.id=link.id;$1D.from=link.from;$1D.to=link.to;$1D.type=link.type;$1D.tags=$1H(link);$Y.push($1D);};return $Y;};this.getViewPort=function(){var scrollX=this.nav.scroll.scrollLeft-$L.shiftX;var scrollY=this.nav.scroll.scrollTop;var $J=this.$bE(scrollX,scrollY);var $1l=this.$bF($J);var $1I=this.$bG($J);var $j={};$j.start=$1l.start;$j.end=$1l.end;$j.resources=$1I;return $j;};this.$bE=function(scrollX,scrollY){var $J={};$J.start={};$J.end={};$J.start.x=Math.floor(scrollX/$i.cellWidth);$J.end.x=Math.floor((scrollX+$i.nav.scroll.clientWidth)/$i.cellWidth);$J.start.y=$i.$bK(scrollY).i;$J.end.y=$i.$bK(scrollY+$i.nav.scroll.clientHeight).i;var $1J=this.itline.length;if($J.end.x>=$1J){$J.end.x=$1J-1;};return $J;};this.$bF=function($J){var $j={};if(this.itline.length<=0){$j.start=this.startDate;$j.end=this.startDate;return $j;};if(!this.itline[$J.start.x]){throw 'Internal error: area.start.x is null.';};$j.start=this.itline[$J.start.x].start;$j.end=this.itline[$J.end.x].end;return $j;};this.$bG=function($J){if(!$J){var $J=this.$bE(this.nav.scroll.scrollLeft,this.nav.scroll.scrollTop);};var $1G=[];$1G.ignoreToJSON=true;for(var i=$J.start.y;i<=$J.end.y;i++){var r=$i.rowlist[i];if(r&&!r.hidden){$1G.push(r.id);}};return $1G;};this.$bH=function(){var $1K=[];$1K.ignoreToJSON=true;for(var i=0;i<this.rowlist.length;i++){var $I=this.rowlist[i];if($I.level>0){continue;};if($I.isNewRow){continue;};var $1L=this.$bL(i);$1K.push($1L);};return $1K;};this.$bM=function($1M){var $1N=[];$1N.ignoreToJSON=true;for(var i=0;i<$1M.length;i++){var $1t=$1M[i];var $I=$i.rowlist[$1t];if($I.isNewRow){continue;};$1N.push($i.$bL($1t));};return $1N;};this.$bL=function(i){var $I=this.rowlist[i];if(typeof $i.onGetNodeState==="function"){var $l={};$l.row=$I;$l.preventDefault=function(){$l.preventDefault.value=true;};$l.result={};$i.onGetNodeState($l);if($l.preventDefault.value){return $l.result;}};var $1L={};$1L.Value=$I.id;$1L.BackColor=$I.backColor;$1L.Name=$I.name;$1L.InnerHTML=$I.html;$1L.ToolTip=$I.toolTip;$1L.Expanded=$I.expanded;$1L.Children=this.$bM($I.children);$1L.Loaded=$I.loaded;$1L.IsParent=$I.isParent;$1L.Columns=this.$bN($I);if($I.start.getTime()!==$i.$a6().getTime()){$1L.Start=$I.start;};if($I.minHeight!==$i.rowMinHeight){$1L.MinHeight=$I.minHeight;};if($I.marginBottom!==$i.rowMarginBottom){$1L.MarginBottom=$I.marginBottom;};if($I.marginTop!==$i.rowMarginTop){$1L.MarginTop=$I.marginTop;};if($I.eventHeight!==$i.eventHeight){$1L.EventHeight=$I.eventHeight;};return $1L;};this.$bN=function($I){if(!$I.columns||$I.columns.length===0){return null;};var $1O=[];$1O.ignoreToJSON=true;for(var i=0;i<$I.columns.length;i++){var c={};c.InnerHTML=$I.columns[i].html;$1O.push(c);};return $1O;};this.$9S=function($1P){var $1Q=this.theme||this.cssClassPrefix;if($1Q){return $1Q+$1P;}else{return "";}};this.$bO=function(){this.nav.top.dispose=this.dispose;};this.dispose=function(){var c=$i;if(c.$8Y){return;};c.$8Y=true;c.$bx();c.$9u();c.divBreaks=null;c.divCells=null;c.divCorner=null;c.divCrosshair=null;c.divEvents=null;if(c.divHeader){c.divHeader.rows=null;};c.divHeader=null;c.divLines=null;c.divNorth=null;c.divRange=null;c.divResScroll=null;c.divSeparators=null;c.divSeparatorsAbove=null;c.divStretch=null;c.divTimeScroll=null;c.$9Z=null;c.$9f=null;c.$9H.calendar=null;c.$9H=null;c.nav.loading=null;c.nav.top.onmousemove=null;c.nav.top.dispose=null;c.nav.top.ontouchstart=null;c.nav.top.ontouchmove=null;c.nav.top.ontouchend=null;c.nav.top.removeAttribute('style');c.nav.top.removeAttribute('class');c.nav.top.innerHTML="";c.nav.top.dp=null;c.nav.top=null;c.nav.scroll.onscroll=null;c.nav.scroll.root=null;c.nav.scroll=null;DayPilot.ue(window,'resize',c.$bP);DayPilotScheduler.unregister(c);};this.$bQ=function($1R,$X){var $1S=$i.$9H;var $1T=$i.$bR($1R);var event=$1R.event;var $R=event.part.height||$i.$bS.eventHeight();var top=(event.part&&event.part.top)?(event.part.top+$i.rowlist[event.part.dayIndex].top):$1T.top;var $1U=document.createElement('div');$1U.setAttribute('unselectable','on');$1U.style.position='absolute';$1U.style.width=($1T.width)+'px';$1U.style.height=$R+'px';$1U.style.left=$1T.left+'px';$1U.style.top=top+'px';$1U.style.zIndex=101;$1U.style.overflow='hidden';var $05=document.createElement("div");$1U.appendChild($05);if(this.cssOnly){$1U.className=this.$9S("_shadow");$05.className=this.$9S("_shadow_inner");};if(!this.cssOnly){if($X==='Fill'){$05.style.backgroundColor="#aaaaaa";$05.style.opacity=0.5;$05.style.filter="alpha(opacity=50)";$05.style.height="100%";if($1R&&$1R.event&&$1R.style){$05.style.fontSize=$1R.style.fontSize;$05.style.fontFamily=$1R.style.fontFamily;$05.style.color=$1R.style.color;$05.innerHTML=$1R.event.client.innerHTML();}}else{$1U.style.paddingTop="2px";$05.style.border='2px dotted #666666';}};$1S.appendChild($1U);$1U.calendar=$i;return $1U;};this.$bT=function($1R,$X){var $1S=$i.$9H;var $1T=$i.$bR($1R);var event=$1R.event;var ev=event;if($i.$bU($1T.rowIndex)){return;};var $R=event.part.height||$i.$bS.eventHeight();var top=(event.part&&event.part.top)?(event.part.top+$i.rowlist[event.part.dayIndex].top):$1T.top;var $N=$1T.left;var $1V=(ev.cache&&typeof ev.cache.moveVDisabled!=='undefined')?!ev.cache.moveVDisabled:!ev.data.moveVDisabled;var $1W=(ev.cache&&typeof ev.cache.moveHDisabled!=='undefined')?!ev.cache.moveHDisabled:!ev.data.moveHDisabled;if(!$1V&&DayPilotScheduler.moving){top=$i.rowlist[ev.part.dayIndex].top;};if(!$1W&&DayPilotScheduler.moving){$N=event.part.left;};var $1U=document.createElement('div');$1U.setAttribute('unselectable','on');$1U.style.position='absolute';$1U.style.width=($1T.width)+'px';$1U.style.height=$R+'px';$1U.style.left=$N+'px';$1U.style.top=top+'px';$1U.style.zIndex=101;$1U.style.overflow='hidden';var $05=document.createElement("div");$1U.appendChild($05);if(this.cssOnly){$1U.className=this.$9S("_shadow");$05.className=this.$9S("_shadow_inner");};if(!this.cssOnly){if($X==='Fill'){$05.style.backgroundColor="#aaaaaa";$05.style.opacity=0.5;$05.style.filter="alpha(opacity=50)";$05.style.height="100%";if($1R&&$1R.event&&$1R.style){$05.style.fontSize=$1R.style.fontSize;$05.style.fontFamily=$1R.style.fontFamily;$05.style.color=$1R.style.color;$05.innerHTML=$1R.event.client.innerHTML();}}else{$1U.style.paddingTop="2px";$05.style.border='2px dotted #666666';}};$1S.appendChild($1U);$1U.calendar=$i;return $1U;};this.$bK=function(y){var $j={};var element;var top=0;var $1X=0;var $1Y=this.rowlist.length;for(var i=0;i<$1Y;i++){var $I=this.rowlist[i];if($I.hidden){continue;};$1X+=$I.height;if(y<$1X||i===$1Y-1){top=$1X-$I.height;element=$I;break;}};$j.top=top;$j.bottom=$1X;$j.i=i;$j.element=element;return $j;};this.links={};var $1c={};this.$bV=$1c;$1c.clear=function(){$i.divLinksAbove.innerHTML='';$i.divLinksBelow.innerHTML='';$i.elements.links=[];};$1c.showLinkpoints=function(){var $Z=$Q.events();$Z.each(function($02){$1c.showLinkpoint($02);});};$1c.showLinkpoint=function($02){var $z=$i.linkPointSize;var $1Z=$z/2;var $N=$02.event.part.left;var top=$i.rowlist[$02.event.part.dayIndex].top+$02.event.part.top;var $R=$02.event.part.height;var $O=$02.event.part.right;var $K=DayPilot.Util.div($i.divLinkpoints,$N-$1Z,top-$1Z+$R/2,$z,$z);$K.className=$i.$9S("_linkpoint");$K.style.boxSizing="border-box";$K.coords={x:$N,y:top+$R/2};$K.type="Start";$K.event=$02.event;$1c.activateLinkpoint($K);$i.elements.linkpoints.push($K);var end=DayPilot.Util.div($i.divLinkpoints,$O-$1Z,top-$1Z+$R/2,$z,$z);end.className=$i.$9S("_linkpoint");end.style.boxSizing="border-box";end.coords={x:$O,y:top+$R/2};end.type="Finish";end.event=$02.event;$1c.activateLinkpoint(end);$i.elements.linkpoints.push(end);};$1c.activateLinkpoint=function($02){$02.onmousedown=function(ev){var ev=ev||window.event;$20.source=$02;$20.calendar=$i;$1c.showLinkpoints();ev.preventDefault&&ev.preventDefault();ev.stopPropagation&&ev.stopPropagation();return false;};$02.onmousemove=function(ev){DayPilot.Util.addClass($02,$i.$9S("_linkpoint_hover"));$1c.clearHideTimeout();};$02.onmouseout=function(ev){if(!$20.source||$20.source.event!==$02.event){DayPilot.Util.removeClass($02,$i.$9S("_linkpoint_hover"));}};$02.onmouseup=function(ev){if($20.source){var $X=$20.source.type+"To"+$02.type;var $21=$20.source.event.id();var to=$02.event.id();var $l={};$l.from=$21;$l.to=to;$l.type=$X;$l.id=null;$l.preventDefault=function(){this.preventDefault.value=true;};if(typeof $i.onLinkCreate==="function"){$i.onLinkCreate($l);if($l.preventDefault.value){return;}};var $22=function(){$i.links.list.push({"from":$21,"to":to,"type":$X,"id":$l.id});$1c.load();};switch($i.linkCreateHandling){case "Update":$22();break;case "CallBack":$i.$bW($l);break;case "PostBack":$i.$bX($l);break;case "Notify":$22();$i.$bY($l);break;};if(typeof $i.onLinkCreated==="function"){$i.onLinkCreated($l);}}};};$1c.hideLinkpoints=function(){$i.divLinkpoints.innerHTML='';$i.elements.linkpoints=[];};$1c.hideTimeout=null;$1c.hideLinkpointsWithDelay=function(){$1c.hideTimeout=setTimeout(function(){$1c.hideLinkpoints();},100);};$1c.clearHideTimeout=function(){if($1c.hideTimeout){clearTimeout($1c.hideTimeout);$1c.hideTimeout=null;}};$1c.load=function(){$1c.clear();if(!DayPilot.isArray($i.links.list)){return;};for(var i=0;i<$i.links.list.length;i++){var link=$i.links.list[i];$1c.drawLinkId(link.from,link.to,link);}};$1c.drawLinkId=function($21,to,$23){var $K=$i.events.find($21);var end=$i.events.find(to);$1c.drawLink($K,end,$23);};$1c.drawLink=function($21,to,$23){var $24=$i.$bZ($21);var $25=$i.$bZ(to);if(!$24){return;};if(!$25){return;};var $X=$23.type||"FinishToStart";var $K,end;var $26=$i.rowlist[$24.event.part.dayIndex].top;var $27=$i.rowlist[$25.event.part.dayIndex].top;switch($X){case "FinishToStart":$K={x:$24.event.part.right,y:$26+$24.event.part.top};end={x:$25.event.part.left,y:$27+$25.event.part.top};if($K.y>end.y){if($K.x<end.x){end.y+=$25.event.part.height;}else{}};break;case "StartToFinish":$K={x:$24.event.part.left,y:$26+$24.event.part.top};end={x:$25.event.part.right,y:$27+$25.event.part.top};break;case "StartToStart":$K={x:$24.event.part.left,y:$26+$24.event.part.top};end={x:$25.event.part.left,y:$27+$25.event.part.top};break;case "FinishToFinish":$K={x:$24.event.part.right,y:$26+$24.event.part.top};end={x:$25.event.part.right,y:$27+$25.event.part.top};break;};$1c.drawLinkXy($K,end,$23);};$1c.clearShadow=function(){$i.divLinkShadow.innerHTML='';$i.elements.linkshadow=[];};$1c.drawShadow=function($21,to){$1c.clearShadow();if(DayPilot.browser.ielt9){$1c.drawShadowOldStyle($21,to);}else{var parent=$i.divLinkShadow;var $0u=DayPilot.line($21.x,$21.y,to.x,to.y,true);parent.appendChild($0u);$i.elements.linkshadow.push($0u);}};$1c.drawShadowOldStyle=function($21,to){var nx=Math.min($21.x,to.x);var $z=2;var parent=$i.divLinkShadow;var $28="black";var h1=DayPilot.Util.div(parent,nx,$21.y,$21.x-nx,$z);h1.style.backgroundColor=$28;$i.elements.linkshadow.push(h1);var v1=DayPilot.Util.div(parent,nx,$21.y,$z,to.y-$21.y);v1.style.backgroundColor=$28;$i.elements.linkshadow.push(v1);var h3=DayPilot.Util.div(parent,nx,to.y,to.x-nx,$z);h3.style.backgroundColor=$28;$i.elements.linkshadow.push(h3);var a=DayPilot.Util.div(parent,to.x-6,to.y-5,0,0);a.style.borderColor="transparent transparent transparent "+$28;a.style.borderStyle="solid";a.style.borderWidth="6px";$i.elements.linkshadow.push(a);};$1c.drawLinkXy=function($21,to,$23){var $29=$i.eventHeight/2;var $z=$23.width||1;var $X=$23.type||"FinishToStart";var $28=$23.color;var style=$23.style;var $2a=$23.layer||"Above";var $2b=$2a==="Above";var $2c=$2b?$i.divLinksAbove:$i.divLinksBelow;var $R=$i.eventHeight;var $W=$i.linkBottomMargin;var $2d=function($02,$2e){if($28){$02.style["border"+$2e+"Color"]=$28;};if(style){$02.style["border"+$2e+"Style"]=style;}};var $2f=[];var $2g=function($02,$2h){$i.elements.links.push($02);$2i($02);$2j($02);$02.divs=$2f;if(!$2h){$2f.push($02);}};var $2j=function($02){$02.oncontextmenu=function(ev){ev=ev||window.event;if($i.contextMenuLink){var link=new DayPilot.Link($23,$i);$i.contextMenuLink.show(link);};ev.cancelBubble=true;ev.preventDefault?ev.preventDefault():null;}};var $2i=function($02){$02.onmouseenter=function(){DayPilot.Util.addClass($02.divs,$i.$9S("_link_hover"));};$02.onmouseleave=function(){DayPilot.Util.removeClass($02.divs,$i.$9S("_link_hover"));};};if($X==="FinishToStart"){if($21.y>to.y){if($21.x<to.x){}else{var $2b=5;var $2k=to.y+$2b;var h1=DayPilot.Util.div($2c,$21.x,$21.y+$R-$W,$29+$z,$z);h1.style.boxSizing="border-box";h1.style.borderBottomWidth=$z+"px";h1.className=$i.$9S("_link_horizontal");DayPilot.Util.addClass(h1,$23.cssClass);$2d(h1,"Bottom");$2g(h1);var v1=DayPilot.Util.div($2c,$21.x+$29,$21.y+$R-$W,$z,$2k-($21.y+$R-$W));v1.style.boxSizing="border-box";v1.style.borderRightWidth=$z+"px";v1.className=$i.$9S("_link_vertical");DayPilot.Util.addClass(v1,$23.cssClass);$2d(v1,"Right");$2g(v1);var h2=DayPilot.Util.div($2c,to.x-$29,$2k,$21.x+2*$29+$z-to.x,$z);h2.style.boxSizing="border-box";h2.style.borderBottomWidth=$z+"px";h2.className=$i.$9S("_link_horizontal");DayPilot.Util.addClass(h2,$23.cssClass);$2d(h2,"Bottom");$2g(h2);var v2=DayPilot.Util.div($2c,to.x-$29,$2k,$z,to.y-$2k+$R-$W);v2.style.boxSizing="border-box";v2.style.borderRightWidth=$z+"px";v2.className=$i.$9S("_link_vertical");DayPilot.Util.addClass(v2,$23.cssClass);$2d(v2,"Right");$2g(v2);var h3=DayPilot.Util.div($2c,to.x-$29,to.y+$R-$W,$29,$z);h3.style.boxSizing="border-box";h3.style.borderBottomWidth=$z+"px";h3.className=$i.$9S("_link_horizontal");DayPilot.Util.addClass(h3,$23.cssClass);$2d(h3,"Bottom");$2g(h3);var a;if($28){a=DayPilot.Util.div($2c,to.x-6,to.y+$R-$W-5,0,0);a.style.borderWidth="6px";a.style.borderColor="transparent transparent transparent "+$28;a.style.borderStyle="solid";}else{a=DayPilot.Util.div($2c,to.x-6,to.y+$R-$W-5,6,6);a.className=$i.$9S("_link_arrow_right");DayPilot.Util.addClass(a,$23.cssClass);};$2g(a,true);}}else if($21.y===to.y){if($21.x<to.x){var $2l=$21.x;var $2m=$21.y+$R-$W;var $2n=to.x;var h1=DayPilot.Util.div($2c,$2l,$2m,$2n-$21.x,$z);h1.style.boxSizing="border-box";h1.style.borderBottomWidth=$z+"px";h1.className=$i.$9S("_link_horizontal");DayPilot.Util.addClass(h1,$23.cssClass);$2d(h1,"Bottom");$2g(h1);var a;if($28){a=DayPilot.Util.div($2c,to.x-6,to.y+$R-$W-5,0,0);a.style.borderWidth="6px";a.style.borderColor="transparent transparent transparent "+$28;a.style.borderStyle="solid";}else{a=DayPilot.Util.div($2c,to.x-6,to.y+$R-$W-5,6,6);a.className=$i.$9S("_link_arrow_right");DayPilot.Util.addClass(a,$23.cssClass);};$2g(a,true);}else{}}else{if($21.x>to.x){var $2b=5;var $2k=to.y-$2b;var h1=DayPilot.Util.div($2c,$21.x,$21.y+$R-$W,$29+$z,$z);h1.style.boxSizing="border-box";h1.style.borderBottomWidth=$z+"px";h1.className=$i.$9S("_link_horizontal");DayPilot.Util.addClass(h1,$23.cssClass);$2d(h1,"Bottom");$2g(h1);var v1=DayPilot.Util.div($2c,$21.x+$29,$21.y+$R-$W,$z,$2k-($21.y+$R-$W));v1.style.boxSizing="border-box";v1.style.borderRightWidth=$z+"px";v1.className=$i.$9S("_link_vertical");DayPilot.Util.addClass(v1,$23.cssClass);$2d(v1,"Right");$2g(v1);var h2=DayPilot.Util.div($2c,to.x-$29,$2k,$21.x+2*$29+$z-to.x,$z);h2.style.boxSizing="border-box";h2.style.borderBottomWidth=$z+"px";h2.className=$i.$9S("_link_horizontal");DayPilot.Util.addClass(h2,$23.cssClass);$2d(h2,"Bottom");$2g(h2);var v2=DayPilot.Util.div($2c,to.x-$29,$2k,$z,to.y-$2k+$R-$W);v2.style.boxSizing="border-box";v2.style.borderRightWidth=$z+"px";v2.className=$i.$9S("_link_vertical");DayPilot.Util.addClass(v2,$23.cssClass);$2d(v2,"Right");$2g(v2);var h3=DayPilot.Util.div($2c,to.x-$29,to.y+$R-$W,$29,$z);h3.style.boxSizing="border-box";h3.style.borderBottomWidth=$z+"px";h3.className=$i.$9S("_link_horizontal");DayPilot.Util.addClass(h3,$23.cssClass);$2d(h3,"Bottom");$2g(h3);var a;if($28){a=DayPilot.Util.div($2c,to.x-6,to.y+$R-$W-5,0,0);a.style.borderWidth="6px";a.style.borderColor="transparent transparent transparent "+$28;a.style.borderStyle="solid";}else{a=DayPilot.Util.div($2c,to.x-6,to.y+$R-$W-5,6,6);a.className=$i.$9S("_link_arrow_right");DayPilot.Util.addClass(a,$23.cssClass);};$2g(a,true);}else{var $2l=$21.x;var $2m=$21.y+$R-$W;var $2n=to.x+$29;var $2o=to.y;var h1=DayPilot.Util.div($2c,$2l,$2m,$2n-$21.x,$z);h1.style.boxSizing="border-box";h1.style.borderBottomWidth=$z+"px";h1.className=$i.$9S("_link_horizontal");DayPilot.Util.addClass(h1,$23.cssClass);$2d(h1,"Bottom");$2g(h1);var v1=DayPilot.Util.div($2c,$2n,$2m,$z,$2o-$2m);v1.style.boxSizing="border-box";v1.style.borderRightWidth=$z+"px";v1.className=$i.$9S("_link_vertical");DayPilot.Util.addClass(v1,$23.cssClass);$2d(v1,"Right");$2g(v1);var a;if($28){a=DayPilot.Util.div($2c,$2n-5+Math.floor($z/2),$2o-5,0,0);if($21.y<to.y){a.style.borderColor=$28+" transparent transparent transparent";}else{a.style.borderColor="transparent transparent "+$28+"transparent";};a.style.borderStyle="solid";a.style.borderWidth="5px";}else{a=DayPilot.Util.div($2c,$2n-6+Math.floor($z/2),$2o-6,6,6);if($21.y<to.y){a.className=$i.$9S("_link_arrow_down");}else{a.className=$i.$9S("_link_arrow_up");};DayPilot.Util.addClass(a,$23.cssClass);};$2g(a,true);}}}else if($X==="StartToFinish"){var $2b=5;var $2k=to.y-$2b;var h1=DayPilot.Util.div($2c,to.x,to.y+$R-$W,$29+$z,$z);h1.style.boxSizing="border-box";h1.style.borderBottomWidth=$z+"px";h1.className=$i.$9S("_link_horizontal");DayPilot.Util.addClass(h1,$23.cssClass);$2d(h1,"Bottom");$2g(h1);var v1=DayPilot.Util.div($2c,to.x+$29,to.y+$R-$W,$z,$2k-(to.y+$R-$W)+0);v1.style.boxSizing="border-box";v1.style.borderRightWidth=$z+"px";v1.className=$i.$9S("_link_vertical");DayPilot.Util.addClass(v1,$23.cssClass);$2d(v1,"Right");$2g(v1);var h2=DayPilot.Util.div($2c,$21.x-$29,$2k,to.x+2*$29+$z-$21.x,$z);h2.style.boxSizing="border-box";h2.style.borderBottomWidth=$z+"px";h2.className=$i.$9S("_link_horizontal");DayPilot.Util.addClass(h2,$23.cssClass);$2d(h2,"Bottom");$2g(h2);var v2=DayPilot.Util.div($2c,$21.x-$29,$2k,$z,$21.y+$R-$W-$2k+0);v2.style.boxSizing="border-box";v2.style.borderRightWidth=$z+"px";v2.className=$i.$9S("_link_vertical");DayPilot.Util.addClass(v2,$23.cssClass);$2d(v2,"Right");$2g(v2);var h3=DayPilot.Util.div($2c,$21.x-$29,$21.y+$R-$W,$29,$z);h3.style.boxSizing="border-box";h3.style.borderBottomWidth=$z+"px";h3.className=$i.$9S("_link_horizontal");DayPilot.Util.addClass(h3,$23.cssClass);$2d(h3,"Bottom");$2g(h3);var a;if($28){a=DayPilot.Util.div($2c,to.x-6,to.y+$R-$W-5,0,0);a.style.borderColor="transparent "+$28+" transparent transparent";a.style.borderStyle="solid";a.style.borderWidth="6px";}else{a=DayPilot.Util.div($2c,to.x-6,to.y+$R-$W-5,6,6);a.className=$i.$9S("_link_arrow_left");DayPilot.Util.addClass(a,$23.cssClass);};$2g(a,true);}else if($X==="StartToStart"){var nx=Math.min($21.x,to.x)-$29;var h1=DayPilot.Util.div($2c,nx,$21.y+$R-$W,$21.x-nx,$z);h1.style.boxSizing="border-box";h1.style.borderBottomWidth=$z+"px";h1.className=$i.$9S("_link_horizontal");DayPilot.Util.addClass(h1,$23.cssClass);$2d(h1,"Bottom");$2g(h1);var v1=DayPilot.Util.div($2c,nx,$21.y+$R-$W,$z,to.y-$21.y);v1.style.boxSizing="border-box";v1.style.borderRightWidth=$z+"px";v1.className=$i.$9S("_link_vertical");DayPilot.Util.addClass(v1,$23.cssClass);$2d(v1,"Right");$2g(v1);var h3=DayPilot.Util.div($2c,nx,to.y+$R-$W,to.x-nx,$z);h3.style.boxSizing="border-box";h3.style.borderBottomWidth=$z+"px";h3.className=$i.$9S("_link_horizontal");DayPilot.Util.addClass(h3,$23.cssClass);$2d(h3,"Bottom");$2g(h3);var a;if($28){a=DayPilot.Util.div($2c,to.x-6,to.y+$R-$W-5,0,0);a.style.borderColor="transparent transparent transparent "+$28;a.style.borderStyle="solid";a.style.borderWidth="6px";}else{a=DayPilot.Util.div($2c,to.x-6,to.y+$R-$W-5,6,6);a.className=$i.$9S("_link_arrow_right");DayPilot.Util.addClass(a,$23.cssClass);};$2g(a,true);}else if($X==="FinishToFinish"){var fx=Math.max(to.x,$21.x)+$29;var h1=DayPilot.Util.div($2c,$21.x,$21.y+$R-$W,fx-$21.x,$z);h1.style.boxSizing="border-box";h1.style.borderBottomWidth=$z+"px";h1.className=$i.$9S("_link_horizontal");DayPilot.Util.addClass(h1,$23.cssClass);$2d(h1,"Bottom");$2g(h1);var v1=DayPilot.Util.div($2c,fx,$21.y+$R-$W,$z,to.y-$21.y);v1.style.boxSizing="border-box";v1.style.borderRightWidth=$z+"px";v1.className=$i.$9S("_link_vertical");DayPilot.Util.addClass(v1,$23.cssClass);$2d(v1,"Right");$2g(v1);var h3=DayPilot.Util.div($2c,to.x,to.y+$R-$W,fx-to.x,$z);h3.style.boxSizing="border-box";h3.style.borderBottomWidth=$z+"px";h3.className=$i.$9S("_link_horizontal");DayPilot.Util.addClass(h3,$23.cssClass);$2d(h3,"Bottom");$2g(h3);var a;if($28){a=DayPilot.Util.div($2c,to.x-6,to.y+$R-$W-5,0,0);a.style.borderColor="transparent "+$28+" transparent transparent";a.style.borderStyle="solid";a.style.borderWidth="6px";}else{a=DayPilot.Util.div($2c,to.x-6,to.y+$R-$W-5,6,6);a.className=$i.$9S("_link_arrow_left");DayPilot.Util.addClass(a,$23.cssClass);};$2g(a,true);}};this.$bW=function($l,$q){var $0Q={};$0Q.from=$l.from;$0Q.to=$l.to;$0Q.type=$l.type;$i.$ak("LinkCreate",$0Q,$q);};this.$bY=function($l,$q){var $0Q={};$0Q.from=$l.from;$0Q.to=$l.to;$0Q.type=$l.type;$i.$ak("LinkCreate",$0Q,$q,"Notify");};this.$bX=function($l,$q){var $0Q={};$0Q.from=$l.from;$0Q.to=$l.to;$0Q.type=$l.type;$i.$aj("LinkCreate",$0Q,$q);};this.$c0=function(i){var top=0;var $W=0;var $1t=0;if(i>this.rowlist.length-1){throw "Row index too high (DayPilotScheduler._getRowByIndex)";};for(var j=0;j<=i;j++){var $I=this.rowlist[j];if($I.hidden){continue;};$W+=$I.height;$1t++;};top=$W-$I.height;var $j={};$j.top=top;$j.height=$I.height;$j.bottom=$W;$j.i=$1t-1;$j.data=$I;return $j;};this.$c1=function(){if(this.backendUrl){return(typeof $i.events.list==='undefined')||(!$i.events.list);}else{return false;}};this.events.find=function(id){if(!$i.events.list||typeof $i.events.list.length==='undefined'){return null;};var $2p=$i.events.list.length;for(var i=0;i<$2p;i++){if($i.events.list[i].id===id){return new DayPilot.Event($i.events.list[i],$i);}};return null;};this.events.all=function(){var $Y=[];for(var i=0;i<$i.events.list.length;i++){var e=new DayPilot.Event($i.events.list[i],$i);$Y.push(e);};return DayPilot.list($Y);};this.events.filter=function($l){$i.events.$c2=$l;$i.$aI({"eventsOnly":true});};this.events.edit=function(e){var $02=$i.$bZ(e);if(!$02){return;};$i.$an($02);};this.events.load=function($2q,$2r,$2s){var $2t=function($l){var $2u={};$2u.exception=$l.exception;$2u.request=$l.request;if(typeof $2s==='function'){$2s($2u);}};var $2v=function($l){var r=$l.request;var $q;try{$q=DayPilot.Util.parseJSON(r.responseText);}catch(e){var $2w={};$2w.exception=e;$2t($2w);return;};if(DayPilot.isArray($q)){var $2x={};$2x.preventDefault=function(){this.preventDefault.value=true;};$2x.data=$q;if(typeof $2r==="function"){$2r($2x);};if($2x.preventDefault.value){return;};$i.events.list=$q;if($i.$aU){$i.update();}}};DayPilot.ajax({"method":"POST","data":{"start":$i.visibleStart().toString(),"end":$i.visibleEnd().toString()},"url":$2q,"success":$2v,"error":$2t});};this.events.findRecurrent=function($2y,$0G){if(!$i.events.list||typeof $i.events.list.length==='undefined'){return null;};var $2p=$i.events.list.length;for(var i=0;i<$2p;i++){if($i.events.list[i].recurrentMasterId===$2y&&$i.events.list[i].start.getTime()===$0G.getTime()){return new DayPilot.Event($i.events.list[i],$i);}};return null;};this.events.$aB=function($q){var $15=[];for(var i=0;i<$i.rowlist.length;i++){var $I=$i.rowlist[i];if($I.isNewRow){continue;};$i.$a7(i);for(var r=0;r<$I.events.length;r++){if($I.events[r].data===$q){$15.push(i);$I.events.splice(r,1);break;}}};return $15;};this.events.$aC=function($q){var $15=[];var $2z=$i.$c3()||$i.viewType==="Days";var $1t=DayPilot.indexOf($i.events.list,$q);$i.$c4($1t);for(var i=0;i<$i.rowlist.length;i++){var $I=$i.rowlist[i];if($I.isNewRow){continue;};$i.$a7(i);var ep=$i.$c5($q,$I);if(ep){if(typeof $i.onBeforeEventRender==='function'){ep.cache=$i.$97.events[$1t];};$15.push(i);if(!$2z){break;}}};return $15;};this.events.update=function(e,$q){var $0Q={};$0Q.oldEvent=new DayPilot.Event(e.copy(),$i);$0Q.newEvent=new DayPilot.Event(e.temp(),$i);var $14=new DayPilot.Action($i,"EventUpdate",$0Q,$q);var $2A=DayPilot.list($i.events.list).find(function($00){var $q=$00 instanceof DayPilot.Event?$00.data:$00;return $q===e.data;});if(!$2A){return;};if($i.$c6.scope){$i.$c6.notify(function(){e.commit();});}else{var $15=$i.events.$aB(e.data);e.commit();$15=$15.concat($i.events.$aC(e.data));$i.$aD($15);$i.$aE();if($i.$aU){if($i.viewType==="Gantt"){$i.update();}else{$i.$aF($15);$i.$9s();}}};return $14;};this.events.remove=function(e,$q){var $0Q={};$0Q.e=new DayPilot.Event(e.data,$i);var $14=new DayPilot.Action($i,"EventRemove",$0Q,$q);var $1t=DayPilot.indexOf($i.events.list,e.data);$i.events.list.splice($1t,1);if($i.$c6.scope){$i.$c6.notify();}else{var $15=$i.events.$aB(e.data);$i.$aD($15);$i.$aE();if($i.$aU){if($i.viewType==="Gantt"){$i.update();}else{$i.$aF($15);$i.$9s();}}};return $14;};this.events.add=function(e,$q){e.calendar=$i;if(!$i.events.list){$i.events.list=[];};$i.events.list.push(e.data);var $14=new DayPilot.Action($i,"EventAdd",$0Q,$q);if(!$i.$aU){return $14;};if($i.$c6.scope){$i.$c6.notify();}else{var $0Q={};$0Q.e=e;var $15=$i.events.$aC(e.data);$i.events.$c7($15);};return $14;};this.events.$c8={"rows":[]};this.events.$c9=null;this.events.$c7=function($15){clearTimeout($i.events.$c9);var $22=$i.events.$c8.rows;DayPilot.list($15).each(function($I){$22.push($I);});$i.events.$c8.rows=DayPilot.ua($22);var $0W=function(){var $15=$i.events.$c8.rows;$i.events.$c8.rows=[];$i.$aD($15);$i.$aE();if($i.$aU){if($i.viewType==="Gantt"){$i.update();}else{$i.$aF($15);$i.$9s();}}};$i.events.$c9=setTimeout($0W);};this.queue={};this.queue.list=[];this.queue.list.ignoreToJSON=true;this.queue.add=function($14){if(!$14){return;};if($14.isAction){$i.queue.list.push($14);}else{throw "DayPilot.Action object required for queue.add()";}};this.queue.notify=function($q){var $0Q={};$0Q.actions=$i.queue.list;$i.$ak('Notify',$0Q,$q,"Notify");$i.queue.list=[];};this.queue.clear=function(){$i.queue.list=[];};this.queue.pop=function(){return $i.queue.list.pop();};this.cells.find=function($K,$1k){var $x=$i.getPixels(new DayPilot.Date($K));if(!$x){return $2B();};var x=$x.i;var $I=$i.$9J($1k);if(!$I){return $2B();};var top=$I.top;var y=$i.$bK(top).i;return this.findXy(x,y);};this.cells.findByPixels=function(x,y){var $0F=$i.$ae(x);if(!$0F){return $2B();};var x=$0F.x;var $I=$i.$bK(y);if(!$I){return $2B();};var y=$I.i;return this.findXy(x,y);};this.cells.all=function(){var $Y=[];var $1J=$i.itline.length;var $2C=$i.rowlist.length;for(var x=0;x<$1J;x++){for(var y=0;y<$2C;y++){var $P=$i.cells.findXy(x,y);$Y.push($P[0]);}};return $2B($Y);};this.cells.$ca=function(x,y){var $0F=$i.$am(x);var $I=$i.rowlist[y];var $1p=$I.start.getTime()-$i.$a6().getTime();var $K=$0F.start.addTime($1p);var end=$0F.end.addTime($1p);var $P={};$P.x=x;$P.y=y;$P.i=x+"_"+y;$P.resource=$I.id;$P.start=$0F.start;$P.end=$0F.end;$P.isParent=$I.children&&$I.children.length;$P.update=function(){if(!$i.rowlist[$P.y].hidden){var $16=$i.$97.cells[$P.i];$i.$cb($16);var $J=$i.$9L();if($J.xStart<=$P.x&&$P.x<=$J.xEnd){if($J.yStart<=$P.y&&$P.y<=$J.yEnd){$i.$cc($P.x,$P.y);}}}};$P.utilization=function(name){if(!$I.sections){$I.calculateUtilization();};return $I.sections.forRange($K,end).maxSum(name);};$P.events=function(){return $I.events.forRange($K,end);};$P.div=$i.$97.cells[$P.i];var p=$i.$cd(x,y);$P.properties=p;return $P;};this.cells.findXy=function(x,y){if(DayPilot.isArray(x)){var $M=[];for(var i=0;i<x.length;i++){var o=x[i];$M.push($i.cells.$ca(o.x,o.y));};return $2B($M);}else if(x===null||y===null){return $2B();};var $P=$i.cells.$ca(x,y);return $2B($P);};var $2D=function(a){var $Y=[];if(DayPilot.isArray(a)){for(var i=0;i<a.length;i++){$Y.push(a[i]);}}else if(typeof a==='object'){$Y.push(a);};$Y.each=function(f){if(!f){return;};for(var i=0;i<$Y.length;i++){f($Y[i]);}};return $Y;};this.$ce=function(a){var $Y=DayPilot.list();if(DayPilot.isArray(a)){for(var i=0;i<a.length;i++){$Y.push(a[i]);}}else if(typeof a==='object'){$Y.push(a);};$Y.cssClass=function($2E){this.each(function($00){$00.properties.cssClass=DayPilot.Util.addClassToString($00.properties.cssClass,$2E);$00.update();});return this;};$Y.removeClass=function($2E){this.each(function($00){$00.properties.cssClass=DayPilot.Util.removeClassFromString($00.properties.cssClass,$2E);$00.update();});return this;};$Y.addClass=$Y.cssClass;$Y.html=function($08){this.each(function($00){$00.properties.html=$08;$00.update();});return this;};return $Y;};var $2B=this.$ce;this.$c6={};this.$c6.scope=null;this.$c6.notify=function(f){if($i.$c6.scope){$i.$c6.scope["$apply"](f);}};this.debug=new DayPilot.Debug(this);this.$cf=function($u){if($i.viewType!=='Days'){throw "Checking row start when viewType !== 'Days'";};for(var i=0;i<$i.rowlist.length;i++){var $I=$i.rowlist[i];var $q=$I.element?$I.element.data:$I.data;var $K=$q.start;if($u.getTime()>=$K.getTime()&&$u.getTime()<$K.addDays(1).getTime()){return $K;}};return null;};this.$cg=function($u){if($u.ticks===this.startDate.ticks){return $u;};var $2F=this.startDate;if($u.ticks<this.startDate.ticks){var $2G=this.itline[0].end.ticks-this.itline[0].start.ticks;while($2F.ticks>$u.ticks){$2F=$2F.addTime(-$2G);};return $2F;};if($i.viewType==='Days'){var $2H=this.$cf($u);var $0B=$2H.getTime()-$i.$a6().getTime();var $P=this.$ag($u.addTime(-$0B));if($P.current){return $P.current.start.addTime($0B);};if($P.past){return $P.previous.end.addTime($0B);};throw "getBoxStart(): time not found";}else{var $P=this.$ag($u);if($P.current){return $P.current.start;};if($P.past){return $P.previous.end;};if($P.hidden){var $G=$P.next.start.getTime()-$u.getTime();var $2I=$P.next.end.getTime()-$P.next.start.getTime();var $2J=Math.ceil($G/$2I)*$2I;var $j=$P.next.start.addTime(-$2J);return $j;};throw "getBoxStart(): time not found";}};this.$bR=function($1R){var $I=this.$bK($i.coords.y);var e=$1R.event;if(typeof e.end !=='function'){throw "e.end function is not defined";};if(!e.end()){throw "e.end() returns null";};var $0H=DayPilot.DateUtil.diff(e.rawend(),e.start());$0H=Math.max($0H,1);var $2K=$0a.useBox($0H);var $2L=e.data&&e.data.type==="Milestone";var $2M=$i.eventHeight;var $2N=0;var x=$i.coords.x;if($2L){x+=$2M/2;};if($i.scale==="Manual"){var $2O=(function(){var end=$i.getDate($i.coords.x,true,true);var $K=end.addTime(-$0H);var $2P=$i.getPixels($K).boxLeft;var $2Q=$i.getPixels(end).boxRight;var end=Math.min($2Q,$i.coords.x);return end -$2P;})();var $0B=Math.min(DayPilotScheduler.moveOffsetX,$2O);x=$i.coords.x-$0B;};var $1p=0;var $2R=this.viewType==='Days'||this.$ch();if($2R&&!e.part.external){$1p=this.rowlist[e.part.dayIndex].start.getTime()-this.$a6().getTime();};if($2K&&!$2L){var $P=$i.$ag(e.start());var $2S=!$P.hidden&&!$P.past;$2N=e.start().getTime()-this.$cg(e.start().addTime(-$1p)).addTime($1p).getTime();if($2S){$2N=(function($2T,$0B){var $2U=$i.$ci($i.$ag($2T).current);var $2V=$i.$ci($i.$ae(x).cell);if($2U>$2V*1.2){var $2W=$0B>0?1:-1;var $0B=Math.abs($0B);while($0B>=$2V){$0B-=$2V;};$0B*=$2W;};return $0B;})(e.start(),$2N);}};var $2X=0;if(DayPilotScheduler.moveDragStart&&$i.scale!=="Manual"){if($2K){var $2Y=e.start().addTime(-$1p);var $2Z=this.$cg($2Y);$2X=DayPilotScheduler.moveDragStart.getTime()-$2Z.getTime();var $30=$i.$cj()*60*1000;$2X=Math.floor($2X/$30)*$30;}else{$2X=DayPilotScheduler.moveDragStart.getTime()-e.start().addTime($1p).getTime();}}else{$2X=0;};if(this.eventMoveToPosition){$2X=0;};var $K=this.getDate(x,true).addTime(-$2X).addTime($1p);if(DayPilotScheduler.resizing){$K=e.start();};if(this.snapToGrid){$K=this.$cg($K.addTime(-$1p)).addTime($1p);};$K=$K.addTime($2N);var end=$K.addTime($0H);var $31=$K;var $32=end;if($2R){$31=$K.addTime(-$1p);$32=$31.addTime($0H);var $33=$I.element.data.start.getTime()-this.$a6().getTime();$K=$31.addTime($33);end=$K.addTime($0H);};var $34=this.getPixels($31);var $35=this.getPixels($32);var $N=($2K)?$34.boxLeft:$34.left;var $z=($2K)?($35.boxRight-$N):($35.left-$N);if($2L){$z=$2M;$N-=$z/2;};var $1T={};$1T.top=$I.top;$1T.left=$N;$1T.row=$I.element;$1T.rowIndex=$I.i;$1T.width=$z;$1T.start=$K;$1T.end=end;$1T.relativeY=$i.coords.y-$I.top;return $1T;};this.$cj=function(){switch(this.scale){case "CellDuration":return this.cellDuration;case "Minute":return 1;case "Hour":return 60;case "Day":return 60*24;case "Week":return 60*24*7;case "Month":return 60*24*30;case "Year":return 60*24*365;};throw "can't guess cellDuration value";};this.$ci=function($0F){return $0F.end.ticks-$0F.start.ticks;};this.$bU=function(y){return this.treePreventParentUsage&&this.$ck(y);};this.$ck=function(y){var $I=this.rowlist[y];if($I.isParent){return true;};if(this.treeEnabled){if($I.children&&$I.children.length>0){return true;}};return false;};this.$cl={};this.$cm=function(){if(!$i.treeAutoExpand){return;};var $1T=this.$bR(DayPilotScheduler.moving);var y=$1T.rowIndex;var $36=this.$ck(y);var $37=this.$cl;if($37.timeout&&$37.y!==y){clearTimeout($37.timeout);$37.timeout=null;};if($36){$37.y=y;if(!$37.timeout){$37.timeout=setTimeout(function(){var $38=!$i.rowlist[$37.y].expanded;if($38){$i.$cn($37.y);$i.$co();};$37.timeout=null;},500);}}};this.$cp=function(){var $39=DayPilotScheduler.resizingShadow.clientWidth;var $3a=DayPilotScheduler.resizingShadow.offsetLeft;var e=DayPilotScheduler.resizing.event;var $3b=DayPilotScheduler.resizing.dpBorder;var $I=$i.rowlist[DayPilotScheduler.resizing.event.part.dayIndex];var $1p=0;$1p=$I.start.getTime()-$i.$a6().getTime();var $0m=null;var $0V=null;var $3c=!$i.snapToGrid;if($3b==='left'){$0m=$i.getDate($3a,$3c).addTime($1p);$0V=e.rawend();}else if($3b==='right'){$0m=e.start();$0V=$i.getDate($3a+$39,$3c,true).addTime($1p);};DayPilotScheduler.resizingShadow.start=$0m;DayPilotScheduler.resizingShadow.end=$0V;$0Y.update();};this.$cq={};var $3d=this.$cq;$3d.getWidth=function(){return $i.nav.top.offsetWidth;};$3d.getHeight=function(){return $i.nav.top.offsetHeight-DayPilot.sh($i.nav.scroll)-1;};$3d.getRowHeaderWidth=function(){return $i.$9V();};$3d.getTimeHeaderHeight=function(){return $i.$9U();};$3d.download=function(name){var $3e=$3d.canvas();var name=name||"image.png";if(window.navigator.msSaveBlob){var $3f=$3e.msToBlob();window.navigator.msSaveBlob($3f,name);}else{var link=document.createElement("a");link.download=name;link.href=$3e.toDataURL();link.click();}};$3d.getCanvas=function(){return $3d.canvas();};$3d.getRectangles=function($3e){var $3g=$3d.getRowHeaderWidth();var $3h=$3d.getTimeHeaderHeight();var $3i={};$3i.main={"x":0,"y":0,"w":$3e.getWidth(),"h":$3e.getHeight()};$3i.corner={"x":0,"y":0,"w":$3g,"h":$3h};$3i.grid={"x":$3g,"y":$3h,"w":$3e.getWidth()-$3g,"h":$3e.getHeight()-$3h};return $3i;};$3d.getViewportRows=function(){var $j=DayPilot.list();var top=$i.$cr;var $W=top+$i.nav.scroll.offsetHeight;var $3j=$i.$bK(top).i;var $3k=$i.$bK($W).i;if($3k<$i.rowlist.length){$3k+=1;};for(var y=$3j;y<$3k;y++){var $I=$i.rowlist[y];if($I.hidden){continue;};$j.push($I);};$j.offset=$3j;return $j;};$3d.getViewportEvents=function(){return $Q.events();};$3d.getViewportTimeline=function(){var $j=DayPilot.list();if($i.itline&&$i.itline.length>0){var $N=$i.$cs;var $O=$N+$i.$ct;var $K=$i.$ae($N).x;var end=$i.$ae($O,true).x;var $3l=$i.$9T();end=Math.min(end,$3l);$K=Math.max($K,0);for(var x=$K;x<=end;x++){var $P=$i.itline[x];$j.push($P);};$j.offset=$K;};return $j;};$3d.getViewportTimeHeader=function(y){var $j=DayPilot.list();var $3m=dp.nav.scroll.scrollLeft;var $3n=$3m+dp.nav.scroll.offsetWidth;var $3o=$i.$cu(y,$3m);var $3p=$i.$cu(y,$3n);if(!$3p){$3p={"x":$i.timeHeader[y].length-1};};for(var x=$3o.x;x<=$3p.x;x++){var $P=$i.timeHeader[y][x];$j.push($P);};return $j;};$3d.fakeDurationBar=function(){var $02=document.createElement("div");$02.style.display="none";$02.className=$i.$9S("_event");var $3q=document.createElement("div");$3q.className=$i.$9S("_event_bar");var $05=document.createElement("div");$05.className=$i.$9S("_event_bar_inner");document.body.appendChild($02);$3q.appendChild($05);$02.appendChild($3q);return $02;};$3d.fakeCell=function(){var $02=document.createElement("div");$02.style.display="none";$02.className=$i.$9S("_cell");var $05=document.createElement("div");$05.className=$i.$9S("_cell_inner");document.body.appendChild($02);$02.appendChild($05);return $02;};$3d.fakeExpand=function(){var $02=document.createElement("div");$02.style.display="none";$02.className=$i.$9S('_tree_image_expand');document.body.appendChild($02);return $02;};$3d.extractUrl=function($3r){var $3s=/url\((.*)\)/.exec($3r);return $3s[1];};$3d.getImages=function(){var $j={};var $1L=$3d.fakeExpand();$j.expand=$3d.extractUrl(new DayPilot.StyleReader($1L).get("background-image"));$1L.className=$i.$9S("_tree_image_collapse");$j.collapse=$3d.extractUrl(new DayPilot.StyleReader($1L).get("background-image"));$1L.className=$i.$9S("_tree_image_no_children");$j.nochildren=$3d.extractUrl(new DayPilot.StyleReader($1L).get("background-image"));DayPilot.de($1L);return $j;};$3d.canvas=function(){var $3e=new DayPilot.Canvas($3d.getWidth(),$3d.getHeight());var $3i=$3d.getRectangles($3e);var $3t=$3d.getImages();var $3u=new DayPilot.StyleReader($i.nav.corner).get("background-color");var $3v=new DayPilot.StyleReader($i.nav.top).get("border-color");var $3w=new DayPilot.StyleReader($i.nav.divider).get("background-color");var $3x=new DayPilot.StyleReader(DayPilot.list($i.elements.events).map(function($00){return $00.firstChild;}).last()).get("border-color");var $3q=$3d.fakeDurationBar();var $3y=new DayPilot.StyleReader($3q.firstChild).get("background-color");var $3z=new DayPilot.StyleReader($3q.firstChild.firstChild).get("background-color");DayPilot.de($3q);var $P=$3d.fakeCell();var $3A=new DayPilot.StyleReader($P).get("background-color");DayPilot.Util.addClass($P,$i.$9S("_cell_business"));var $3B=new DayPilot.StyleReader($P).get("background-color");DayPilot.de($P);var $3C=DayPilot.Util.firstPropValue($i.$97.linesVertical);var $3D=new DayPilot.StyleReader($3C).get("background-color");var $3E=new DayPilot.StyleReader($i.$97.timeHeader["0_0"]).get("font");var $3F=new DayPilot.StyleReader($i.$97.timeHeader["0_0"]).get("color");var $3m=dp.nav.scroll.scrollLeft;var $3n=$3m+dp.nav.scroll.offsetWidth;var $3G=dp.nav.scroll.scrollTop;$3e.fillRect($3i.corner,$3u);DayPilot.list($i.timeHeader).each(function($00,y){$3d.getViewportTimeHeader(y).each(function($P){var $N=$3i.grid.x+$P.left-$3m;var top=y*$i.headerHeight;var $z=$P.width;var $R=$i.headerHeight;var $3H=Math.max(0,$3i.grid.x-$N);$N+=$3H;$z-=$3H;var $3H=Math.max(0,$N+$z-($3i.grid.x+$3i.grid.w));$z-=$3H;var $3I={"x":$N,"y":top,"w":$z+1,"h":$R+1};$3e.fillRect($3I,$3u);$3e.rect($3I,$3v);$3e.text($3I,$P.innerHTML,$3E,$3F,"center");});});$3d.getViewportTimeline().each(function($P){var $N=$3i.grid.x+$P.left-$3m;var $3H=Math.max(0,$3i.grid.x-$N);$N+=$3H;if($N===$3i.grid.x){return;};$3e.line($N,$3i.grid.y+1,$N,$3i.grid.y+$3i.grid.h-2,$3D);});$3d.getViewportRows().each(function($I,y,$15){var y=$15.offset+y;$3d.getViewportTimeline().each(function($P,x,$3J){var x=$3J.offset+x;var $23=$i.$cd(x,y);var top=$3i.grid.y+$I.top-$3G;var $3K=Math.max(0,$3i.grid.y-top);top+=$3K;var $N=$3i.grid.x+$P.left-$3m;var $3H=Math.max(0,$3i.grid.x-$N);$N+=$3H;var $3L=$23.business;var $3M=$23.backColor||($3L?$3B:$3A);var $3N={"x":$N,"y":top,"w":$P.width,"h":$I.height};$3e.fillRect($3N,$3M);});});$3d.getViewportRows().each(function($I){var top=$3i.grid.y+$I.top-$3G;var $3K=Math.max(0,$3i.grid.y-top);top+=$3K;if(top===$3i.grid.y){return;};$3e.line($3i.grid.x+1,top,$3i.grid.x+$3i.grid.w-1,top,$3D);});$3d.getViewportRows().each(function($I){var top=$3i.grid.y+$I.top-$3G;var $3K=Math.max(0,$3i.grid.y-top);top+=$3K;var $3O=10;var $N=$I.level*$i.treeIndent+$i.treeImageMarginLeft;var $3N={"x":0,"y":top,"w":$3i.grid.x+1,"h":$I.height+1};var $1s=$I.html;var $3P={"x":$N,"y":top+$i.treeImageMarginTop,"w":10,"h":10};var $3Q={"x":$N+$3O,"y":top,"w":$3N.w-($N+$3O),"h":$I.height+1};$3e.fillRect($3N,$3u);$3e.text($3Q,$1s,$3E,$3F);$3e.rect($3N,$3v);var $3R=null;if(DayPilot.list($I.children).isEmpty()){$3R=$3t.nochildren;}else if($I.expanded){$3R=$3t.collapse;}else{$3R=$3t.expand;};$3e.image($3P,$3R);});$3d.getViewportEvents().each(function($02){var e=$02.event;var $3S=$i.rowlist[e.part.dayIndex].top;var $z=e.part.width;var $3T=e.part.barWidth;var top=$3i.grid.y+$3S+e.part.top-$3G;var $3K=Math.max(0,$3i.grid.y-top);top+=$3K;var $N=$3i.grid.x+e.part.left-$3m;var $3H=Math.max(0,$3i.grid.x-$N);$N+=$3H;$z-=$3H;$3T-=$3H;var $3U=e.data.barColor||$3z;var $3V=e.data.barBackColor||$3y;var $3M=e.data.backColor||"white";var $3W=5;var $3N={"x":$N,"y":top,"w":$z,"h":e.part.height};var $3X={"x":$N,"y":top,"w":$z,"h":$3W};var $3Y={"x":$N+e.part.barLeft,"y":top,"w":$3T,"h":$3W};var $3Z={"x":$N,"y":top+$3W,"w":$z,"h":e.part.height-$3W};$3e.fillRect($3N,$3M);$3e.text($3Z,e.text(),$3E,$3F,"left",2);$3e.rect($3N,$3x);$3e.fillRect($3X,$3V);if($3T>0){$3e.fillRect($3Y,$3U);}});$3e.rect($3i.main,$3v);$3e.line($3i.grid.x,0,$3i.grid.x,$3i.main.h,$3w);$3e.line(0,$3i.grid.y,$3i.main.w,$3i.grid.y,$3w);return $3e.getCanvasElement();};this.$cv={};var $40=this.$cv;$40.findJointDivs=function(e){var id=e.data.join;if(!id){return DayPilot.list();};var $2f=DayPilot.list($i.elements.events).filter(function($00){return $00.event.data.join===id&&$00.event!==e;});return $2f;};this.$cw={};var $0Y=this.$cw;$0Y.divs=[];$0Y.list=[];$0Y.forbidden=false;$0Y.additional=function(){var $Y=DayPilot.list();var $41=$i.multiselect.isSelected(DayPilotScheduler.resizing.event);var $42=$i.allowMultiResize;var $Y=DayPilot.list();if($41&&$42){$Y=DayPilot.list($i.multiselect.divs).filter(function($00){return $00!==DayPilotScheduler.resizing;});};var j=$40.findJointDivs(DayPilotScheduler.resizing.event);$Y=$Y.concat(j);return $Y;};$0Y.update=function(){$0Y.clear();$0Y.draw();};$0Y.clear=function(){DayPilot.de($0Y.divs);$0Y.divs=[];};$0Y.draw=function(){if(!DayPilotScheduler.resizing){return;};var e=DayPilotScheduler.resizing.event;var $1U=DayPilotScheduler.resizingShadow;var $43=$1U.start.getTime()-e.start().getTime();var $44=$1U.end.getTime()-e.end().getTime();var $45=0;$0Y.list=[];$0Y.forbidden=false;$0Y.invalid=false;$0Y.rowoffset=$45;$0Y.additional().each(function($00){if(!$00.event){return;};var event=$00.event;var $I=$i.rowlist[event.part.dayIndex+$45];if(!$I){$0Y.invalid=true;return;};var top=event.part.top+$I.top;var $R=event.part.height;if($45){top=$I.top;$R=$I.height;};var $31=event.start().addTime($43);var $32=event.end().addTime($44);var $0Z={};$0Z.event=event;$0Z.start=$31;$0Z.end=$32;$0Z.overlapping=false;$0Y.list.push($0Z);var $34=$i.getPixels($31);var $35=$i.getPixels($32);var $0H=DayPilot.DateUtil.diff(event.rawend(),event.start());$0H=Math.max($0H,1);var $2K=$0a.useBox($0H);var $N=($2K)?$34.boxLeft:$34.left;var $z=($2K)?($35.boxRight-$N):($35.left-$N);var $02=document.createElement("div");$02.style.position="absolute";$02.style.left=$N+"px";$02.style.top=top+"px";$02.style.height=$R+"px";$02.style.width=$z+"px";$02.style.zIndex=101;$02.style.overflow="hidden";$02.className=$i.$9S("_shadow");$02.info=$0Z;var $05=document.createElement("div");$05.className=$i.$9S("_shadow_inner");$02.appendChild($05);$i.$9H.appendChild($02);$0Y.divs.push($02);});if($0Y.invalid){var $46=$i.$9S("_shadow_overlap");DayPilot.list($0Y.divs).each(function($00){DayPilot.Util.addClass($00,$46);});return;};DayPilot.list($0Y.divs).each(function($00){if(!$00.info){return;};var $02=$00;var $0Z=$00.info;var event=$00.info.event;var $I=$i.rowlist[event.part.dayIndex+$45];var $34=$i.getPixels($0Z.start);var $35=$i.getPixels($0Z.end);var $N=$34.left;var $z=$35.left-$N;var $47=DayPilot.list($0Y.list).map(function($00){return $00.event.data;}).add(DayPilotScheduler.resizing.event.data);$i.$cx($02,$I,$N,$z,$47);if($02.overlapping){$0Z.overlapping=true;$0Y.forbidden=true;}});};this.$cy={};var mm=this.$cy;mm.divs=[];mm.list=[];mm.forbidden=false;mm.verticalAll=function(){return $i.multiMoveVerticalMode==="All";};mm.additional=function(){var $Y=DayPilot.list();var $41=$i.multiselect.isSelected(DayPilotScheduler.moving.event);var $42=$i.allowMultiMove;var $Y=DayPilot.list();if($41&&$42){$Y=DayPilot.list($i.multiselect.divs).filter(function($00){return $00!==DayPilotScheduler.moving&&$00!==$0J.moving;});};var j=$40.findJointDivs(DayPilotScheduler.moving.event);$Y=$Y.concat(j);return $Y;};mm.update=function(){mm.clear();mm.draw();};mm.draw=function(){if(!DayPilotScheduler.moving){return;};var e=DayPilotScheduler.moving.event;var $K=DayPilotScheduler.movingShadow.start;var $0B=$K.getTime()-e.start().getTime();var $48=e.part.dayIndex;var $49=DayPilot.indexOf($i.rowlist,DayPilotScheduler.movingShadow.row);var $45=$49-$48;if(!mm.verticalAll()){$45=0;};mm.list=[];mm.forbidden=false;mm.invalid=false;mm.rowoffset=$45;mm.additional().each(function($00){if(!$00.event){return;};var event=$00.event;var $I=$i.rowlist[event.part.dayIndex+$45];if(!$I){mm.invalid=true;return;};var top=event.part.top+$I.top;var $R=event.part.height;if($45){top=$I.top;$R=$I.height;};var $31=event.start().addTime($0B);var $32=event.end().addTime($0B);var $0Z={};$0Z.event=event;$0Z.start=$31;$0Z.end=$32;$0Z.overlapping=false;mm.list.push($0Z);var $34=$i.getPixels($31);var $35=$i.getPixels($32);var $0H=DayPilot.DateUtil.diff(event.rawend(),event.start());$0H=Math.max($0H,1);var $2K=$0a.useBox($0H);var $N=($2K)?$34.boxLeft:$34.left;var $z=($2K)?($35.boxRight-$N):($35.left-$N);var $02=document.createElement("div");$02.style.position="absolute";$02.style.left=$N+"px";$02.style.top=top+"px";$02.style.height=$R+"px";$02.style.width=$z+"px";$02.style.zIndex=101;$02.style.overflow="hidden";$02.className=$i.$9S("_shadow");$02.info=$0Z;var $05=document.createElement("div");$05.className=$i.$9S("_shadow_inner");$02.appendChild($05);$i.$9H.appendChild($02);mm.divs.push($02);});if(mm.invalid){var $46=$i.$9S("_shadow_overlap");DayPilot.list(mm.divs).each(function($00){DayPilot.Util.addClass($00,$46);});return;};DayPilot.list(mm.divs).each(function($00){if(!$00.info){return;};var $02=$00;var $0Z=$00.info;var event=$00.info.event;var $I=$i.rowlist[event.part.dayIndex+$45];var $34=$i.getPixels($0Z.start);var $35=$i.getPixels($0Z.end);var $N=$34.left;var $z=$35.left-$N;var $47=DayPilot.list(mm.list).map(function($00){return $00.event.data;}).add(DayPilotScheduler.moving.event.data);$i.$cx($02,$I,$N,$z,$47);if($02.overlapping){$0Z.overlapping=true;mm.forbidden=true;}});};mm.clear=function(){DayPilot.de(mm.divs);mm.divs=[];};this.$cz=function(){var $1T=$i.coords;var $3b=DayPilotScheduler.resizing.dpBorder;var e=DayPilotScheduler.resizing.event;var $4a=e.part.left;if($3b=="right"){$4a+=e.part.width;};var $4b=DayPilotScheduler.resizing.event.calendar.cellWidth;var $4c=DayPilotScheduler.resizing.event.part.width;var $4d=DayPilotScheduler.resizing.event.part.left;var $4e=0;var $4f=($1T.x-$4a);var $4g,$4h;if($3b==='right'){$4g=$4d;if($i.snapToGrid){var $0F=$i.$ae($4c+$4d+$4f).cell;var $4i=$0F.left+$0F.width;$4h=$4i-$4d;if($4h<$4b){$4h=$4b;}}else{$4h=$4c+$4f;};var $y=$i.$cA();if($4d+$4h>$y){$4h=$y-$4d;};DayPilotScheduler.resizingShadow.style.width=($4h)+'px';}else if($3b==='left'){if($i.snapToGrid){if($4f>=$4c){$4f=$4c;};$4g=Math.floor((($4d+$4f)+0)/$4b)*$4b;if($4g<$4e){$4g=$4e;}}else{$4g=$4d+$4f;};$4h=$4c-($4g-$4d);var $O=$4d+$4c;var $4j=$4b;if(!$i.snapToGrid){$4j=1;}else if($i.useEventBoxes==="Never"){if($4c<$4b){$4j=$4c;}else{$4j=1;}};if($4h<$4j){$4h=$4j;$4g=$O-$4h;};DayPilotScheduler.resizingShadow.style.left=$4g+'px';DayPilotScheduler.resizingShadow.style.width=($4h)+'px';}else{throw "Invalid dpBorder.";};(function checkOverlap(){var ev=DayPilotScheduler.resizing.event;var $I=$i.rowlist[ev.part.dayIndex];var $N=$4g;var $z=$4h;$i.$cx(DayPilotScheduler.resizingShadow,$I,$N,$z,ev.data);})();$i.$cB();};this.$co=function(){var scroll=this.nav.scroll;if(!$i.coords){return;};if(!DayPilotScheduler.moving){return;};$i.$9W();var $1U=DayPilotScheduler.movingShadow;var $1T=this.$bR(DayPilotScheduler.moving);if($i.$bU($1T.rowIndex)){return;};var ev=DayPilotScheduler.moving.event;var $4k=0;(function calculatePosition(){var y=$1T.relativeY;var $I=$1T.row;var $4l=$I.lines.length;var top=0;var lh=$i.$bS.eventHeight();var $y=$I.lines.length;for(var i=0;i<$I.lines.length;i++){var $0u=$I.lines[i];if($0u.isFree($1T.left,$i.cellWidth)){$y=i;break;}};var $F=Math.floor((y-top+lh/ 2)/ lh);var $F=Math.min($y,$F);var $F=Math.max(0,$F);$4k=$F;})();var $1V=(ev.cache&&typeof ev.cache.moveVDisabled!=='undefined')?!ev.cache.moveVDisabled:!ev.data.moveVDisabled;var $1W=(ev.cache&&typeof ev.cache.moveHDisabled!=='undefined')?!ev.cache.moveHDisabled:!ev.data.moveHDisabled;var $4m=!mm.additional().isEmpty();if($4m&&$i.multiMoveVerticalMode==="Disabled"){$1V=false;};var $4n=$4k*$i.$bS.eventHeight();if($4n>0){$4n-=3;};if($1V){if(!this.$bU($1T.rowIndex)){$1U.row=$1T.row;$1U.style.height=Math.max($1T.row.height,0)+'px';$1U.style.top=($1T.top)+'px';if($i.eventMoveToPosition){$1U.style.top=($1T.top+$4n)+"px";$1U.style.height="3px";$1U.line=$4k;}}else{var $4o=$1U.row;var $4p=1;if($4o){$4p=$1T.rowIndex<$4o.index?1:-1;}else{return;};for(var i=$1T.rowIndex;i!==$4o.index;i+=$4p){var $I=this.rowlist[i];if(!this.$bU(i)&&!$I.hidden){$1U.style.top=($I.top)+'px';$1U.style.height=Math.max($I.height,0)+'px';$1U.row=$I;if($i.eventMoveToPosition){$4k=$4p>0?0:$I.lines.length-1;$1U.style.top=($1T.top+$4n)+"px";$1U.style.height="3px";$1U.line=$4k;};break;}}}}else{var $4o=$i.rowlist[ev.part.dayIndex];var $y=$4o.lines.length;for(var i=0;i<$4o.lines.length;i++){var $0u=$4o.lines[i];if($0u.isFree($1T.left,$i.cellWidth)){$y=i;break;}};if(!$4m){$1U.style.height=Math.max($4o.height,0)+'px';$1U.style.top=($4o.top)+'px';};$1U.row=$4o;if($i.eventMoveToPosition&&!$4m){if($1T.row===$4o){$1U.style.top=($4o.top+$4n)+"px";$1U.style.height="3px";$1U.line=$4k;}else{var $F=($1T.rowIndex>$4o.index&&$y>0)?$y*$i.$bS.eventHeight()-3:0;$1U.style.top=($4o.top+$F)+"px";$1U.style.height="3px";$1U.line=0;}}};if($1W){$1U.style.left=$1T.left+'px';if($i.eventMoveToPosition){$1U.style.width=($i.cellWidth)+'px';}else{$1U.style.width=($1T.width)+'px';};$1U.start=$1T.start;$1U.end=$1T.end;}else{$1U.style.left=ev.part.left+"px";$1U.start=ev.start();$1U.end=ev.rawend();};(function checkOverlap(){var $I=$1U.row;var $q=ev.data;var $z=$1T.width;var $N=$1T.left;var $47=DayPilot.list(mm.list).map(function($00){return $00.event.data;}).add($q);$i.$cx($1U,$I,$N,$z,$47);})();(function(){var $0C=$i.$cC;if($0C&&$0C.start.getTime()===$1U.start.getTime()&&$0C.end.getTime()===$1U.end.getTime()&&$0C.resource===$1U.row.id){return;};mm.update();var $l={};$l.start=$1U.start;$l.end=$i.$ax($1U.end);$l.duration=new DayPilot.Duration($l.start,$l.end);$l.e=ev;$l.resource=$1U.row.id;$l.row=$i.$bm($1U.row);$l.position=$1U.line;$l.overlapping=$1U.overlapping||mm.forbidden;$l.allowed=true;$l.left={};$l.left.html=$l.start.toString($i.eventMovingStartEndFormat);$l.left.enabled=$i.eventMovingStartEndEnabled;$l.right={};$l.right.html=$l.end.toString($i.eventMovingStartEndFormat);$l.right.enabled=$i.eventMovingStartEndEnabled;$l.multimove=DayPilot.list(mm.list);var $0Z={};$0Z.event=ev;$0Z.start=$l.start;$0Z.end=$l.end;$l.multimove.splice(0,0,$0Z);$i.$cC=$l;var $0l={"start":$l.start,"end":$l.end};if(typeof $i.onEventMoving==='function'){$i.onEventMoving($l);};$1U.allowed=$l.allowed;if($l.start!==$0l.start||$l.end !==$0l.end){var $K=$l.start;var end=$i.$b1($l.end);$1U.start=$K;$1U.end=end;var $0H=DayPilot.DateUtil.diff($K,end);$0H=Math.max($0H,1);var $2K=$0a.useBox($0H);var $N=$2K?$i.getPixels($K).boxLeft:$i.getPixels($K).left;var $O=$2K?$i.getPixels(end).boxRight:$i.getPixels(end).left;$1U.style.left=$N+"px";$1U.style.width=($O-$N)+"px";};$i.$cD($1U,$l);DayPilot.Util.addClass(DayPilotScheduler.moving,$i.$9S("_event_moving_source"));$i.$cE(DayPilotScheduler.movingShadow,$l);})();};this.$cx=function($1U,$I,$N,$z,$q){if($i.allowEventOverlap){return;};(function calculate(){$1U.overlapping=false;for(var i=0;i<$I.lines.length;i++){var $0u=$I.lines[i];if(!$0u.isFree($N,$z,$q)){$1U.overlapping=true;return;}};if(!$i.allowMultiRange){return;};var $4q=$I.index;var $4r=DayPilot.list(mr.list).some(function($00){var $02=$00.div;var $4s=parseInt($02.style.left);var $4t=parseInt($02.style.width);var ry=$00.start.y;if($1U===$02){return false;};if(ry!==$4q){return false;};return DayPilot.Util.overlaps($N,$N+$z,$4s,$4s+$4t);});if($4r){$1U.overlapping=true;return;}})();var $4u=$1U.overlapping;var $46=$i.$9S("_shadow_overlap");if($4u){DayPilot.Util.addClass($1U,$46);}else{DayPilot.Util.removeClass($1U,$46);}};this.$cD=function($1U,$l){var $46=$i.$9S("_shadow_forbidden");if(!$l.allowed||mm.invalid){DayPilot.Util.addClass($1U,$46);}else{DayPilot.Util.removeClass($1U,$46);}};this.$cE=function($1U,$l){var $4v=5;this.$cF();var $F={};$F.left=parseInt($1U.style.left);$F.top=parseInt($1U.style.top);$F.right=$F.left+parseInt($1U.style.width);var $z=$l.left.width||10;var $N=document.createElement("div");$N.style.position="absolute";$N.style.left=($F.left-$z-$4v)+"px";$N.style.top=$F.top+"px";$N.style.height=$i.eventHeight+"px";$N.style.overflow="hidden";$N.style.boxSizing="border-box";$N.innerHTML=$l.left.html;$N.className=this.$9S("_event_move_left");if($l.left.enabled){$i.divHover.appendChild($N);};if($l.left.width){$N.style.width=$z+"px";}else{$N.style.whiteSpace="nowrap";var $4w=$N.offsetWidth;var $4x=$F.left-$4w-$4v;$N.style.width=$4w+"px";$N.style.left=$4x+"px";};var $O=document.createElement("div");$O.style.position="absolute";$O.style.left=($F.right+$4v)+"px";$O.style.top=$F.top+"px";$O.style.height=$i.eventHeight+"px";$O.style.overflow="hidden";$O.style.boxSizing="border-box";if($l.right.width){$O.style.width=$l.right.width+"px";}else{$O.style.whiteSpace="nowrap";};$O.innerHTML=$l.right.html;$O.className=this.$9S("_event_move_right");if($l.right.enabled){$i.divHover.appendChild($O);}};this.$cF=function(){$i.divHover.innerHTML='';};this.$cG=function(){if(this.rowHeaderColumns){this.rowHeaderCols=DayPilot.Util.propArray(this.rowHeaderColumns,"width");}};this.$cH=function(){var $3l=0;this.$cG();if(this.rowHeaderCols){for(var i=0;i<this.rowHeaderCols.length;i++){$3l+=this.rowHeaderCols[i];}}else{$3l=this.rowHeaderWidth;};return $3l;};this.$cI=function(){return this.$cJ($i.progressiveRowRenderingPreload);};this.$cJ=function($4y){var $4y=$4y||0;var $K=0;var end=$i.rowlist.length;var $4z=$i.progressiveRowRendering;if($4z){var $J=$i.$9L();$K=$J.yStart;end=$J.yEnd+1;$K=Math.max(0,$K-$4y);end=Math.min($i.rowlist.length,end +$4y);};return{"start":$K,"end":end}};this.$cK=function(){if(!this.$cL()){return;};if(!this.rowHeaderWidthAutoFit){return;};var $4A=this.divHeader;if(!$4A){return;};if(!$4A.rows){return;};var $y=[];var $1l=$i.$cI();for(var i=$1l.start;i<$1l.end;i++){var $I=$4A.rows[i];if(!$I){continue;};if($I.hidden){continue;};if($I.autofitDone){continue;};$I.autofitDone=true;for(var j=0;j<$I.cells.length;j++){var $05=$I.cells[j].firstChild.firstChild;if(!$05||!$05.style){continue;};var $4B=$05.style.width;var $4C=$05.style.right;$05.style.position="absolute";$05.style.width="auto";$05.style.right="auto";$05.style.whiteSpace="nowrap";var w=$05.offsetWidth+2;$05.style.position="";$05.style.width=$4B;$05.style.right=$4C;$05.style.whiteSpace="";if(typeof $y[j]==='undefined'){$y[j]=0;};$y[j]=Math.max($y[j],w);}};var $4D=0;var $4E=false;this.$cG();if(this.rowHeaderCols){for(var i=0;i<$y.length;i++){if(this.rowHeaderCols[i]){if($y[i]>this.rowHeaderCols[i]){this.rowHeaderCols[i]=$y[i];$4E=true;};$4D+=this.rowHeaderCols[i];}}}else{$4D=this.rowHeaderWidth;if(this.rowHeaderWidth<$y[0]){$4D=$y[0];$4E=true;}};if($i.progressiveRowRendering){};if($4E){if(this.$cM){this.$cM.widths=this.rowHeaderCols;this.$cM.updateWidths();DayPilot.Util.updatePropsFromArray(this.rowHeaderColumns,"width",this.rowHeaderCols);};if(!this.rowHeaderScrolling){this.rowHeaderWidth=$4D;};this.$aT();this.$cN();}};this.$9l=function(){this.$cO=true;this.$cG();var $3l=this.$cH();var $4F=this.divHeader;if($4F){$4F.innerHTML='';DayPilot.puc($4F);}else{$4F=document.createElement("div");$4F.onmousemove=function(){$i.$cP();};if(!this.cssOnly){$4F.className=this.$9S("resourceheader");};this.divHeader=$4F;};$4F.style.width=$3l+"px";$4F.style.height=$i.$96+"px";$4F.rows=[];var $4z=$i.progressiveRowRendering;if($4z){$c();}else{var m=this.rowlist.length;for(var i=0;i<m;i++){$i.$cQ(i);}};$i.$cR();this.divResScroll.appendChild($4F);if(this.rowHeaderWidthAutoFit){this.$cK();}};this.$cS=function(){if(!$i.progressiveRowRendering){return;};var $J=this.$cI();for(var i=0;i<$i.rowlist.length;i++){if($J.start<=i&&i<$J.end){$i.$cQ(i);}else{$i.$cT(i);}};if(this.rowHeaderWidthAutoFit){var $4c=$i.$9V();this.$cK();var $4h=$i.$9V();if($4h!==$4c){var $4G=this.cellWidth;this.$9g();var $4H=this.cellWidth;if($4H!==$4G){this.$9h();this.$9m();this.$9s();this.$9k();}}}};this.$cR=function(){var $4F=$i.divHeader;var $4I=this.rowHeaderCols;var $1O=$4I?this.rowHeaderCols.length:0;var $3l=this.$cH();var c=document.createElement("div");c.style.position="absolute";c.style.top=this.$96+"px";c.colSpan=$1O+1;c.style.width=$3l+"px";c.style.height=($i.divResScroll.clientHeight+20)+"px";$4F.appendChild(c);$i.nav.resScrollSpace=c;if(!this.cssOnly){c.style.backgroundColor=this.hourNameBackColor;c.style.cursor='default';};c.setAttribute("unselectable","on");if(!this.cssOnly){c.className=this.$9S('rowheader');c.style.fontSize="1px";c.innerHTML="&nbsp;";};if(this.cssOnly){var $02=document.createElement("div");$02.style.position="relative";$02.style.height="100%";$02.className=this.$9S('_rowheader');c.appendChild($02);}};this.$cT=function(i){var $I=$i.divHeader.rows[i];if(!$I){return;};DayPilot.de($I.cells);$i.divHeader.rows[i]=null;};this.$aV=function(i){this.$cT(i);this.$cQ(i);};this.$cQ=function(i){var $4F=$i.divHeader;var $4J=this.divHeader;if($4J.rows[i]){return;};var $4I=this.rowHeaderCols;var $1O=$4I?this.rowHeaderCols.length:0;var $3l=this.$cH();var $I=this.rowlist[i];if(!$I){return;};if($I.hidden){return;};var $l=this.$cU($I);$4J.rows[i]={};$4J.rows[i].cells=[];var c=document.createElement("div");c.style.position="absolute";c.style.top=$I.top+"px";c.row=$I;c.index=i;var $23=$l.row;var $z=$4I?$4I[0]:this.rowHeaderWidth;c.style.width=($z)+"px";c.style.border="0px none";if($23.toolTip){c.title=$23.toolTip;};c.setAttribute("unselectable","on");c.onmousemove=$i.$cV;c.onmouseout=$i.$cW;c.onmouseup=$i.$cX;c.oncontextmenu=$i.$cY;c.onclick=$i.$cZ;c.ondblclick=$i.$d0;var $02=document.createElement("div");$02.style.width=($z)+"px";$02.setAttribute("unselectable","on");$02.className=this.cssOnly?this.$9S('_rowheader'):this.$9S('rowheader');if($23.cssClass){DayPilot.Util.addClass($02,$23.cssClass);};if($23.backColor){$02.style.background=$23.backColor;};$02.style.height=($I.height)+"px";$02.style.overflow='hidden';$02.style.position='relative';var $05=document.createElement("div");$05.setAttribute("unselectable","on");$05.className=this.cssOnly?this.$9S('_rowheader_inner'):"";$02.appendChild($05);var $0J=this.rowMoveHandling!=="Disabled";var $4K=10;var $4L=$23.areas||[];if($0J&&!$23.moveDisabled){$4L.push({"v":"Hover","w":$4K,"bottom":0,"top":0,"left":0,"css":$i.$9S("_rowmove_handle"),"action":"Move"});};var ro=$i.$bm($I);DayPilot.Areas.attach($02,ro,{"areas":$4L,"allowed":function(){return !$4M.row;}});var $3b=document.createElement("div");$3b.style.position="absolute";$3b.style.bottom="0px";$3b.style.width="100%";$3b.style.height="1px";$3b.className=this.$9S("_resourcedivider");$02.appendChild($3b);(function drawText(){if($i.treeEnabled&&!$I.isNewRow){var $N=$I.level*$i.treeIndent+$i.treeImageMarginLeft;if($0J){$N+=$4K;};var $z=10;var $37=document.createElement("div");$37.style.width="10px";$37.style.height=$z+"px";$37.style.backgroundRepeat="no-repeat";$37.style.position='absolute';$37.style.left=$N+'px';$37.style.top=$i.treeImageMarginTop+"px";if(!$I.loaded&&$I.children.length===0){if($i.treeImageExpand&&!$i.cssOnly){$37.style.backgroundImage="url('"+$i.treeImageExpand+"')";};$37.className=$i.cssOnly?$i.$9S('_tree_image_expand'):$i.$9S('tree_image_expand');$37.style.cursor='pointer';$37.index=i;$37.onclick=function(ev){$i.$d1(this.index);ev=ev||window.event;ev.cancelBubble=true;};}else if($I.children.length>0){if($I.expanded){if($i.treeImageCollapse&&!$i.cssOnly){$37.style.backgroundImage="url('"+$i.treeImageCollapse+"')";};$37.className=$i.cssOnly?$i.$9S('_tree_image_collapse'):$i.$9S('tree_image_collapse');}else{if($i.treeImageExpand&&!$i.cssOnly){$37.style.backgroundImage="url('"+$i.treeImageExpand+"')";};$37.className=$i.cssOnly?$i.$9S('_tree_image_expand'):$i.$9S('tree_image_expand');};$37.style.cursor='pointer';$37.index=i;$37.onclick=function(ev){$i.$cn(this.index);ev=ev||window.event;ev.cancelBubble=true;};}else{if($i.treeImageNoChildren&&!$i.cssOnly){$37.style.backgroundImage="url('"+$i.treeImageNoChildren+"')";};$37.className=$i.cssOnly?$i.$9S('_tree_image_no_children'):$i.$9S('tree_image_no_children');};$05.appendChild($37);};var $1s=document.createElement("div");if($i.treeEnabled){$1s.style.marginLeft=($N+$z)+"px";}else if(!$i.cssOnly){$1s.style.marginLeft="4px";};$1s.innerHTML=$23.html;c.textDiv=$1s;c.cellDiv=$02;$05.appendChild($1s);})();c.appendChild($02);if($23.areas){for(var j=0;j<$23.areas.length;j++){var $J=$23.areas[j];var v=$J.v||"Visible";if(v!=="Visible"){continue;};var r=$i.$bm($I);var a=DayPilot.Areas.createArea($02,r,$J);$02.appendChild(a);}};$4F.appendChild(c);$4J.rows[i].cells.push(c);if(!$I.columns||$I.columns.length===0){c.colSpan=$1O>0?$1O:1;$02.style.width=$3l+"px";}else{var $N=$z;for(var j=1;j<$1O;j++){var c=document.createElement("div");c.style.position="absolute";c.style.top=$I.top+"px";c.style.left=$N+"px";$4F.appendChild(c);$4J.rows[i].cells.push(c);c.row=$I;c.index=i;if($23.toolTip){c.title=$23.toolTip;};c.setAttribute("unselectable","on");c.onmousemove=$i.$cV;c.onmouseout=$i.$cW;c.onmouseup=$i.$cX;c.oncontextmenu=$i.$cY;c.onclick=$i.$cZ;c.ondblclick=$i.$d0;var $02=document.createElement("div");var w=this.cssOnly?$4I[j]:$4I[j]-1;$N+=w;if($23.backColor){$02.style.backgroundColor=$23.backColor;};$02.style.width=w+"px";$02.style.height=($I.height)+"px";$02.style.overflow='hidden';$02.style.position='relative';$02.setAttribute("unselectable","on");if(this.cssOnly){DayPilot.Util.addClass($02,this.$9S("_rowheader"));DayPilot.Util.addClass($02,this.$9S("_rowheadercol"));DayPilot.Util.addClass($02,this.$9S("_rowheadercol"+j));};if($23.cssClass){DayPilot.Util.addClass($02,$23.cssClass);};var $05=document.createElement("div");$05.setAttribute("unselectable","on");$05.className=this.$9S("_rowheader_inner");$02.appendChild($05);var $3b=document.createElement("div");$3b.style.position="absolute";$3b.style.bottom="0px";$3b.style.width="100%";$3b.style.height="1px";$3b.className=this.$9S("_resourcedivider");$02.appendChild($3b);var $1s=document.createElement("div");if(!this.cssOnly){$1s.style.marginLeft='4px';};var $4N=$23.columns[j-1];var $4O=$4N&&$4N.html?$4N.html:"";$1s.innerHTML=$4O;c.textDiv=$1s;c.cellDiv=$02;$05.appendChild($1s);c.appendChild($02);}}};this.$cY=function(){var $I=this.row;if($I.contextMenu){$I.contextMenu.show($i.$bm($I));};return false;};this.$cZ=function(ev){if($1r.cancelClick){return;};var $I=this.row;var r=$i.$bm($I,this.index);if($I.isNewRow){$i.$bq.edit($I);return;};$i.$bn(r,ev.ctrlKey,ev.shiftKey,ev.metaKey);};this.$d0=function(ev){if($i.timeouts.resClick){for(var $0U in $i.timeouts.resClick){window.clearTimeout($i.timeouts.resClick[$0U]);};$i.timeouts.resClick=null;};var $I=this.row;var e=$i.$bm($I,this.index);if($i.$9G()){var $l={};$l.resource=e;$l.preventDefault=function(){this.preventDefault.value=true;};if(typeof $i.onRowDoubleClick==='function'){$i.onRowDoubleClick($l);if($l.preventDefault.value){return;}};switch($i.rowDoubleClickHandling){case 'PostBack':$i.rowDoubleClickPostBack(e);break;case 'CallBack':$i.rowDoubleClickCallBack(e);break;case 'Select':$i.$bp($I,ev.ctrlKey,ev.shiftKey,ev.metaKey);break;case 'Edit':$i.$bq.edit($I);break;};if(typeof $i.onRowDoubleClicked==='function'){$i.onRowDoubleClicked($l);}}else{switch($i.rowDoubleClickHandling){case 'PostBack':$i.rowDoubleClickPostBack(e);break;case 'CallBack':$i.rowDoubleClickCallBack(e);break;case 'JavaScript':$i.onRowDoubleClick(e);break;case 'Select':$i.$bp($I,ev.ctrlKey,ev.shiftKey,ev.metaKey);break;case 'Edit':$i.$bq.edit($I);break;}}};this.rowDoubleClickPostBack=function(e,$q){var $0Q={};$0Q.resource=e;this.$aj("RowDoubleClick",$0Q,$q);};this.rowDoubleClickCallBack=function(e,$q){var $0Q={};$0Q.resource=e;this.$ak("RowDoubleClick",$0Q,$q);};this.$d2=function(ev){var $P={};$P.start=this.cell.start;$P.level=this.cell.level;$P.end=this.cell.end;if(!$P.end){$P.end=new DayPilot.Date($P.start).addMinutes($i.cellDuration);};$i.$br($P);};this.$bm=function($I){return new DayPilot.Row($I,$i);};this.$a7=function(i){var $I=this.rowlist[i];if(!$I.events){$I.resetEvents();};if($I.data){return;};$I.data={};$I.data.start=new DayPilot.Date($I.start);$I.data.startTicks=$I.data.start.getTime();var $0H=this.$aa().getTime()-this.$a6().getTime();$I.data.end=$0a.isResourcesView()?$I.data.start.addTime($0H):$I.data.start.addDays(1);$I.data.endTicks=$I.data.end.getTime();$I.data.offset=$I.start.getTime()-this.$a6().getTime();$I.data.i=i;};this.$9k=function($Z){if($Z){this.events.list=$Z;}else if(!this.events.list){this.events.list=[];};$4P.prepareRows(true);var $Y=this.events.list;var $4Q=$Y.length;var $4R=typeof this.onBeforeEventRender==='function';var $15;var $4S=$i.viewType==="Resources";for(var j=0;j<$4Q;j++){var $4T=$Y[j];if(!$4T){continue;};if($4T instanceof DayPilot.Event){throw "DayPilot.Scheduler: DayPilot.Event object detected in events.list array. Use raw event data instead.";};if($4R){this.$c4(j);};if($4T.resource==="*"){$15=$i.rowlist;}else if($4S){$15=$4P.rowcache[$4T.resource];}else if($i.viewType==="Days"){$15=$i.rowlist;}else if($i.viewType==="Gantt"){$15=$4P.rowcache[$4T.id];};for(var x=0;$15&&x<$15.length;x++){var $I=$15[x];var ep=this.$c5($4T,$I);if(!ep){continue;};if($4R){ep.cache=this.$97.events[j];}}};DayPilot.list($i.rowlist).each(function($I){$i.$d3($I);});this.$aE();};this.$d4=function($Z){var $4U=[];var $4V=[];var $4W=null;if($Z&&$4X){var $4Y=$Z;var $4W=[];for(var i=0;i<$4Y.length;i++){var e=$4Y[i];var $4Z=false;for(var j=0;j<this.events.list.length;j++){var ex=this.events.list[j];if(ex.id===e.id&&ex.start.toString()===e.start.toString()&&ex.resource===e.resource){var $15=$i.events.$aB(ex);$4V=$4V.concat($15);this.events.list[j]=e;$4Z=true;break;}};if(!$4Z){$4W.push(e);}};this.events.list=this.events.list.concat($4W);}else if($Z){this.events.list=$Z;}else if(!this.events.list){this.events.list=[];};var $Y=$4W||this.events.list;if($Z){this.events.list=$Z;}else if(!this.events.list){this.events.list=[];};var $Y=this.events.list;var $50=$Y.length;if(typeof this.onBeforeEventRender==='function'){var $K=$4W?this.events.list.length-$4W.length:0;var end=this.events.list.length;for(var i=$K;i<end;i++){this.$c4(i);}};var $51=!this.$c3();var $52=true;if($52){var $53=!$4W||typeof $I.events==="undefined";$4P.prepareRows($53);for(var j=0;$Y&&j<$50;j++){if($4U[j]){continue;};var $4T=$Y[j];if(!$4T){continue;};var $15=[];if($4T.resource==="*"){$15=$i.rowlist;}else if($i.viewType==="Days"){$15=$i.rowlist;}else if($i.viewType==="Gantt"){$15=$4P.rowcache[$4T.id];}else{$15=$4P.rowcache[$4T.resource];};for(var x=0;$15&&x<$15.length;x++){var $I=$15[x];var ep=this.$c5($4T,$I);if(!ep){continue;};if(typeof this.onBeforeEventRender==='function'){ep.cache=this.$97.events[j+$K];};$4V.push($I.index);}}}else{for(var i=0;i<this.rowlist.length;i++){var $I=this.rowlist[i];if(!$4W||typeof $I.events==="undefined"){$I.resetEvents();};$i.$a7(i);if(this.$bU(i)){continue;};for(var j=0;$Y&&j<$50;j++){if($4U[j]){continue;};var e=$Y[j];var ep=this.$c5(e,$I);if(!ep){continue;};if(typeof this.onBeforeEventRender==='function'){ep.cache=this.$97.events[j+$K];};$4V.push(i);if($51){if(ep.data.resource!=="*"&&ep.part.start.getTime()===ep.start().getTime()&&ep.part.end.getTime()===ep.rawend().getTime()){$4U[j]=true;}}}}};for(var i=0;i<this.rowlist.length;i++){var $I=this.rowlist[i];this.$d3($I);};this.$aE();return DayPilot.ua($4V);};this.$d5={};var $4P=this.$d5;$4P.rowCache={};$4P.prepareRows=function($53){$4P.rowcache={};for(var i=0;i<$i.rowlist.length;i++){var $I=$i.rowlist[i];if($53){$I.resetEvents();};$i.$a7(i);if(!$I.id){continue;};var $54=$I.id.toString();if(!$4P.rowcache[$54]){$4P.rowcache[$54]=[];};$4P.rowcache[$54].push($I);}};$4P.loadEvent=function($4T){};this.$c3=function(){var $55={};if($i.viewType!=="Resources"){return false;};for(var i=0;i<$i.rowlist.length;i++){var $I=$i.rowlist[i];var id=$I.id;if($55[id]){return true;};$55[id]=true;};return false;};this.$c4=function(i){var $0w=this.$97.events;var $q=this.events.list[i];var $56={};if($q instanceof DayPilot.Event){$q=$q.data;};for(var name in $q){$56[name]=$q[name];};if(typeof this.onBeforeEventRender==='function'){var $l={};$l.e=$56;$l.data=$56;this.onBeforeEventRender($l);};$0w[i]=$56;};this.$d3=function($I){$I.lines=[];$I.sections=null;if($I.isNewRow){return;};if(this.sortDirections){$I.events.sort(this.$d6);}else{$I.events.sort(this.$d7);};var $57=$i.groupConcurrentEvents;if($57){for(var i=0;i<$I.blocks.length;i++){$I.blocks[i].events=[];}};DayPilot.list($I.events).each(function(e){if(e.part.height){return;};if($I.eventHeight){e.part.height=$I.eventHeight;return;};e.part.height=$0a.eventHeight();});for(var j=0;j<$I.events.length;j++){var e=$I.events[j];$I.putIntoLine(e);if($57){$I.putIntoBlock(e);}};var $58=0;for(var i=0;i<$I.lines.length;i++){var $0u=$I.lines[i];$0u.top=$58;$58+=($0u.height||$I.eventHeight)*this.eventStackingLineHeight/100;};if($57){for(var j=0;j<$I.blocks.length;j++){var $59=$I.blocks[j];$59.lines=[];$59.events.sort(this.$d6);for(var k=0;k<$59.events.length;k++){var e=$59.events[k];$59.putIntoLine(e);};if($59.lines.length<=$i.groupConcurrentEventsLimit){$59.expanded=true;};var $5a=DayPilot.list($59.events).map(function(e){return e.id();}).some(function($00){return DayPilot.contains($i.$d8,$00);});if($5a){$59.expanded=true;};var $58=0;for(var i=0;i<$59.lines.length;i++){var $0u=$59.lines[i];$0u.top=$58;$58+=($0u.height||$I.eventHeight)*this.eventStackingLineHeight/100;}}}};this.$aD=function($15){$15=DayPilot.ua($15);for(var i=0;i<$15.length;i++){var ri=$15[i];$i.$d3($i.rowlist[ri]);};for(var i=0;i<$15.length;i++){var ri=$15[i];var $I=$i.rowlist[ri];$i.$d9($I);}};this.$ch=function(){var $K=$i.scale==="Manual"?$i.itline[0].start:$i.startDate;return DayPilot.list($i.rowlist).some(function($00){if(!$00.start){return false;};return $00.start.getTime()!==new DayPilot.Date($K).getTime();});};this.$c5=function(e,$I){var $K=new DayPilot.Date(e.start);var end=new DayPilot.Date(e.end);end=$i.$b1(end);var $5b=$K.ticks;var $5c=end.ticks;if($5c<$5b){return null;};var $0w=null;if(typeof $i.onBeforeEventRender==='function'){var $1t=DayPilot.indexOf($i.events.list,e);$0w=$i.$97.events[$1t];};if($0w){if($0w.hidden){return null;}}else if(e.hidden){return null;};var $5d=false;switch(this.viewType){case 'Days':$5d=!($5c<=$I.data.startTicks||$5b>=$I.data.endTicks)||($5b===$5c&&$5b===$I.data.startTicks);break;case 'Resources':$5d=($I.id===e.resource||$I.id==="*"||e.resource==="*")&&(!($5c<=$I.data.startTicks||$5b>=$I.data.endTicks)||($5b===$5c&&$5b===$I.data.startTicks));break;case 'Gantt':$5d=($I.id===e.id)&&!($5c<=$I.data.startTicks||$5b>=$I.data.endTicks);break;};if(!$5d){return null;};var ep=new DayPilot.Event(e,$i);ep.part.dayIndex=$I.data.i;ep.part.start=$I.data.startTicks<$5b?$K:$I.data.start;ep.part.end=$I.data.endTicks>$5c?end:$I.data.end;var $5e=this.getPixels(ep.part.start.addTime(-$I.data.offset));var $5f=this.getPixels(ep.part.end.addTime(-$I.data.offset));if(ep.part.start===ep.part.end){$5f=this.getPixels(ep.part.end.addTime(-$I.data.offset).addSeconds(1));};if($0w&&$0w.height){ep.part.height=$0w.height;}else if(e.height){ep.part.height=e.height;};ep.part.$da=function(){var $5g=this.height;if($i.eventVersionsEnabled&&!DayPilot.list(ep.data.versions).isEmpty()){var $0g=ep.versions.length;$5g+=$0g*$i.eventVersionHeight;$5g+=$0g*$i.eventVersionMargin;};return $5g;};var $N=$5e.left;var $O=$5f.left;ep.part.startPixels=$5e;ep.part.endPixels=$5f;if($N===$O){if($5e.cut||$5f.cut){return null;};var $1Z=(ep.part.start.addTime(-$I.data.offset).getTime()+ep.part.end.addTime(-$I.data.offset).getTime())/2;var $5h=$i.getPixels(new DayPilot.Date(Math.floor($1Z)));if($5h.cut){return null;}};ep.part.box=$0a.useBox($5c-$5b);var $2M=$i.eventHeight;if(e.type==="Milestone"){var $z=e.width||$2M;ep.part.end=ep.part.start;ep.part.left=$N-$z/2;ep.part.width=$z;ep.part.barLeft=0;ep.part.barWidth=$z;}else if(ep.part.box){var $5i=$5e.boxLeft;var $5j=$5f.boxRight;ep.part.left=$5i;ep.part.width=$5j-$5i;ep.part.barLeft=Math.max($N-ep.part.left,0);ep.part.barWidth=Math.max($O-$N,1);}else{ep.part.left=$N;ep.part.width=Math.max($O-$N,1);ep.part.barLeft=0;ep.part.barWidth=Math.max($O-$N-1,1);};if($i.eventVersionsEnabled){$i.$db(ep,$I);};if(typeof $i.onEventFilter==="function"&&$i.events.$c2){var $l={};$l.filter=$i.events.$c2;$l.visible=true;$l.e=ep;$i.onEventFilter($l);if(!$l.visible){return null;}};$I.events.push(ep);return ep;};this.$db=function(ep,$I){ep.versions=[];var $q=ep.data;var $Y=DayPilot.list($q.versions);if($Y.isEmpty()){return;};$Y.each(function($1u){var $K=new DayPilot.Date($1u.start);var end=new DayPilot.Date($1u.end);var $5e=$i.getPixels($K.addTime(-$I.data.offset));var $5f=$i.getPixels(end.addTime(-$I.data.offset));if($K.ticks===end.ticks){$5f=$i.getPixels(end.addTime(-$I.data.offset).addTime(1));};var $N=$5e.left;var $O=$5f.left;if($N===$O&&($5e.cut||$5f.cut)){return null;};var $5k={};$5k.left=$N;$5k.continueLeft=$K<$I.data.start;$5k.right=$O;$5k.continueRight=end>$I.data.end;$5k.width=$O-$N;ep.versions.push($5k);});};this.$d7=function(a,b){if(!a||!b||!a.start||!b.start){return 0;};var $5l=a.start().ticks-b.start().ticks;if($5l!==0){return $5l;};var $5m=b.end().ticks-a.end().ticks;return $5m;};this.$d6=function(a,b){if(!a||!b){return 0;};if(!a.data||!b.data||!a.data.sort||!b.data.sort||a.data.sort.length===0||b.data.sort.length===0){return $i.$d7(a,b);};var $j=0;var i=0;while($j===0&&typeof a.data.sort[i]!=="undefined"&&typeof b.data.sort[i]!=="undefined"){if(a.data.sort[i]===b.data.sort[i]){$j=0;}else{$j=$i.$dc(a.data.sort[i],b.data.sort[i],$i.sortDirections[i]);};i++;};return $j;};this.$dc=function(a,b,$5n){var $5o=($5n!=="desc");var $5p=$5o?-1:1;var $5q=-$5p;if(a===null&&b===null){return 0;};if(b===null){return $5q;};if(a===null){return $5p;};var ar=[];ar[0]=a;ar[1]=b;ar.sort();return a===ar[0]?$5p:$5q;};this.$bp=function($I,$17,$1w,$18){if($i.$9G()){var $1t=DayPilot.indexOf($i.rowlist,$I);var e=$i.$bm($I,$1t);var $5r=DayPilot.indexOf($1r.selected,$I)!==-1;var $0P=$5r?"deselected":"selected";var $l={};$l.row=e;$l.selected=$5r;$l.ctrl=$17;$l.shift=$1w;$l.meta=$18;$l.preventDefault=function(){this.preventDefault.value=true;};if(typeof $i.onRowSelect==='function'){$i.onRowSelect($l);if($l.preventDefault.value){return;}};var $5s=$1w&&!$17&&!$18;if(!$1w){$1r.$dd={"row":$I,"index":$1t};};if($5s){$1r.fixRowSelectLast();var $5t=$1r.$dd.index;var $5u=$1t;$1r.selectRange($5t,$5u);};switch($i.rowSelectHandling){case 'PostBack':$i.rowSelectPostBack(e,$0P);break;case 'CallBack':$i.rowSelectCallBack(e,$0P);break;case 'Update':!$5s&&$1r.select($I,$17,$1w,$18);break;};if(typeof $i.onRowSelected==='function'){$l.selected=DayPilot.indexOf($1r.selected,$I)!==-1;$i.onRowSelected($l);}}else{$1r.select($I,$17,$1w);var $1t=DayPilot.indexOf($i.rowlist,$I);var e=$i.$bm($I,$1t);var $5r=DayPilot.indexOf($1r.selected,$I)!==-1;var $0P=$5r?"deselected":"selected";switch($i.rowSelectHandling){case 'PostBack':$i.rowSelectPostBack(e,$0P);break;case 'CallBack':$i.rowSelectCallBack(e,$0P);break;case 'JavaScript':$i.onRowSelect(e,$0P);break;}}};this.rowSelectPostBack=function(r,$0P,$q){var $0Q={};$0Q.resource=r;$0Q.change=$0P;this.$aj('RowSelect',$0Q,$q);};this.rowSelectCallBack=function(r,$0P,$q){var $0Q={};$0Q.resource=r;$0Q.change=$0P;this.$ak('RowSelect',$0Q,$q);};this.rows={};this.rows.selection={};var $5v=this.rows.selection;$5v.get=function(){var $Y=[];DayPilot.list($1r.selected).each(function($00){$Y.push($i.$bm($00));});return $Y;};$5v.clear=function(){$1r.clearSelection();};$5v.add=function($I){if(!$I||!$I.isRow){throw "DayPilot.Scheduler.rows.selection.add(): DayPilot.Row object expected";};var $5w=DayPilot.list($1r.selected).some(function($00){return $00===$I.$.row;});if(!$5w){$1r.selected.push($I.$.row);};$1r.$de();$1r.$df();};$5v.$df=function(){$i.selectedRows=DayPilot.list($1r.selected).map(function($00){return $00.id;});};this.rows.all=function(){var $Y=[];for(var i=0;i<$i.rowlist.length;i++){var r=$i.$bm($i.rowlist[i]);$Y.push(r);};return $2D($Y);};this.rows.each=function(f){$i.rows.all().each(f);};this.rows.filter=function($5x){$i.rows.$c2=$5x;$i.$aI({"immediateEvents":true});};this.rows.find=function(id,$K){var $15=$i.rows.all();for(var i=0;i<$15.length;i++){var $00=$15[i];if($00.id===id){if(typeof $K==="string"){if($K===$00.start.toString()){return $00;}}else{return $00;}}}};this.rows.load=function($2q){DayPilot.ajax({"method":"POST","url":$2q,"success":function($l){var r=$l.request;var $q=DayPilot.Util.parseJSON(r.responseText);if(DayPilot.isArray($q)){$i.resources=$q;if($i.$aU){$i.update();}}}});};this.rows.expand=function($5y){var $15=[];var $5z=$5y||1;for(var i=0;i<$i.rowlist.length;i++){var $I=$i.rowlist[i];var $5A=$5z===-1;if($I.level<$5z){$5A=true;};if($5A&&!$I.expanded&&$I.children&&$I.children.length>0){$15.push($I.index);}};if($15.length===0){return;};if($15.length===1){$i.$cn($15[0]);}else{for(var i=0;i<$15.length;i++){var $1t=$15[i];var $I=$i.rowlist[$1t];$I.expanded=true;};$i.$aI();}};this.rows.expandAll=function(){$i.rows.expand(-1);};this.rows.headerHide=function(){$i.$dg=true;$i.$dh();$i.$cN();};this.rows.headerShow=function(){$i.$dg=false;$i.$dh();$i.$cN();};this.rows.headerToggle=function(){if($i.$dg){$i.rows.headerShow();}else{$i.rows.headerHide();}};this.$di=function(){var $1u=$4M.source;var $1v=$4M.target;var $w=$4M.position;$1r.resetMoving();if($i.$9G()){var $l={};$l.source=$i.$bm($1u);$l.target=$i.$bm($1v);$l.position=$w;$l.preventDefault=function(){this.preventDefault.value=true;};if(typeof $i.onRowMove==="function"){$i.onRowMove($l);if($l.preventDefault.value){return;}};switch($i.rowMoveHandling){case "Update":$1r.move($l);break;case "CallBack":$i.rowMoveCallBack($l.source,$l.target,$l.position);break;case "PostBack":$i.rowMovePostBack($l.source,$l.target,$l.position);break;case "Notify":$1r.move($l);$i.rowMoveNotify($l.source,$l.target,$l.position);break;};if(typeof $i.onRowMoved==="function"){$i.onRowMoved($l);}}else{var $1u=$i.$bm($1u);var $1v=$i.$bm($1v);var $w=$w;switch($i.rowMoveHandling){case "CallBack":$i.rowMoveCallBack($1u,$1v,$w);break;case "PostBack":$i.rowMovePostBack($1u,$1v,$w);break;case "JavaScript":$i.onRowMove($1u,$1v,$w);break;}}};this.$9E=function($15){var $Y=DayPilot.list($15);$1r.selected=[];if(!$Y.isEmpty()){$i.$8W=false;$i.$9j();};$Y.each(function($00){var $I=$i.$9J($00);if($I){$1r.selected.push($I);}});$1r.$de();};this.$bq={};var $1r=this.$bq;$1r.edit=function($I){var $5B=$1r.$dj($I);};$1r.rowSelectLastSetDefault=function(){$1r.$dd={"row":$i.rowlist[0],"index":0};};$1r.rowSelectSetLast=function($I){var $1t=DayPilot.indexOf($i.rowlist,$I);if($1t===-1){throw "DayPilot.Scheduler: Row not found when selecting a range";};$1r.$dd={"row":$I,"index":$1t};};$1r.fixRowSelectLast=function(){if(!$1r.$dd){$1r.rowSelectLastSetDefault();};var $1t=DayPilot.indexOf($i.rowlist,$1r.$dd.row);if($1t>-1){return;};var $I=$i.$9J($1r.$dd.row.id);if($I){$1t=DayPilot.indexOf($i.rowlist,$I);$1r.$dd={"row":$I,"index":$1t};}else{$1r.rowSelectLastSetDefault();}};$1r.createOverlay=function($I){var $z=$i.$cH();var $2E=$i.$9S("_rowmove_source");var $02=DayPilot.Util.div($i.divHeader,0,$I.top,$z,$I.height);$02.className=$2E;$I.moveOverlay=$02;};$1r.deleteOverlay=function($I){DayPilot.de($I.moveOverlay);$I.moveOverlay=null;};$1r.$dj=function($I){var r=$1r.$bj($I);var c=r.cells[0];if(c.input){return c.input;};var $z=c.clientWidth;if($I.isNewRow){$z=$i.$9V();};var $5B=document.createElement("textarea");$5B.style.position="absolute";$5B.style.top="0px";$5B.style.left="0px";$5B.style.width=$z+"px";$5B.style.height=$I.height+"px";$5B.style.border="0px none";$5B.style.overflow="hidden";$5B.style.boxSizing="border-box";$5B.style.resize="none";var $1R=c.textDiv;$5B.style.fontFamily=DayPilot.gs($1R,'fontFamily')||DayPilot.gs($1R,'font-family');$5B.style.fontSize=DayPilot.gs($1R,'fontSize')||DayPilot.gs($1R,'font-size');$5B.value=$I.html;c.firstChild.appendChild($5B);c.input=$5B;var $5C=function(){try{c.input.parentNode.removeChild(c.input);}catch(e){$c();};c.input=null;};$5B.focus();$5B.onblur=function(){$5B.onblur=null;var $1q=$5B.value;var $1t=DayPilot.indexOf($i.rowlist,$I);$5C();if(!$5B.canceled){$i.$bl($I,$1q);}};$5B.onkeydown=function(e){var $5D=(window.event)?event.keyCode:e.keyCode;if($5D===27){$5B.canceled=true;$5C();};if($5D===13){$5B.onblur();return false;};return true;};if($5B.setSelectionRange){$5B.setSelectionRange(0,9999);}else{$5B.select();};return $5B;};$1r.selected=[];$1r.select=function($I,$17,$1w,$18){var $5r=DayPilot.indexOf($1r.selected,$I)!==-1;if($17||$18){if($5r){$1r.unselect($I);DayPilot.rfa($1r.selected,$I);return;}}else{$5r=false;$1r.clearSelection();};$1r.$dk($I);if(!$5r){$1r.selected.push($I);};$5v.$df();};$1r.selectRange=function($5t,$5u){$1r.clearSelection();var $4j=Math.min($5t,$5u);var $y=Math.max($5t,$5u);for(var i=$4j;i<=$y;i++){var $I=$i.rowlist[i];$1r.$dk($I);$1r.selected.push($I);};$5v.$df();};$1r.$de=function(){for(var i=0;i<$1r.selected.length;i++){var $I=$1r.selected[i];$1r.$dk($I);}};$1r.$dk=function($I){var y=DayPilot.indexOf($i.rowlist,$I);if(y===-1){var $5E=$i.$9J($I.id).index;if($5E){y=$5E.index;}else{return;}};var cl=$i.$9S("_cell_selected");var $M=[];for(var i=0;i<$i.itline.length;i++){var c={};c.x=i;c.y=y;$M.push(c);};$i.cells.findXy($M).addClass(cl);var cl=$i.$9S("_rowheader_selected");var $4A=$i.divHeader;for(var y=0;y<$4A.rows.length;y++){var r=$4A.rows[y];if(r&&r.cells[0]&&r.cells[0].row===$I){for(var x=0;x<r.cells.length;x++){var c=r.cells[x];var $5F=c.firstChild;DayPilot.Util.addClass($5F,cl);}}}};$1r.$bD=function(){var $Y=[];if(!$1r.selected){return $Y;};for(var i=0;i<$1r.selected.length;i++){var $I=$1r.selected[i];var $1t=DayPilot.indexOf($i.rowlist,$I);var r=$i.$bm($I,$1t);$Y.push(r.toJSON());};return $Y;};$1r.unselect=function($I){var cl=$i.$9S("_cell_selected");var y=DayPilot.indexOf($i.rowlist,$I);var $M=[];for(var i=0;i<$i.itline.length;i++){var c={};c.x=i;c.y=y;$M.push(c);};$i.cells.findXy($M).removeClass(cl);var cl=$i.$9S("_rowheader_selected");var $4A=$i.divHeader;var r=$1r.$bj($I);if(r){for(var x=0;x<r.cells.length;x++){var c=r.cells[x];var $5F=c.firstChild;DayPilot.Util.removeClass($5F,cl);}}};$1r.$dd=null;$1r.clearSelection=function(){for(var j=0;j<$1r.selected.length;j++){var $I=$1r.selected[j];$1r.unselect($I);};$1r.selected=[];$i.selectedRows=[];};$1r.$bj=function($I){var $4A=$i.divHeader;for(var y=0;y<$4A.rows.length;y++){var r=$4A.rows[y];if(r&&r.cells[0]&&r.cells[0].row===$I){return r;}};return null;};$1r.selectById=function(id){var $I=$i.$9J(id);if($I){$1r.select($I);}};$1r.startMoving=function($I){var $4M=DayPilot.Global.rowmoving;$4M.row=$I;$4M.cursor=$i.divResScroll.style.cursor;$i.divResScroll.style.cursor="move";$1r.createOverlay($I);};$1r.resetMoving=function(){$i.divResScroll.style.cursor=$4M.cursor;DayPilot.de($4M.div);$1r.deleteOverlay($4M.row);DayPilot.Global.rowmoving=$4M={};};$1r.move=function($l){var $1u=$l.source.$.row.resource;var $1v=$l.target.$.row.resource;var $w=$l.position;if($w==="forbidden"){return;};var $5G=$5H.findParentArray($1u);if(!$5G){throw "Cannot find source node parent";};var $5I=DayPilot.indexOf($5G,$1u);$5G.splice($5I,1);var $5J=$5H.findParentArray($1v);if(!$5J){throw "Cannot find target node parent";};var $5K=DayPilot.indexOf($5J,$1v);switch($w){case "before":$5J.splice($5K,0,$1u);break;case "after":$5J.splice($5K+1,0,$1u);break;case "child":if(!$1v.children){$1v.children=[];$1v.expanded=true;};$1v.children.push($1u);break;};$i.update();};var $5H={};$5H.findParentArray=function($1G){return $5H.findInArray($i.resources,$1G);};$5H.findInArray=function($3s,$1G){if(DayPilot.indexOf($3s,$1G)!==-1){return $3s;};for(var i=0;i<$3s.length;i++){var r=$3s[i];if(r.children&&r.children.length>0){var parent=$5H.findInArray(r.children,$1G);if(parent){return parent;}}};return null;};this.$9i=function(){this.rowlist=DayPilot.list();var $1I=this.resources;var $5L=this.$a2();if(!$5L){if(this.viewType==="Gantt"){$1I=this.$dl();}else if(this.viewType==="Days"){$1I=this.$dm();}};if($5L&&this.viewType==="Days"&&(!$1I||$1I.length===0)){$1I=this.$dm();};var $1t={};$1t.i=0;this.$dn($1I,$1t,0,null,this.treeEnabled,false);var $5M=$i.rowCreateHandling!=="Disabled";if($5M){this.$do();}};this.$do=function(){var r={};r.id="NEW";r.isNewRow=true;r.html="";r.loaded=true;r.start=this.startDate;r.children=[];r.height=$i.eventHeight;r.marginBottom=0;r.marginTop=0;r.getHeight=function(){return $i.eventHeight+$i.rowMarginBottom+$i.rowMarginTop;};r.putIntoLine=function(){};r.resetEvents=function(){};this.rowlist.push(r);};this.$dl=function(){var $Y=[];if(this.$8Z&&this.resources){for(var i=0;i<this.resources.length;i++){$Y.push(this.resources[i]);}};if(!this.events.list){return;};for(var i=0;i<this.events.list.length;i++){var e=this.events.list[i];var r={};r.id=e.id;r.name=e.text;$Y.push(r);};return $Y;};this.$dm=function(){var $Y=[];var $K=$i.$a6();var $5N=this.$bS.locale();for(var i=0;i<this.days;i++){var d=$K.addDays(i);var r={};r.name=d.toString($5N.datePattern,$5N);r.start=d;$Y.push(r);};return $Y;};this.$a6=function(){if(this.itline&&this.itline.length>0){return this.itline[0].start;};return this.startDate;};this.$aa=function(){if(this.itline&&this.itline.length>0){return this.itline[this.itline.length-1].end;};return this.startDate.addDays(this.days);};this.$dp={};var $5O=this.$dp;this.visibleStart=function(){return this.$a6();};this.visibleEnd=function(){return this.$aa();};this.$dn=function($1I,$1t,$5z,parent,$5P,$5Q){if(!$1I){return;};for(var i=0;i<$1I.length;i++){if(!$1I[i]){continue;};var $5R={};$5R.level=$5z;$5R.hidden=$5Q;$5R.index=$1t.i;var $1G=this.$dq($1I[i],$5R);var $I={};$I.backColor=$1G.backColor;$I.cssClass=$1G.cssClass;$I.expanded=$1G.expanded;$I.name=$1G.name;$I.html=$1G.html?$1G.html:$I.name;$I.eventHeight=typeof $1G.eventHeight!=='undefined'?$1G.eventHeight:$i.$bS.eventHeight();$I.minHeight=typeof $1G.minHeight!=='undefined'?$1G.minHeight:$i.rowMinHeight;$I.marginBottom=typeof $1G.marginBottom!=='undefined'?$1G.marginBottom:$i.rowMarginBottom;$I.marginTop=typeof $1G.marginTop!=='undefined'?$1G.marginTop:$i.rowMarginTop;$I.loaded=!$1G.dynamicChildren;$I.id=$1G.id||$1G.value;$I.toolTip=$1G.toolTip;$I.children=[];$I.columns=[];$I.start=$1G.start?new DayPilot.Date($1G.start):this.$a6();$I.isParent=$1G.isParent;$I.contextMenu=$1G.contextMenu?DayPilot.Util.evalVariable($1G.contextMenu):this.contextMenuResource;$I.areas=$1G.areas;$I.moveDisabled=$1G.moveDisabled;$I.bubbleHtml=$1G.bubbleHtml;$I.tags=$1G.tags;$I.task=$1G.task;$I.height=$I.eventHeight;$I.hidden=$5Q;$I.level=$5z;$I.index=$1t.i;$I.resource=$1I[i];$I.lines=[];$I.blocks=[];$I.isRow=true;$I.getHeight=function(){var $R=0;if($i.groupConcurrentEvents){for(var i=0;i<this.blocks.length;i++){var $59=this.blocks[i];$R=Math.max($R,$59.getHeight());}}else{if(this.lines.length>0){var $0C=this.lines.length-1;var $0u=this.lines[$0C];var $5S=$0u.height||this.eventHeight;var top=$0u.top||0;$R=top+$5S;}};if($R===0){$R=this.eventHeight;};return($R>this.minHeight)?$R:this.minHeight;};$I.resetEvents=function(){var r=this;r.events=[];r.events.forRange=function($K,end){var $j=[];for(var i=0;i<r.events.length;i++){var ev=r.events[i];if(DayPilot.Util.overlaps(ev.start(),ev.end(),$K,end)){$j.push(ev);}};return $j;};};$I.calculateUtilization=function(){var r=this;var $5T=r.sections=getSections();for(var i=0;i<$5T.length;i++){var $04=$5T[i];$04.events=[];for(var x=0;x<r.events.length;x++){var e=r.events[x];if(DayPilot.Util.overlaps($04.start,$04.end,e.start(),e.rawend())){$04.events.push(e);}};$04.sum=function(name){var $5U=0;for(var i=0;i<this.events.length;i++){var e=this.events[i];var $5V=0;if(typeof name==="undefined"){$5V=1;}else if(e.tag(name)){$5V=e.tag(name);}else if(e.data[name]){$5V=e.data[name];};if(typeof $5V==='number'){$5U+=$5V;}};return $5U;}};function getPoints(){var $5W=[];for(var i=0;i<r.events.length;i++){var e=r.events[i];if(!DayPilot.contains($5W,e.start().toString())){$5W.push(e.start().toString());};if(!DayPilot.contains($5W,e.rawend().toString())){$5W.push(e.rawend().toString());}};$5W.sort();return $5W;};function getSections(){var $5W=getPoints();var $5T=[];var $04={"start":r.data.start};for(var i=0;i<$5W.length;i++){$04.end=new DayPilot.Date($5W[i]);$5T.push($04);$04={"start":new DayPilot.Date($5W[i])};};$04.end=r.data.end;$5T.push($04);$5T.forRange=function($K,end){var $Y=[];for(var i=0;i<this.length;i++){var $04=this[i];if(DayPilot.Util.overlaps($K,end,$04.start,$04.end)){$Y.push($04);}};$Y.maxSum=function(name){var $y=0;for(var i=0;i<this.length;i++){var $04=this[i];var $5U=$04.sum(name);if($5U>$y){$y=$5U;}};return $y;};return $Y;};return $5T;}};$I.putIntoLine=function(ep){var $5X=this;for(var i=0;i<this.lines.length;i++){var $0u=this.lines[i];if($0u.isFree(ep.part.left,ep.part.width)){$0u.add(ep);return i;}};var $0u=[];$0u.height=0;$0u.add=function(ep){this.push(ep);var $5g=ep.part.$da();if($5g>$0u.height){$0u.height=$5g;}};$0u.isFree=function($5Y,$5Z,$47){var end=$5Y+$5Z-1;var $y=this.length;for(var i=0;i<$y;i++){var e=this[i];if(!(end<e.part.left||$5Y>e.part.left+e.part.width-1)){if(DayPilot.contains($47,e.data)){continue;};return false;}};return true;};$0u.add(ep);this.lines.push($0u);return this.lines.length-1;};$I.putIntoBlock=function(ep){for(var i=0;i<this.blocks.length;i++){var $59=this.blocks[i];if(DayPilot.indexOf($59.events,ep)!==-1){return;};if($59.overlapsWith(ep.part.left,ep.part.width)){$59.events.push(ep);ep.part.block=$59;$59.min=Math.min($59.min,ep.part.left);$59.max=Math.max($59.max,ep.part.left+ep.part.width);return i;}};var $59={};$59.expanded=false;$59.row=this;$59.events=[];$59.lines=[];$59.putIntoLine=function(ep){var $60=this;for(var i=0;i<this.lines.length;i++){var $0u=this.lines[i];if($0u.isFree(ep.part.left,ep.part.width)){$0u.add(ep);return i;}};var $0u=[];$0u.height=0;$0u.add=function(ep){this.push(ep);if(ep.part.height>$0u.height){$0u.height=ep.part.height;}};$0u.isFree=function($K,$z){var end=$K+$z-1;var $y=this.length;for(var i=0;i<$y;i++){var e=this[i];if(!(end<e.part.left||$K>e.part.left+e.part.width-1)){return false;}};return true;};$0u.add(ep);this.lines.push($0u);};$59.overlapsWith=function($K,$z){var end=$K+$z-1;if(!(end<this.min||$K>this.max-1)){return true;};return false;};$59.getHeight=function(){if(!this.expanded){return $i.eventHeight;};if(this.lines.length>0){var $0C=this.lines.length-1;var $0u=this.lines[$0C];var $5S=$0u.height||$i.eventHeight;var top=$0u.top||0;return top+$5S;}};$59.events.push(ep);ep.part.block=$59;$59.min=ep.part.left;$59.max=ep.part.left+ep.part.width;this.blocks.push($59);};$I.$dr=false;$I.$ds=parent;$I.$dt=function(){this.hidden=!this.$du();this.$dr=false;if(this.$ds){this.$ds.$dt();}};$I.$du=function(){if(!this.$ds){return true;};return this.$ds.$du()&&this.$ds.expanded;};this.rowlist.push($I);if(typeof $i.onRowFilter==="function"&&$i.rows.$c2){var $l={};$l.visible=true;$l.row=$i.$bm($I);$l.filter=$i.rows.$c2;$i.onRowFilter($l);$I.$dr=!$l.visible;if(!$l.visible){$I.hidden=true;}else{if(parent){parent.$dt();}}};if(parent!==null){parent.children.push($1t.i);};if($1G.columns){for(var j=0;j<$1G.columns.length;j++){$I.columns.push($1G.columns[j]);}};$1t.i++;if($5P&&$1G.children&&$1G.children.length){var $61=$5Q||!$I.expanded;this.$dn($1G.children,$1t,$5z+1,$I,true,$61);}}};this.$cU=function($I){if($I.isNewRow){return{"row":{"cssClass":$i.$9S("_row_new"),"moveDisabled":true,"html":""}};};var $l={};$l.row=this.$bm($I);DayPilot.Util.copyProps($I,$l.row,['html','backColor','cssClass','toolTip','contextMenu','moveDisabled']);$l.row.columns=DayPilot.Util.createArrayCopy($I.columns,['html']);$l.row.areas=DayPilot.Util.createArrayCopy($I.areas);if(typeof $l.row.columns==='undefined'&&$i.rowHeaderColumns&&$i.rowHeaderColumns.length>0){r.columns=[];for(var i=0;i<$i.rowHeaderColumns.length;i++){r.columns.push({});}};if(typeof this.onBeforeRowHeaderRender==="function"){this.onBeforeRowHeaderRender($l);};return $l;};this.$dq=function($1G,$5R){var r=this.$dv($1G,$5R);if(typeof this.onBeforeResHeaderRender==='function'){var $l={};$l.resource=r;this.onBeforeResHeaderRender($l);};return r;};this.$dv=function($1G,$5R){var r={};for(var name in $5R){r[name]=$5R[name];};for(var name in $1G){r[name]=$1G[name];};if(typeof $1G.html==='undefined'){r.html=$1G.name;};if(typeof r.columns==='undefined'&&$i.rowHeaderColumns&&$i.rowHeaderColumns.length>0){r.columns=[];for(var i=0;i<$i.rowHeaderColumns.length;i++){r.columns.push({});}};return r;};this.$dw=function(){this.$dx();this.nav.top.dp=this;this.nav.top.innerHTML="";DayPilot.Util.addClass(this.nav.top,this.$9S("_main"));if(DayPilot.browser.ie9){DayPilot.Util.addClass(this.nav.top,this.$9S("_browser_ie9"));};if(DayPilot.browser.ie8){DayPilot.Util.addClass(this.nav.top,this.$9S("_browser_ie8"));};this.nav.top.style.MozUserSelect='none';this.nav.top.style.KhtmlUserSelect='none';this.nav.top.style.webkitUserSelect='none';this.nav.top.style.WebkitTapHighlightColor="rgba(0,0,0,0)";this.nav.top.style.WebkitTouchCallout="none";if(this.width){this.nav.top.style.width=this.width;};if(this.heightSpec==="Parent100Pct"){this.nav.top.style.height="100%";};this.nav.top.style.lineHeight="1.2";this.nav.top.style.position="relative";if(!this.visible){this.nav.top.style.display="none";};this.nav.top.onmousemove=this.$dy;this.nav.top.ontouchstart=$0I.onMainTouchStart;this.nav.top.ontouchmove=$0I.onMainTouchMove;this.nav.top.ontouchend=$0I.onMainTouchEnd;if(this.hideUntilInit&&this.backendUrl){this.nav.top.style.visibility='hidden';};var $3g=this.$9V();var $62=this.$bS.layout();if($62==='DivBased'){var $N=document.createElement("div");$N.style.position="absolute";$N.style.left="0px";$N.style.width=($3g)+"px";$N.appendChild(this.$dz());var $63=document.createElement("div");$63.style.height="1px";$63.className=this.$9S("_divider_horizontal");$N.appendChild($63);this.nav.dh1=$63;$N.appendChild(this.$dA());this.nav.left=$N;var $64=document.createElement("div");$64.style.position="absolute";$64.style.left=($3g)+"px";$64.style.width=$0a.splitterWidth()+"px";$64.style.height=(this.$9U()+this.$9Y())+"px";$64.className=this.$9S("_divider")+" "+this.$9S("_splitter");$64.setAttribute("unselectable","on");this.nav.divider=$64;if(this.rowHeaderScrolling){this.$dB();};var $O=document.createElement("div");$O.style.marginLeft=($3g+$0a.splitterWidth())+"px";$O.style.marginRight='1px';$O.style.position='relative';$O.appendChild(this.$dC());this.nav.right=$O;var $65=document.createElement("div");$65.style.height="1px";$65.style.position="absolute";$65.style.top=this.$9U()+"px";$65.style.width="100%";$65.className=this.$9S("_divider_horizontal");$O.appendChild($65);this.nav.dh2=$65;$O.appendChild(this.$dD());var $66=document.createElement("div");$66.style.clear='left';this.nav.top.appendChild($N);this.nav.top.appendChild($64);this.nav.top.appendChild($O);this.nav.top.appendChild($66);}else{var $4A=document.createElement("table");$4A.cellPadding=0;$4A.cellSpacing=0;$4A.border=0;$4A.style.position='absolute';if(!this.cssOnly){$4A.style.backgroundColor=this.hourNameBackColor;};var $67=$4A.insertRow(-1);var $68=$67.insertCell(-1);$68.appendChild(this.$dz());var $69=$67.insertCell(-1);$69.appendChild(this.$dC());var $6a=$4A.insertRow(-1);var $6b=$6a.insertCell(-1);$6b.appendChild(this.$dA());var $6c=$6a.insertCell(-1);$6c.appendChild(this.$dD());this.nav.top.appendChild($4A);};this.$9f=document.createElement("div");this.$9f.style.display="none";this.nav.top.appendChild(this.$9f);if(this.$bC()){var $6d=document.createElement("input");$6d.type="hidden";$6d.id=this.id+"_state";$6d.name=this.id+"_state";this.nav.state=$6d;this.nav.top.appendChild($6d);};var $4y=5;var loading=document.createElement("div");loading.style.position='absolute';loading.style.left=(this.$9V()+$0a.splitterWidth()+5)+"px";loading.style.top=(this.$9U()+5)+"px";loading.style.display='none';if(!this.cssOnly){loading.style.backgroundColor=this.loadingLabelBackColor;loading.style.fontSize=this.loadingLabelFontSize;loading.style.fontFamily=this.loadingLabelFontFamily;loading.style.color=this.loadingLabelFontColor;loading.style.padding='2px';};loading.innerHTML=this.loadingLabelText;DayPilot.Util.addClass(loading,this.$9S("_loading"));this.nav.loading=loading;this.nav.top.appendChild(loading);this.$dE();};this.$dy=function(ev){if($4M.row){var $1T=DayPilot.mo3($i.divHeader,ev);var ri=$i.$bK($1T.y);var $I=$i.rowlist[ri.i];if($I.isNewRow){return;};var $6e=$1T.y-ri.top;var $6f=ri.bottom-ri.top;var $6g=$6f/3;var $6h=$6g*2;var $1Z=$6f/2;var $w="before";var $6i=$I.children&&$I.children.length>0;var $6j=(function(){var i=ri.i;var $6k=$I.level;while(i>=0){var r=$i.rowlist[i];i--;if($6k<=r.level){continue;};if(r===$4M.row){return true;};if(r.level===0){return false;};$6k=r.level;};return false;})();var $6l=true;if($6j||ri.i===$4M.row.index){$w="forbidden";}else if($6l){if($6i){if($6e<$1Z){$w="before";}else{$w="child";}}else{if($6e<$6g){$w="before";}else if($6e<$6h){$w="child";}else{$w="after";}}}else{if($6i){$w="before";}else{if($6e<$1Z){$w="before";}else{$w="after";}}};if($4M.row.moveDisabled){$w="forbidden";};$4M.calendar=$i;$4M.source=$4M.row;$4M.target=$i.rowlist[ri.i];$4M.position=$w;var $6m=(function(){if(!$4M.last){return true;};if($4M.last.target!==$4M.target){return true;};if($4M.last.position!==$4M.position){return true;};return false;})();if($6m){if(typeof $i.onRowMoving==='function'){var $l={};$l.source=$i.$bm($4M.source);$l.target=$i.$bm($4M.target);$l.position=$w;$i.onRowMoving($l);$4M.position=$l.position;}}else if($4M.last){$4M.position=$4M.last.position;};$4M.last={};$4M.last.target=$4M.target;$4M.last.position=$4M.position;(function drawRowPosition(){if($4M.div){DayPilot.de($4M.div);};var top=ri.top;var $F=$4M.position;var ro=$i.rowlist[ri.i];var $5z=ro.level;var $N=$5z*$i.treeIndent;switch($F){case "before":top=ri.top;break;case "child":top=ri.top+$1Z;break;case "after":top=ri.bottom;break;case "forbidden":top=ri.top+$1Z;break;};var $z=$i.$cH()-$N;var $w=document.createElement("div");$w.style.position="absolute";$w.style.left=$N+"px";$w.style.width=$z+"px";$w.style.top=top+"px";$w.className=$i.$9S("_rowmove_position_"+$F);$4M.div=$w;$i.divResScroll.appendChild($w);})();}else if(DayPilotScheduler.splitting){var $z=DayPilot.mo3($i.nav.top,ev).x;var $y=$i.$cH();var $4h=Math.min($y,$z-1);$i.rowHeaderWidth=$4h;$i.$dg=false;$i.$dh();}};this.$9r=function(){var $R=this.$9U();this.nav.corner.style.height=($R)+"px";this.divTimeScroll.style.height=$R+"px";this.divNorth.style.height=$R+"px";if(this.nav.dh1&&this.nav.dh2){this.nav.dh1.style.top=$R+"px";this.nav.dh2.style.top=$R+"px";};this.nav.loading.style.top=($R+5)+"px";this.nav.scroll.style.top=($R+1)+"px";};this.$9V=function(){if(this.$dg){return 0;};var $6n=this.rowHeaderScrolling;if($6n){return this.rowHeaderWidth;};return this.$cH();};this.$dB=function(){var $02=this.nav.divider;$02.style.cursor="col-resize";$02.setAttribute("unselectable","on");$02.onmousedown=function(ev){var $6o=DayPilotScheduler.splitting={};$6o.cursor=$i.nav.top.style.cursor;$6o.cleanup=function(){$i.nav.top.style.cursor=$6o.cursor;if(typeof $i.onRowHeaderResized==="function"){var $l={};$i.onRowHeaderResized($l);}};$i.nav.top.style.cursor="col-resize";return false;};};this.$dh=function(){var $6p=$0a.splitterWidth();var $z=this.$9V();this.nav.corner.style.width=$z+"px";this.divCorner.style.width=$z+"px";this.divResScroll.style.width=$z+"px";this.nav.left.style.width=($z)+"px";this.nav.divider.style.left=($z)+"px";this.nav.right.style.marginLeft=($z+$6p)+"px";if(this.nav.message){this.nav.message.style.left=($z+$6p)+"px";};if(this.nav.loading){this.nav.loading.style.left=($z+$6p+5)+"px";};if(this.nav.hideIcon){var hi=this.nav.hideIcon;var $6q=$i.$9S("_header_icon_show");var $6r=$i.$9S("_header_icon_hide");hi.style.left=($z+$6p-1)+"px";if($i.$dg){DayPilot.Util.removeClass(hi,$6r);DayPilot.Util.addClass(hi,$6q);}else{DayPilot.Util.removeClass(hi,$6q);DayPilot.Util.addClass(hi,$6r);}}};this.$dF=function(){this.$cG();var $0d=this.$cH();var $6s=function($P,$z,$N){if(!$P||!$P.style){return;};var $02=$P.firstChild;if($i.$cO){$P.style.width=$z+"px";$02.style.width=$z+"px";if(typeof $N==="number"){$P.style.left=$N+"px";}}else{$02.style.width=$z+"px";}};var $4A=this.divHeader;$4A.style.width=$0d+"px";var $1l=$i.$cI();for(var i=$1l.start;i<$1l.end;i++){var $I=$4A.rows[i];if(!$I){continue;};var $P=$I.cells[0];if($P.colSpan>1){var $P=$I.cells[0];$6s($P,$0d);}else{if(this.rowHeaderCols){var $N=0;for(var j=0;j<$I.cells.length;j++){var $z=this.rowHeaderCols[j];var $P=$I.cells[j];$6s($P,$z,$N);$N+=$z;}}else{var $z=this.rowHeaderWidth;var $P=$I.cells[0];$6s($P,$z);}}};if($i.nav.resScrollSpace){$i.nav.resScrollSpace.style.width=$0d+"px";};this.$dG();};this.$aT=function(){this.$dh();this.$dF();};this.$dH=function(){var $02=$i.nav.corner;var $23=this.rowHeaderColumns;var scroll=document.createElement("div");scroll.style.position="absolute";scroll.style.bottom="0px";scroll.style.left="0px";scroll.style.width="100%";scroll.style.height=$0a.headerHeight()+"px";scroll.style.overflow="hidden";$i.nav.columnScroll=scroll;var $I=document.createElement("div");$I.style.position="absolute";$I.style.bottom="0px";$I.style.left="0px";$I.style.width="5000px";$I.style.height=$0a.headerHeight()+"px";$I.style.overflow="hidden";$I.className=this.$9S("_columnheader");scroll.appendChild($I);var $05=document.createElement("div");$05.style.position="absolute";$05.style.top="0px";$05.style.bottom="0px";$05.style.left="0px";$05.style.right="0px";$05.className=this.$9S("_columnheader_inner");$I.appendChild($05);var $6t=new DayPilot.Splitter($05);$6t.widths=DayPilot.Util.propArray($23,"width");$6t.height=$0a.headerHeight();$6t.css.title=this.$9S("_columnheader_cell");$6t.css.titleInner=this.$9S("_columnheader_cell_inner");$6t.css.splitter=this.$9S("_columnheader_splitter");$6t.titles=DayPilot.Util.propArray($23,"title");$6t.updating=function($l){DayPilot.Util.updatePropsFromArray($i.rowHeaderColumns,"width",this.widths);$i.$aT();if($i.cellWidthSpec==="Auto"){}};$6t.updated=function($6u){$i.$cN();if($i.$9G()){if(typeof $i.onRowHeaderColumnResized==="function"){var $l={};$l.column=$i.rowHeaderColumns[$6u.index];$i.onRowHeaderColumnResized($l);};}else{switch($i.rowHeaderColumnResizedHandling){case "CallBack":break;case "PostBack":break;case "JavaScript":if(typeof $i.onRowHeaderColumnResized==="function"){var $l={};$l.column=$i.rowHeaderColumns[$6u.index];$i.onRowHeaderColumnResized($l);};break;}}};$6t.color='#000000';$6t.opacity=30;$6t.init();$02.appendChild(scroll);this.$cM=$6t;};this.$aS=function(){var $02=this.nav.corner;$02.innerHTML='';$02.className=this.cssOnly?this.$9S('_corner'):this.$9S('corner');if(!this.cssOnly){$02.style.backgroundColor=this.hourNameBackColor;$02.style.fontFamily=this.hourFontFamily;$02.style.fontSize=this.hourFontSize;$02.style.cursor='default';};var $05=document.createElement("div");$05.style.position="absolute";$05.style.top="0px";$05.style.left="0px";$05.style.right="0px";$05.style.bottom="0px";if(this.cssOnly){$05.className=this.$9S('_corner_inner');};this.divCorner=$05;$05.innerHTML='&nbsp;';if(this.rowHeaderColumns&&this.rowHeaderColumns.length>0){var $6v=document.createElement("div");$6v.style.position="absolute";$6v.style.top="0px";$6v.style.left="0px";$6v.style.right="0px";$6v.style.bottom=($0a.headerHeight()+1)+"px";$02.appendChild($6v);var $64=document.createElement("div");$64.style.position="absolute";$64.style.left="0px";$64.style.right="0px";$64.style.height="1px";$64.style.bottom=($0a.headerHeight())+"px";$64.className=this.$9S("_divider");$02.appendChild($64);$6v.appendChild($05);this.$dH();}else{$02.appendChild($05);};var $6w=document.createElement("div");$6w.style.position='absolute';$6w.style.padding='2px';$6w.style.top='0px';$6w.style.left='1px';$6w.style.backgroundColor="#FF6600";$6w.style.color="white";$6w.innerHTML="\u0044\u0045\u004D\u004F";if(this.numberFormat)$02.appendChild($6w);};this.$dE=function(){if(!this.rowHeaderHideIconEnabled){return;};var $6x=3;var $N=this.$9V()+$0a.splitterWidth()-1;var $z=10;var $R=20;var top=this.$9U()+$6x;var $02=DayPilot.Util.div(this.nav.top,$N,top,$z,$R);$02.style.cursor="pointer";$02.className=$i.$9S("_header_icon");DayPilot.Util.addClass($02,$i.$9S("_header_icon_hide"));$02.onclick=function(){$i.rows.headerToggle();};this.nav.hideIcon=$02;};this.$dz=function(){var $3g=this.$9V();var $02=document.createElement("div");$i.nav.corner=$02;$02.style.width=$3g+"px";$02.style.height=(this.$9U())+"px";$02.style.overflow='hidden';$02.style.position='relative';$02.setAttribute("unselectable","on");$02.onmousemove=function(){$i.$cP();};$02.oncontextmenu=function(){return false;};this.$aS();return $02;};this.$9U=function(){if(this.timeHeader){var $6y=this.timeHeader.length;return $6y*$0a.headerHeight();};return 2*$0a.headerHeight();};this.$dI=null;this.$dA=function(){var $02=document.createElement("div");if(!this.cssOnly){$02.style.backgroundColor=this.hourNameBackColor;};$02.style.width=(this.$9V())+"px";$02.style.height=this.$9Y()+"px";$02.style.overflow='hidden';$02.style.position='relative';$02.className=$i.$9S("_rowheader_scroll");$02.onmousemove=function(){$i.$cP();};$02.onscroll=function(){if($i.nav.columnScroll&&$i.rowHeaderScrolling){$i.nav.columnScroll.scrollLeft=$02.scrollLeft;};if($i.$dI){clearTimeout($i.$dI);};$i.$dI=setTimeout(function(){$i.nav.scroll.scrollTop=$02.scrollTop;},500);};$02.onwheel=function(ev){var $4f=ev.deltaY>0?$i.eventHeight:-$i.eventHeight;$i.nav.scroll.scrollTop=$02.scrollTop+$4f;ev.preventDefault&&ev.preventDefault();};$02.onmousewheel=function(ev){ev=ev||window.event;var $4f=ev.wheelDelta<0?$i.eventHeight:-$i.eventHeight;$i.nav.scroll.scrollTop=$02.scrollTop+$4f;ev.preventDefault&&ev.preventDefault();ev.returnValue=false;};$02.oncontextmenu=function(){return false;};$02.onmouseenter=function(){if($i.rowHeaderScrolling){$02.style.overflowX="auto";}};$02.onmouseleave=function(){if($i.rowHeaderScrolling){$02.style.overflowX="hidden";}};this.divResScroll=$02;this.$9Z=$02;return $02;};this.$dJ=function($02){if($0a.layout()==='TableBased'){var $z=parseInt(this.width,10);var $6z=(this.width.indexOf("%")!==-1);var $6A=/MSIE/i.test(navigator.userAgent);var $3g=this.$cH();if($6z){if(this.nav.top&&this.nav.top.offsetWidth>0){$02.style.width=(this.nav.top.offsetWidth-6-$3g)+"px";}}else{$02.style.width=($z-$3g)+"px";}}};this.$bP=function(ev){$i.$9p();$i.$9F();};this.$9p=function(){if($i.$bS.layout()==='TableBased'){$i.$dJ($i.nav.scroll);$i.$dJ($i.divTimeScroll);};$i.$9s();$i.$cN();$i.$dK();$i.$97.drawArea=null;};this.$dK=function(){var $1l=DayPilotScheduler.rangeHold;$i.clearSelection();DayPilotScheduler.rangeHold=$1l;$i.$bc($1l,true);};this.$cN=function(){if(!$i.$aU){return;};if($i.cellWidthSpec!=='Auto'){return;};$i.$9g();$i.$9h();$i.$9m();$i.$9t();$i.$9x();$i.$9v();$i.$9y();$i.$9u();$i.$9k();$i.$9z();};this.$9g=function(){if(this.cellWidthSpec!=='Auto'){return;};var $0d=this.nav.top.clientWidth;var $6B=this.$9V();var $6C=$i.$dL();var $1b=$0d-$6B-$6C;var $6D=this.$9T();if(!$6D){return;};var $P=$1b/this.$9T();this.cellWidth=Math.max($P,$i.cellWidthMin);$i.$dM=$P<$i.cellWidthMin;};this.$dL=function(){if($i.heightSpec==="Auto"){return 0;};if($i.heightSpec==="Max"||$i.heightSpec==="Fixed"||$i.heightSpec==="Parent100Pct"){var $05=$i.$dN();if($05>$i.height){return DayPilot.sw($i.nav.scroll);}else{return 0;}};return DayPilot.sw($i.nav.scroll);};this.$a1=function(){var $0d=this.nav.top.clientWidth;var $6B=this.$9V();var $6E=2;var $R=this.$9Y();var innerHeight=this.$dN();var $6F=0;if(innerHeight>$R){$6F=DayPilot.swa();};var $1b=$0d-$6B-$6E-$6F;return $1b;};this.$dC=function(){var $02=document.createElement("div");$02.style.overflow='hidden';$02.style.position='absolute';$02.style.display='block';$02.style.top="0px";$02.style.width="100%";$02.style.height=this.$9U()+"px";$02.style.overflow="hidden";$02.onmousemove=function(){$i.$cP();if($i.cellBubble){$i.cellBubble.delayedHide();}};this.$dJ($02);this.divTimeScroll=$02;var $05=document.createElement("div");$05.style.width=(this.$9T()*this.cellWidth+5000)+"px";this.divNorth=$05;$02.appendChild($05);return $02;};this.$9Y=function(){var $R=0;if(this.heightSpec==='Fixed'||this.heightSpec==="Parent100Pct"){return this.height?this.height:0;}else{$R=this.$dN();};if(this.heightSpec==='Max'&&$R>this.height){return this.height;};return $R;};this.$dN=function(){var $R;if(this.$96){var $6G=DayPilot.sh($i.nav.scroll);if($6G===0){$R=this.$96;}else{$R=this.$96+$6G;}}else{$R=this.rowlist.length*this.$bS.eventHeight();};return $R;};this.$cP=function(){this.$dG();this.$dO();this.$dP();};this.$dD=function(){var $02=document.createElement("div");$02.style.overflow="auto";$02.style.overflowX="auto";$02.style.overflowY="auto";$02.style.position="absolute";$02.style.height=(this.$9Y())+"px";$02.style.top=(this.$9U()+1)+"px";$02.style.width="100%";if(!this.cssOnly){$02.style.backgroundColor=this.emptyBackColor;};$02.className=this.$9S("_scrollable");$02.oncontextmenu=function(){return false;};this.$dJ($02);this.nav.scroll=$02;this.$9H=document.createElement("div");this.$9H.style.MozUserSelect="none";this.$9H.style.KhtmlUserSelect="none";this.$9H.style.webkitUserSelect="none";this.$9H.daypilotMainD=true;this.$9H.calendar=this;if($a){this.$9H.style.webkitTransform="translateZ(0px)";};this.$9H.style.position='absolute';var $6H=this.$cA();if($6H>0&&!isNaN($6H)){this.$9H.style.width=($6H)+"px";};this.$9H.setAttribute("unselectable","on");this.$9H.onmousedown=this.$dQ;this.$9H.onmousemove=this.$dR;this.$9H.onmouseup=this.$dS;this.$9H.oncontextmenu=this.$dT;this.$9H.ondblclick=this.$dU;this.$9H.className=this.$9S("_matrix");this.divStretch=document.createElement("div");this.divStretch.style.position='absolute';this.divStretch.style.height='1px';this.$9H.appendChild(this.divStretch);this.divCells=document.createElement("div");this.divCells.style.position='absolute';this.divCells.oncontextmenu=this.$dT;this.$9H.appendChild(this.divCells);this.divLines=document.createElement("div");this.divLines.style.position='absolute';this.divLines.oncontextmenu=this.$dT;this.$9H.appendChild(this.divLines);this.divBreaks=document.createElement("div");this.divBreaks.style.position='absolute';this.divBreaks.oncontextmenu=this.$dT;this.$9H.appendChild(this.divBreaks);this.divSeparators=document.createElement("div");this.divSeparators.style.position='absolute';this.divSeparators.oncontextmenu=this.$dT;this.$9H.appendChild(this.divSeparators);this.divLinksBelow=document.createElement("div");this.divLinksBelow.style.position="absolute";this.$9H.appendChild(this.divLinksBelow);this.divCrosshair=document.createElement("div");this.divCrosshair.style.position='absolute';this.divCrosshair.ondblclick=this.$dU;this.$9H.appendChild(this.divCrosshair);this.divRange=document.createElement("div");this.divRange.style.position='absolute';this.divRange.oncontextmenu=this.$dT;this.$9H.appendChild(this.divRange);this.divEvents=document.createElement("div");this.divEvents.style.position='absolute';this.$9H.appendChild(this.divEvents);this.divSeparatorsAbove=document.createElement("div");this.divSeparatorsAbove.style.position='absolute';this.divSeparatorsAbove.oncontextmenu=this.$dT;this.$9H.appendChild(this.divSeparatorsAbove);this.divLinksAbove=document.createElement("div");this.divLinksAbove.style.position="absolute";this.$9H.appendChild(this.divLinksAbove);this.divLinkShadow=document.createElement("div");this.divLinkShadow.style.position="absolute";this.$9H.appendChild(this.divLinkShadow);this.divLinkpoints=document.createElement("div");this.divLinkpoints.style.position="absolute";this.$9H.appendChild(this.divLinkpoints);this.divRectangle=document.createElement("div");this.divRectangle.style.position="absolute";this.$9H.appendChild(this.divRectangle);this.divHover=document.createElement("div");this.divHover.style.position='absolute';this.$9H.appendChild(this.divHover);$02.appendChild(this.$9H);return $02;};this.$dV={};var $0X=this.$dV;$0X.create=function(){if($i.nav.overlay){return;};var $02=document.createElement('div');$02.style.position="absolute";$02.style.left="0px";$02.style.right="0px";$02.style.top="0px";$02.style.bottom="0px";$02.className=$i.$9S("_block");$i.nav.top.appendChild($02);$i.nav.overlay=$02;};$0X.show=function(){$0X.create();$i.nav.overlay.style.display='';};$0X.hide=function(){if($i.nav.overlay){$i.nav.overlay.style.display='none';}};this.$by=function($6I){if($i.loadingTimeout){window.clearTimeout($i.loadingTimeout);};var $09=$6I?0:100;$i.loadingTimeout=window.setTimeout(function(){if($i.loadingLabelVisible){$i.nav.loading.innerHTML=$i.loadingLabelText;$i.nav.loading.style.display='';};if($i.blockOnCallBack){$0X.show();}},$09);};this.$9a=function(){if(this.loadingTimeout){window.clearTimeout(this.loadingTimeout);};this.nav.loading.style.display='none';if(this.blockOnCallBack){$0X.hide();}};this.$dW=function(){this.startDate=new DayPilot.Date(this.startDate).getDatePart();};this.$dX=function($6J){var $02=document.createElement("div");$02.style.position="absolute";$02.style.top="-2000px";$02.style.left="-2000px";$02.className=this.$9S($6J);document.body.appendChild($02);var $R=$02.offsetHeight;var $z=$02.offsetWidth;document.body.removeChild($02);var $j={};$j.height=$R;$j.width=$z;return $j;};this.$9b=function($6K){if($6K){this.autoRefreshEnabled=true;};if(!this.autoRefreshEnabled){return;};if(this.$95>=this.autoRefreshMaxCount){return;};this.$bx();var $6L=this.autoRefreshInterval;if(!$6L||$6L<10){throw "The minimum autoRefreshInterval is 10 seconds";};this.autoRefreshTimeout=window.setTimeout(function(){$i.$dY();},this.autoRefreshInterval*1000);};this.$bx=function(){if(this.autoRefreshTimeout){window.clearTimeout(this.autoRefreshTimeout);}};this.autoRefreshStart=function($6K){$i.$9b($6K);};this.autoRefreshPause=function(){$i.$bx();};this.$dY=function(){if(!DayPilotScheduler.resizing&&!DayPilotScheduler.moving&&!DayPilotScheduler.drag&&!DayPilotScheduler.range){var $6M=false;if(typeof this.onAutoRefresh==='function'){var $l={};$l.i=this.$95;$l.preventDefault=function(){this.preventDefault.value=true;};$i.onAutoRefresh($l);if($l.preventDefault.value){$6M=true;}};if(!$6M&&this.$a2()){this.commandCallBack(this.autoRefreshCommand);};this.$95++;};if(this.$95<this.autoRefreshMaxCount){this.autoRefreshTimeout=window.setTimeout(function(){$i.$dY();},this.autoRefreshInterval*1000);}};this.$dZ=function(){if(!DayPilotScheduler.globalHandlers){DayPilotScheduler.globalHandlers=true;DayPilot.re(document,'mousemove',DayPilotScheduler.gMouseMove);DayPilot.re(document,'mouseup',DayPilotScheduler.gMouseUp);DayPilot.re(document,'keyup',DayPilotScheduler.gKeyUp);DayPilot.re(document,'mousedown',DayPilotScheduler.gMouseDown);DayPilot.re(document,'touchmove',DayPilotScheduler.gTouchMove);DayPilot.re(document,'touchend',DayPilotScheduler.gTouchEnd);};DayPilot.re(window,'resize',this.$bP);};this.$e0=function(){this.nav.scroll.root=this;this.nav.scroll.onscroll=this.$9F;$i.$cs=this.nav.scroll.scrollLeft;$i.$cr=this.nav.scroll.scrollTop;$i.$ct=this.divNorth.clientWidth;};this.$9C=function(){if(!this.nav.state){return;};var $6N={};$6N.scrollX=this.nav.scroll.scrollLeft;$6N.scrollY=this.nav.scroll.scrollTop;if(this.syncResourceTree){$6N.tree=this.$bH();};this.nav.state.value=DayPilot.he(DayPilot.JSON.stringify($6N));};this.$9y=function(){if(!this.separators){return;};for(var i=0;i<this.separators.length;i++){this.$e1(i);}};this.$e2={};this.$e2.step=300;this.$e2.delay=10;this.$e2.mode="display";this.$e2.layers=true;this.$d9=function($I){var $6O=true;var $6P=this.durationBarDetached?-10:0;var $58=0;for(var j=0;j<$I.lines.length;j++){var $0u=$I.lines[j];$0u.height=0;$0u.top=$58;for(var k=0;k<$0u.length;k++){var e=$0u[k];if(!e.part.top||$6O){e.part.line=j;if(!e.part.height){e.part.height=$I.eventHeight;};var $5g=e.part.$da();if($5g>$0u.height){$0u.height=$5g;};e.part.top=$58+$I.marginTop;if($i.eventVersionsEnabled&&!DayPilot.list(e.data.versions).isEmpty()){var $0g=e.data.versions.length;var top=e.part.top;DayPilot.list(e.data.versions).each(function($5k,i){if(!e.versions[i]){return;};var $0B=i*($i.eventVersionHeight+$i.eventVersionMargin);e.versions[i].top=top+$0B;e.part.top+=$i.eventVersionHeight;e.part.top+=$i.eventVersionMargin;});};e.part.detachedBarTop=e.part.top-$6P;e.part.right=e.part.left+e.part.width;e.part.fullTop=this.rowlist[e.part.dayIndex].top+e.part.top;e.part.fullBottom=e.part.fullTop+e.part.height;}};$58+=($0u.height||$I.eventHeight)*this.eventStackingLineHeight/100;}};this.$9z=function($1g){var $E=this.$e2.step;var $6Q=this.$e2.layers;if($6Q){$i.divEvents=document.createElement("div");$i.divEvents.style.position='absolute';$i.$9H.insertBefore(this.divEvents,this.divSeparatorsAbove);};if(this.$e2.mode==='display'){this.divEvents.style.display='none';}else if(this.$e2.mode==='visibility'){this.divEvents.style.visibility='hidden';};var $6R=this.dynamicEventRendering==='Progressive';var $J=this.$9L();var top=$J.pixels.top;var $W=$J.pixels.bottom;for(var i=0;i<this.rowlist.length;i++){var $I=this.rowlist[i];var $3S=$I.top-this.dynamicEventRenderingMargin;var $6S=$3S+$I.height+2*this.dynamicEventRenderingMargin;if($6R&&($W<=$3S||top>=$6S)){continue;};this.$d9($I);for(var j=0;j<$I.lines.length;j++){var $0u=$I.lines[j];for(var k=0;k<$0u.length;k++){var e=$0u[k];var $6T=this.$e3(e);if($1g&&$6T){$E--;if($E<=0){this.divEvents.style.visibility='';this.divEvents.style.display='';window.setTimeout(function(){$i.$9z($1g);},$i.$e2.delay);return;}}}}};this.divEvents.style.display='';if(!DayPilot.list($i.multiselect.list).isEmpty()){$i.multiselect.redraw();};this.$9O();$1c.load();};this.$aY=function($6U){var $I=this.rowlist[$6U];this.divEvents=document.createElement("div");this.divEvents.style.position='absolute';this.divEvents.style.display='none';this.$9H.insertBefore(this.divEvents,this.divSeparatorsAbove);var $6P=this.durationBarDetached?10:0;this.$d9($I);for(var j=0;j<$I.lines.length;j++){var $0u=$I.lines[j];for(var k=0;k<$0u.length;k++){var e=$0u[k];this.$e3(e);}};this.divEvents.style.display='';};this.$9u=function(){if(this.elements.events){var length=this.elements.events.length;for(var i=0;i<length;i++){var $02=this.elements.events[i];this.$e4($02);}};this.elements.events=[];};this.$aX=function($6U){if(this.elements.events){var length=this.elements.events.length;var $6V=[];for(var i=0;i<length;i++){var $02=this.elements.events[i];if($02.row===$6U){this.$e4($02);$6V.push(i);}};for(var i=$6V.length-1;i>=0;i--){this.elements.events.splice($6V[i],1);}}};this.$e4=function($02){$02.onclick=null;$02.oncontextmenu=null;$02.onmouseover=null;$02.onmouseout=null;$02.onmousemove=null;$02.onmousedown=null;$02.ondblclick=null;if($02.event){if(!$02.isBar){$02.event.rendered=null;};$02.event=null;};if($02.related){DayPilot.de($02.related);};if($02.parentNode){$02.parentNode.removeChild($02);}};this.$e5=function($02){if($02.event){$02.event.rendered=false;};$02.onclick=null;$02.onmousedown=null;$02.event=null;if($02.parentNode){$02.parentNode.removeChild($02);}};this.$e6=function($6W){if(!$6W){$6W=0;};if(this.dynamicEventRendering!=='Progressive'){return;};this.divEvents.style.display='none';var $6X=[];var $6Y=0;var length=this.elements.events.length;for(var i=length-1;i>=0;i--){var $02=this.elements.events[i];if(this.$e7($02.event)){if($6W>0){$6W--;$6X.unshift($02);}else{this.$e4($02);$6Y++;}}else{$6X.unshift($02);}};this.elements.events=$6X;this.divEvents.style.display='';};this.$e8=function($6W){var $6X=[];var $6Y=0;var $J=this.$9L();var length=this.elements.cells.length;for(var i=length-1;i>=0;i--){var $02=this.elements.cells[i];var $6Z=($J.xStart<$02.coords.x&&$02.coords.x<=$J.xEnd)&&($J.yStart<$02.coords.y&&$02.coords.y<=$J.yEnd);if(!$6Z){if($6W>0){$6W--;$6X.unshift($02);}else{this.$cb($02);$6Y++;}}else{$6X.unshift($02);}}};this.$cb=function($02){if(!$02){return;};var x=$02.coords.x;var y=$02.coords.y;DayPilot.rfa($i.elements.cells,$02);DayPilot.de($02);$i.$97.cells[x+"_"+y]=null;};this.$9v=function(){if(this.elements.separators){for(var i=0;i<this.elements.separators.length;i++){var $02=this.elements.separators[i];DayPilot.de($02);}};this.elements.separators=[];};this.$e9=function(){var $6R=this.dynamicEventRendering==='Progressive';if(!this.nav.scroll){return false;};var top=this.nav.scroll.scrollTop;var $W=top+this.nav.scroll.clientHeight;for(var i=0;i<this.rowlist.length;i++){var $I=this.rowlist[i];var $3S=$I.top;var $6S=$I.top+$I.height;if($6R&&($W<=$3S||top>=$6S)){continue;};for(var j=0;j<$I.lines.length;j++){var $0u=$I.lines[j];for(var k=0;k<$0u.length;k++){var e=$0u[k];if(this.$ea(e)){return true;}}}};return false;};this.$ea=function($q){if($q.rendered){return false;};var $6R=this.dynamicEventRendering==='Progressive';var $N=this.nav.scroll.scrollLeft;var $O=$N+this.nav.scroll.clientWidth;var $70=$q.Left;var $71=$q.Left+$q.Width;if($6R&&($O<=$70||$N>=$71)){return false;};return true;};this.$e7=function(ev){if(!ev.rendered){return true;};var $J=this.$9L();var top=$J.pixels.top;var $W=$J.pixels.bottom;var $N=$J.pixels.left-this.dynamicEventRenderingMargin;var $O=$J.pixels.right+this.dynamicEventRenderingMargin;var $70=ev.part.left;var $71=ev.part.right;var $72=ev.part.fullTop;var $73=ev.part.fullBottom;if($O<=$70||$N>=$71){return true;};if($W<=$72||top>=$73){return true;};return false;};this.$d8=DayPilot.list();this.$eb=function($59){if($59.rendered){return false;};var $N=$59.min;var $z=$59.max-$59.min;var $R=$i.eventHeight;var top=$59.row.top;var $02=document.createElement("div");$02.style.position='absolute';$02.style.left=$N+'px';$02.style.top=top+'px';$02.style.width=$z+'px';$02.style.height=$R+'px';$02.className=$i.$9S("_event_group");$02.style.cursor="pointer";var $l={};$l.group={};$l.group.count=$59.events.length;$l.group.html="[+] "+$59.events.length+" events";if(typeof $i.onBeforeGroupRender==="function"){$i.onBeforeGroupRender($l);};var $05=document.createElement("div");$05.innerHTML=$l.group.html;$02.appendChild($05);$02.onmousedown=function(ev){var ev=ev||window.event;ev.cancelBubble=true;};$02.onclick=function(ev){var $59=$02.event;$59.expanded=true;$i.$e5($02);var $74=DayPilot.indexOf($i.elements.events,$02);if($74!==-1){$i.elements.events.splice($74,1);};var $Y=$i.$d8;DayPilot.list($59.events).each(function(e){$Y.push(e.id());});$i.$aE();$i.$aF($59.part.dayIndex);$i.$9s();var ev=ev||window.event;ev.cancelBubble=true;};$59.part={};$59.part.left=$N;$59.part.width=$z;$59.part.dayIndex=DayPilot.indexOf($i.rowlist,$59.row);$59.part.top=0;$59.client={};$59.client.html=function(){return $l.group.html;};$02.event=$59;this.elements.events.push($02);this.divEvents.appendChild($02);$59.rendered=true;return true;};this.$e3=function(e){if(e.rendered){return false;};if($i.groupConcurrentEvents){var $59=e.part.block;if($59.events.length>1&&!$59.expanded){return $i.$eb($59);}};var $6R=this.dynamicEventRendering==='Progressive';var $J=this.$9L();var $N=$J.pixels.left-this.dynamicEventRenderingMargin;var $O=$J.pixels.right+this.dynamicEventRenderingMargin;var $70=e.part.left;var $71=e.part.left+e.part.width;if($6R&&($O<=$70||$N>=$71)){return false;};var $6U=e.part.dayIndex;var $75=!this.cssOnly&&this.eventBorderVisible;var $z=e.part.width;var $R=e.part.height;if($75){$z-=2;$R-=2;};var $0w=e.cache||e.data;$z=Math.max(0,$z);$R=Math.max(0,$R);var $I=this.rowlist[$6U];if($I.hidden){return false;};var $3S=$I.top;var $76=this.durationBarDetached;var $02=document.createElement("div");$02.related=[];if($76){var $77=e.part.barLeft;var $3T=e.part.barWidth;if(this.durationBarMode==="PercentComplete"){$77=0;$3T=($0w.complete||0)/100*$z;};var $3q=document.createElement("div");$3q.style.position='absolute';$3q.style.left=(e.part.left+$77)+'px';$3q.style.top=($3S+e.part.detachedBarTop)+'px';$3q.style.width=$3T+'px';$3q.style.height=5+'px';$3q.style.backgroundColor="black";$3q.type="detachedBar";$02.related.push($3q);this.divEvents.appendChild($3q);};(function drawVersions(parent){if(!$i.eventVersionsEnabled){return;};DayPilot.list(e.data.versions).each(function($5k,i){if(!$5k){return;};var $78=e.versions[i];if(!$78){return;};var $02=document.createElement("div");$02.style.position='absolute';$02.style.left=$78.left+'px';$02.style.top=($3S+$78.top)+'px';$02.style.width=$78.width+'px';$02.style.height=$i.eventVersionHeight+'px';$02.className=$i.$9S("_event")+" "+$i.$9S("_event_previous")+" "+$i.$9S("_event_version");if($5k.toolTip){$02.title=$5k.toolTip;};if($5k.cssClass){DayPilot.Util.addClass($02,$5k.cssClass);};var $05=document.createElement("div");$05.setAttribute("unselectable","on");$05.className=$i.$9S("_event_inner");$05.innerHTML=$5k.html||$5k.text||"";if($5k.backColor){$05.style.background=$5k.backColor;if(DayPilot.browser.ie9||DayPilot.browser.ielt9){$05.style.filter='';}};if($5k.fontColor){$05.style.color=$5k.fontColor;};if($5k.borderColor){$05.style.borderColor=$5k.borderColor;};if($5k.backImage){$05.style.backgroundImage="url("+$5k.backImage+")";if($5k.backRepeat){$05.style.backgroundRepeat=$5k.backRepeat;}};$02.appendChild($05);if($78.continueLeft){DayPilot.Util.addClass($02,$i.$9S("_event_continueleft"));};if($78.continueRight){DayPilot.Util.addClass($02,$i.$9S("_event_continueright"));};var $79=$i.durationBarVisible&&!$5k.barHidden;var $z=$78.width;if($79&&$z>0){var $77=100*$78.barLeft/($z);var $3T=Math.ceil(100*$78.barWidth/($z));if($i.durationBarMode==="PercentComplete"){$77=0;$3T=$5k.complete||0;};var $3q=document.createElement("div");$3q.setAttribute("unselectable","on");$3q.className=$i.$9S("_event_bar");$3q.style.position="absolute";if($5k.barBackColor){$3q.style.backgroundColor=$5k.barBackColor;};var $7a=document.createElement("div");$7a.setAttribute("unselectable","on");$7a.className=$i.$9S("_event_bar_inner");$7a.style.left=$77+"%";if(0<$3T&&$3T<=1){$7a.style.width="1px";}else{$7a.style.width=$3T+"%";};if($5k.barColor){$7a.style.backgroundColor=$5k.barColor;};if($5k.barImageUrl){$7a.style.backgroundImage="url("+$5k.barImageUrl+")";};$3q.appendChild($7a);$02.appendChild($3q);};if($5k.htmlLeft){var $4y=5;var $7b=document.createElement("div");$7b.style.position='absolute';$7b.style.right=-($78.left-$4y)+'px';$7b.style.top=($3S+$78.top)+'px';$7b.style.height=$i.eventHeight+'px';$7b.style.boxSizing="border-box";$7b.innerHTML=$5k.htmlLeft;$7b.className=$i.$9S("_event_left");$7b.type="divLeft";$7b.versionPart=$78;parent.related.push($7b);$i.divEvents.appendChild($7b);};if($5k.htmlRight){var $4y=5;var $7c=document.createElement("div");$7c.style.position='absolute';$7c.style.left=($78.left+$78.width+$4y)+'px';$7c.style.top=($3S+$78.top)+'px';$7c.style.height=$i.eventHeight+'px';$7c.style.boxSizing="border-box";$7c.innerHTML=$5k.htmlRight;$7c.className=$i.$9S("_event_right");$7c.type="divRight";$7c.versionPart=$78;parent.related.push($7c);$i.divEvents.appendChild($7c);};$02.versionPart=$78;$02.type="version";parent.related.push($02);$i.divEvents.appendChild($02);});})($02);if(e.data.htmlLeft){var $4y=5;var $7b=document.createElement("div");$7b.style.position='absolute';$7b.style.right=-(e.part.left-$4y)+'px';$7b.style.top=($3S+e.part.top)+'px';$7b.style.height=$i.eventHeight+'px';$7b.style.boxSizing="border-box";$7b.innerHTML=e.data.htmlLeft;$7b.className=$i.$9S("_event_left");$7b.type="divLeft";$02.related.push($7b);this.divEvents.appendChild($7b);};if(e.data.htmlRight){var $4y=5;var $7c=document.createElement("div");$7c.style.position='absolute';$7c.style.left=(e.part.left+e.part.width+$4y)+'px';$7c.style.top=($3S+e.part.top)+'px';$7c.style.height=$i.eventHeight+'px';$7c.style.boxSizing="border-box";$7c.innerHTML=e.data.htmlRight;$7c.className=$i.$9S("_event_right");$7c.type="divRight";$02.related.push($7c);this.divEvents.appendChild($7c);};var top=$3S+e.part.top;$02.style.position='absolute';$02.style.left=e.part.left+'px';$02.style.top=($3S+e.part.top)+'px';$02.style.width=$z+'px';$02.style.height=$R+'px';if(!$i.eventTextWrappingEnabled){$02.style.whiteSpace='nowrap';};$02.style.overflow='hidden';$02.className=this.cssOnly?this.$9S("_event"):this.$9S("event");if(e.data.type==="Milestone"){DayPilot.Util.addClass($02,$i.$9S("_task_milestone"));};if(e.data.type==="Group"){DayPilot.Util.addClass($02,$i.$9S("_task_parent"));DayPilot.Util.addClass($02,$i.$9S("_task_group"));};if($0w.cssClass){DayPilot.Util.addClass($02,$0w.cssClass);};var $7d=true;if($7d){DayPilot.Util.addClass($02,this.$9S("_event_line"+e.part.line));};$02.setAttribute("unselectable","on");if(this.showToolTip&&!this.bubble){$02.title=e.client.toolTip()||"";};$02.onmousemove=this.$ec;$02.onmouseout=this.$ed;$02.onmousedown=this.$ee;$02.ontouchstart=$0I.onEventTouchStart;$02.ontouchmove=$0I.onEventTouchMove;$02.ontouchend=$0I.onEventTouchEnd;if(e.client.clickEnabled()){$02.onclick=this.$ah;};if(e.client.doubleClickEnabled()){$02.ondblclick=this.$at;};$02.oncontextmenu=this.$as;var $7e=[];var $7f=0;if(this.cssOnly){var $05=document.createElement("div");$05.setAttribute("unselectable","on");$05.className=$i.$9S("_event_inner");$05.innerHTML=e.client.innerHTML();if($0w.backColor){$05.style.background=$0w.backColor;if(DayPilot.browser.ie9||DayPilot.browser.ielt9){$05.style.filter='';}};if($0w.fontColor){$05.style.color=$0w.fontColor;};if($0w.borderColor){$05.style.borderColor=$0w.borderColor;};if($0w.backImage){$05.style.backgroundImage="url("+$0w.backImage+")";if($0w.backRepeat){$05.style.backgroundRepeat=$0w.backRepeat;}};$02.appendChild($05);var $7g=e.start().getTime()===e.part.start.getTime();var $7h=e.rawend().getTime()===e.part.end.getTime();if(!$7g){DayPilot.Util.addClass($02,this.$9S("_event_continueleft"));};if(!$7h){DayPilot.Util.addClass($02,this.$9S("_event_continueright"));};if(e.client.barVisible()&&$z>0){var $77=100*e.part.barLeft/($z);var $3T=Math.ceil(100*e.part.barWidth/($z));if(this.durationBarMode==="PercentComplete"){$77=0;$3T=$0w.complete||0;};var $3q=document.createElement("div");$3q.setAttribute("unselectable","on");$3q.className=this.$9S("_event_bar");$3q.style.position="absolute";if($0w.barBackColor){$3q.style.backgroundColor=$0w.barBackColor;};var $7a=document.createElement("div");$7a.setAttribute("unselectable","on");$7a.className=this.$9S("_event_bar_inner");$7a.style.left=$77+"%";if(0<$3T&&$3T<=1){$7a.style.width="1px";}else{$7a.style.width=$3T+"%";};if($0w.barColor){$7a.style.backgroundColor=$0w.barColor;};if($0w.barImageUrl){$7a.style.backgroundImage="url("+$0w.barImageUrl+")";};$3q.appendChild($7a);$02.appendChild($3q);}};$02.row=$6U;if($0w.areas){for(var i=0;i<$0w.areas.length;i++){var $J=$0w.areas[i];var v=$J.v||"Visible";if(v!=="Visible"){continue;};if($J.start||$J.end){$J.left=$i.getPixels(new DayPilot.Date($J.start)).left-e.part.left;$J.width=$i.getPixels(new DayPilot.Date($J.end)).left-$J.left-e.part.left;};var a=DayPilot.Areas.createArea($02,e,$J);$02.appendChild(a);}};this.elements.events.push($02);this.divEvents.appendChild($02);e.rendered=true;$02.event=e;if($i.multiselect.$aJ($02.event)){$i.multiselect.add($02.event,true);$i.multiselect.$aI($02);};if($i.$9G()){if(typeof $i.onAfterEventRender==='function'){var $l={};$l.e=$02.event;$l.div=$02;$i.onAfterEventRender($l);}}else{if($i.afterEventRender){$i.afterEventRender($02.event,$02);}};return true;};this.$9G=function(){return $i.api===2;};this.$aZ=function(){for(var i=0;i<this.elements.events.length;i++){var $02=this.elements.events[i];var event=$02.event;var $6U=event.part.dayIndex;var $I=this.rowlist[$6U];var $3S=$I.top;var top=$3S+event.part.top;$02.style.top=top+'px';DayPilot.list($02.related).filter(function($00){return !!$00.versionPart;}).each(function($7i){var $78=$7i.versionPart;$7i.style.top=($3S+$78.top)+'px';});DayPilot.list($02.related).filter(function($00){return !$00.versionPart&&($00.type==="divLeft"||$00.type==="divRight");}).each(function($7i){$7i.style.top=top+'px';});}};this.$bZ=function(e){if(!e){return null;};for(var i=0;i<$i.elements.events.length;i++){var $02=$i.elements.events[i];if($02.event===e||$02.event.data===e.data){return $02;}};return null;};this.$ed=function(ev){var $02=this;DayPilot.Areas.hideAreas($02,ev);if($i.cssOnly){DayPilot.Util.removeClass($02,$i.$9S("_event_hover"));};$i.$ef($02);if(!$20.source){$1c.hideLinkpointsWithDelay();};if($i.bubble&&$i.eventHoverHandling==='Bubble'){$i.bubble.hideOnMouseOut();}};this.$eg=function($02){if(typeof this.onEventMouseOver==="function"){var $l={};$l.div=$02;$l.e=$02.event;this.onEventMouseOver($l);}};this.$ef=function($02){if(typeof this.onEventMouseOut==="function"){var $l={};$l.div=$02;$l.e=$02.event;this.onEventMouseOut($l);}};this.$ec=function(ev){ev=ev||window.event;if($i.cellBubble){$i.cellBubble.delayedHide();};var $02=this;while($02&&!$02.event){$02=$02.parentNode;};$i.$eh($02,ev);var $7j=$02.event.cache?$02.event.cache.deleteDisabled:$02.event.data.deleteDisabled;if(!$02.active){var $4L=[];if($i.eventDeleteHandling!=="Disabled"&&!$7j){var top=$i.durationBarVisible?$i.durationBarHeight:0;$4L.push({"action":"JavaScript","v":"Hover","w":17,"h":17,"top":top+2,"right":2,"css":$i.$9S("_event_delete"),"js":function(e){$i.$ap(e);}});};var $Y=$02.event.cache?$02.event.cache.areas:$02.event.data.areas;if($Y&&$Y.length>0){$4L=$4L.concat($Y);};DayPilot.Areas.showAreas($02,$02.event,null,$4L);if($i.cssOnly){DayPilot.Util.addClass($02,$i.$9S("_event_hover"));};$i.$eg($02);};if($i.linkCreateHandling!=="Disabled"&&!$20.source){$1c.clearHideTimeout();$1c.hideLinkpoints();if(!DayPilotScheduler.moving&&!DayPilotScheduler.resizing){$1c.showLinkpoint($02);}};if(ev.srcElement){ev.srcElement.insideEvent=true;}else{ev.insideEvent=true;}};this.$ei={};var $0J=this.$ei;this.$ee=function(ev){$i.$cP();if(typeof DayPilot.Bubble!=='undefined'){DayPilot.Bubble.hideActive();};ev=ev||window.event;var $7k=DayPilot.Util.mouseButton(ev);if($7k.left){var $1w=ev.shiftKey;if($i.multiSelectRectangle!=="Disabled"&&$1w){$0O.start();return false;};if(this.style.cursor==='w-resize'||this.style.cursor==='e-resize'){DayPilotScheduler.resizing=this;DayPilotScheduler.originalMouse=DayPilot.mc(ev);document.body.style.cursor=this.style.cursor;$1c.hideLinkpoints();}else if((this.style.cursor==='move')||($i.moveBy==='Full'&&this.event.client.moveEnabled())){$0J.start=true;$0J.moving=this;$0J.originalMouse=DayPilot.mc(ev);$0J.moveOffsetX=DayPilot.mo3(this,ev).x;$0J.moveDragStart=$i.getDate($i.coords.x,true);$1c.hideLinkpoints();}};DayPilot.Menu&&DayPilot.Menu.active&&DayPilot.Menu.active.hide();ev.cancelBubble=true;return false;};this.$ej={};var $0I=$i.$ej;$0I.active=false;$0I.start=false;$0I.timeouts=[];$0I.onEventTouchStart=function(ev){if($0I.active||$0I.start){return;};ev.stopPropagation();$0I.clearTimeouts();$0I.start=true;$0I.active=false;var $02=this;var $7l=$i.tapAndHoldTimeout;$0I.timeouts.push(window.setTimeout(function(){$0I.active=true;$0I.start=false;$i.coords=$0I.relativeCoords(ev);ev.preventDefault();switch($i.eventTapAndHoldHandling){case "Move":var $1T=touchMousePos(ev);$0I.startMoving($02,$1T);break;case "ContextMenu":var e=$02.event;if(DayPilot.Menu){DayPilot.Menu.touchPosition(ev);};var $0N=e.client.contextMenu();if($0N){$0N.show(e);}else{if($i.contextMenu){$i.contextMenu.show(e);}};break;}},$7l));};$0I.onEventTouchMove=function(ev){$0I.clearTimeouts();$0I.start=false;};$0I.onEventTouchEnd=function(ev){if(DayPilot.Util.isMouseEvent(ev)){return;};$0I.clearTimeouts();if($0I.start){$0I.start=false;ev.preventDefault();ev.stopPropagation();var $02=this;window.setTimeout(function(){$i.$al($02,ev);});};window.setTimeout(function(){$0I.start=false;$0I.active=false;},500);};$0I.onMainTouchStart=function(ev){if($0I.active||$0I.start){return;};$0I.clearTimeouts();$0I.start=true;$0I.active=false;var $7l=$i.tapAndHoldTimeout;$0I.timeouts.push(window.setTimeout(function(){$0I.active=true;$0I.start=false;ev.preventDefault();$i.coords=$0I.relativeCoords(ev);$0I.range=$i.$ek();},$7l));var $7m=true;if($7m){$i.coords=$0I.relativeCoords(ev);}};$0I.onMainTouchMove=function(ev){$0I.clearTimeouts();$0I.start=false;if(DayPilotScheduler.resizing){ev.preventDefault();$0I.updateResizing();return;};if($0I.active){ev.preventDefault();$i.coords=$0I.relativeCoords(ev);if(DayPilotScheduler.moving){$0I.updateMoving();return;};if($0I.range){var $1l=$0I.range;$1l.end={x:Math.floor($i.coords.x/$i.cellWidth)};$i.$bc($1l);}}};$0I.onMainTouchEnd=function(ev){$0I.clearTimeouts();var $7m=true;if($0I.active){if(DayPilotScheduler.moving){ev.preventDefault();var e=DayPilotScheduler.moving.event;var $0m=DayPilotScheduler.movingShadow.start;var $0V=DayPilotScheduler.movingShadow.end;var $10=($i.viewType!=='Days')?DayPilotScheduler.movingShadow.row.id:null;var external=DayPilotScheduler.drag?true:false;var $4u=DayPilotScheduler.movingShadow.overlapping;var $7n=!DayPilotScheduler.movingShadow.allowed;DayPilot.Util.removeClass(DayPilotScheduler.moving,$i.$9S("_event_moving_source"));DayPilot.de(DayPilotScheduler.movingShadow);$i.$cF();DayPilotScheduler.movingShadow.calendar=null;document.body.style.cursor='';DayPilotScheduler.moving=null;DayPilotScheduler.movingShadow=null;$i.$cy.clear();if($4u||$7n||$i.$cy.forbidden||$i.$cy.invalid){return;};$i.$b3(e,$0m,$0V,$10,external);};if($0I.range){var $1l=$0I.range;$0I.range=null;var $1U=$i.elements.range2;if($1U&&$1U.overlapping){$i.clearSelection();}else{$i.$b8($1l);}}}else if($0I.start&&$7m){var $1l=$i.$ek();$i.$bc($1l);var $1U=$i.elements.range2;if($1U&&$1U.overlapping){$i.clearSelection();}else{$i.$b8($1l);}};window.setTimeout(function(){$0I.start=false;$0I.active=false;},500);};$0I.clearTimeouts=function(){for(var i=0;i<$0I.timeouts.length;i++){clearTimeout($0I.timeouts[i]);};$0I.timeouts=[];};$0I.relativeCoords=function(ev){var $7o=$i.$9H;var x=ev.touches[0].pageX;var y=ev.touches[0].pageY;var $7p=DayPilot.abs($7o);var $1T={x:x-$7p.x,y:y-$7p.y,toString:function(){return "x: "+this.x+", y:"+this.y;}};return $1T;};$0I.startMoving=function($02,$1T){DayPilotScheduler.moving=$02;DayPilotScheduler.originalMouse=$1T;var $7q=DayPilot.abs($02);DayPilotScheduler.moveOffsetX=$1T.x-$7q.x;DayPilotScheduler.moveDragStart=$i.getDate($i.coords.x,true);DayPilotScheduler.movingShadow=$i.$bT($02,$i.shadow);$i.$co();};$0I.startResizing=function($02,$3b){DayPilotScheduler.resizing=$02;DayPilotScheduler.resizing.dpBorder=$3b;if(!DayPilotScheduler.resizingShadow){DayPilotScheduler.resizingShadow=$i.$bT($02,$i.shadow);};$i.$cz();};$0I.updateResizing=function(){if(!DayPilotScheduler.resizingShadow){var mv=DayPilotScheduler.resizing;DayPilotScheduler.resizingShadow=$i.$bT(mv,$i.shadow);};$i.$cz();};$0I.updateMoving=function(){if(DayPilotScheduler.movingShadow&&DayPilotScheduler.movingShadow.calendar!==$i){DayPilotScheduler.movingShadow.calendar=null;DayPilot.de(DayPilotScheduler.movingShadow);DayPilotScheduler.movingShadow=null;};if(!DayPilotScheduler.movingShadow){var mv=DayPilotScheduler.moving;DayPilotScheduler.movingShadow=$i.$bT(mv,$i.shadow);};DayPilotScheduler.moving.target=$i;$i.$co();};this.$eh=function($02,ev){var $7r=this.eventResizeMargin;var $7s=this.eventMoveMargin;var $1R=$02;if(typeof(DayPilotScheduler)==='undefined'){return;};var $0B=DayPilot.mo3($02,ev);if(!$0B){return;};$i.eventOffset=$0B;if(DayPilotScheduler.resizing){return;};if(DayPilotScheduler.moving){return;};var $7t=$1R.event.part.start.toString()===$1R.event.start().toString();var $7u=$1R.event.part.end.toString()===$1R.event.rawend().toString();if($i.moveBy==='Top'&&$0B.y<=$7s&&$1R.event.client.moveEnabled()&&$i.eventMoveHandling!=='Disabled'){$02.style.cursor='move';}else if(($i.moveBy==='Top'||$i.moveBy==='Full')&&$0B.x<=$7r&&$1R.event.client.resizeEnabled()&&$i.eventResizeHandling!=='Disabled'){if($7t){$02.style.cursor="w-resize";$02.dpBorder='left';}else{$02.style.cursor='not-allowed';}}else if($i.moveBy==='Left'&&$0B.x<=$7s&&$1R.event.client.moveEnabled()&&$i.eventMoveHandling!=='Disabled'){$02.style.cursor="move";}else if($02.offsetWidth-$0B.x<=$7r&&$1R.event.client.resizeEnabled()&&$i.eventResizeHandling!=='Disabled'){if($7u){$02.style.cursor="e-resize";$02.dpBorder='right';}else{$02.style.cursor='not-allowed';}}else if(!DayPilotScheduler.resizing&&!DayPilotScheduler.moving){if($1R.event.client.clickEnabled()&&$i.eventClickHandling!=='Disabled'){$02.style.cursor='pointer';}else{$02.style.cursor='default';}};if(typeof(DayPilotBubble)!=='undefined'&&$i.bubble&&$i.eventHoverHandling==='Bubble'){if($02.style.cursor==='default'||$02.style.cursor==='pointer'){var $7v=this.$el&&$0B.x===this.$el.x&&$0B.y===this.$el.y;if(!$7v){this.$el=$0B;$i.bubble.showEvent($02.event);}}else{}}};this.$9T=function(){if(this.viewType!=='Days'){return this.itline.length;}else{return Math.floor(24*60/this.cellDuration);}};this.$b9=function($1l){var $1l=$1l||DayPilotScheduler.range||DayPilotScheduler.rangeHold;if(!$1l){return null;};var $I=$i.rowlist[$1l.start.y];if(!$I){return null;};var r=$1l.$em?$1l.$em:$1l;var $1k=$I.id;var $S=r.end.x>r.start.x?r.start.x:r.end.x;var $T=(r.end.x>r.start.x?r.end.x:r.start.x);var $1p=0;$1p=$I.start.getTime()-this.$a6().getTime();var $K=this.itline[$S].start.addTime($1p);var end=this.itline[$T].end.addTime($1p);return new DayPilot.Selection($K,end,$1k,$i);};this.$en=function($1R){var $7w=$1R.parentNode;var $7x=document.createElement('textarea');$7x.style.position='absolute';$7x.style.width=(($1R.offsetWidth<100)?100:($1R.offsetWidth-2))+'px';$7x.style.height=($1R.offsetHeight-2)+'px';$7x.style.fontFamily=DayPilot.gs($1R,'fontFamily')||DayPilot.gs($1R,'font-family');$7x.style.fontSize=DayPilot.gs($1R,'fontSize')||DayPilot.gs($1R,'font-size');$7x.style.left=$1R.offsetLeft+'px';$7x.style.top=$1R.offsetTop+'px';$7x.style.border='1px solid black';$7x.style.padding='0px';$7x.style.marginTop='0px';$7x.style.backgroundColor='white';$7x.value=DayPilot.tr($1R.event.text());$7x.event=$1R.event;$7w.appendChild($7x);return $7x;};this.$an=function($1R){if(DayPilotScheduler.editing){DayPilotScheduler.editing.blur();};if(!$1R.event){return;};var $7x=this.$en($1R);DayPilotScheduler.editing=$7x;DayPilot.re($7x,DayPilot.touch.start,function(ev){ev.stopPropagation();});$7x.onblur=function(){$7x.onblur=null;DayPilotScheduler.editing=null;if($7x.parentNode){$7x.parentNode.removeChild($7x);};if(!$1R.event){return;};var $7y=$1R.event.text();var $1q=$7x.value;$i.$bu($1R.event,$1q,$7x.canceling);};$7x.onmousedown=function(e){e=e||window.event;e.stopPropagation&&e.stopPropagation();};$7x.onkeypress=function(e){var $5D=(window.event)?event.keyCode:e.keyCode;if($5D===13){this.onblur();return false;};return true;};$7x.cancel=function(){if(DayPilotScheduler.editing){DayPilotScheduler.editing.canceling=true;DayPilotScheduler.editing.blur();}};$7x.onkeydown=function(e){var $5D=(window.event)?event.keyCode:e.keyCode;if($5D===27){DayPilotScheduler.editing.cancel();}};$7x.select();$7x.focus();};this.$cV=function(ev){var td=this;var $I=td.row;if(typeof(DayPilotBubble)!=='undefined'){if($i.cellBubble){$i.cellBubble.hideOnMouseOut();};if($i.resourceBubble){var $1G={};$1G.calendar=$i;$1G.id=$I.id;if($I.bubbleHtml){$1G.bubbleHtml=function(){return $I.bubbleHtml;}};$1G.toJSON=function(){var $1D={};$1D.id=this.id;return $1D;};$i.resourceBubble.showResource($1G);}}};this.$cW=function(ev){var td=this;if(typeof(DayPilotBubble)!=='undefined'&&$i.resourceBubble){$i.resourceBubble.hideOnMouseOut();};var $02=td.firstChild;DayPilot.Areas.hideAreas($02,ev);$02.data=null;};this.$cX=function(ev){if($4M.row){$1r.cancelClick=true;setTimeout(function(){$1r.cancelClick=false;},100);}};this.$9m=function(){if(!this.timeHeader){return;};this.$97.timeHeader={};var $6B=document.createElement("div");$6B.style.position="relative";this.nav.timeHeader=$6B;for(var y=0;y<this.timeHeader.length;y++){var $I=this.timeHeader[y];for(var x=0;x<$I.length;x++){this.$eo(x,y);}};var $7z=this.divNorth;DayPilot.puc($7z);$7z.innerHTML='';$7z.appendChild($6B);var $6H=this.$cA();$7z.style.width=(this.$cA()+5000)+"px";var $7A=this.divCorner;if(!this.cssOnly){$7A.style.backgroundColor=this.cornerBackColor;};if(this.cornerHtml){$7A.innerHTML=this.cornerHtml;}else{$7A.innerHTML='';};var $6H=this.$cA();if($6H>0){this.divStretch.style.width=(this.$cA())+"px";}};this.$ac=function(h,$7B){var $08=null;var $5N=this.$bS.locale();var $7B=$7B||this.cellGroupBy;var $21=h.start;var to=h.end;switch($7B){case 'Hour':$08=($i.$bS.timeFormat()==='Clock12Hours')?$21.toString("h tt",$5N):$21.toString("H",$5N);break;case 'Day':$08=$21.toString($5N.datePattern);break;case 'Week':$08=$0a.weekStarts()===1?$21.weekNumberISO():$21.weekNumber();break;case 'Month':$08=$21.toString("MMMM yyyy",$5N);break;case 'Year':$08=$21.toString("yyyy");break;case 'None':$08='';break;case 'Cell':if(this.scale==='Manual'||this.scale==='CellDuration'){var $0H=(h.end.ticks-h.start.ticks)/60000;$08=this.$ep($21,$0H);}else{$08=this.$ac(h,this.scale);};break;default:throw 'Invalid cellGroupBy value';};return $08;};this.$ep=function($K,$0H){var $5N=this.$bS.locale();var $0H=$0H||this.cellDuration;if($0H<60){return $K.toString("mm");}else if($0H<1440){return $i.$bS.timeFormat()==='Clock12Hours'?$K.toString("h tt",$5N):$K.toString("H",$5N);}else if($0H<10080){return $K.toString("d");}else if($0H===10080){return $0a.weekStarts()===1?$K.weekNumberISO():$K.weekNumber();}else{return $K.toString("MMMM yyyy",$5N);}};this.$a8=function($21){var $7C=this.scale;switch($7C){case "Cell":throw "Invalid scale: Cell";case "Manual":throw "Internal error (addScaleSize in Manual mode)";case "Minute":return $21.addMinutes(1);case "CellDuration":return $21.addMinutes(this.cellDuration);default:return this.$ab($21,$7C);}};this.$ab=function($21,$7B){var to;var $7D=this.viewType!=='Days'?this.days:1;var $0r=this.startDate.addDays($7D);if($i.scale==="Manual"){$0r=$i.$aa();};var $7B=$7B||this.cellGroupBy;var $7E=60;switch($7B){case 'Hour':to=$21.addHours(1);break;case 'Day':to=$21.getDatePart().addDays(1);break;case 'Week':to=$21.getDatePart().addDays(1);while(to.dayOfWeek()!==$0a.weekStarts()){to=to.addDays(1);};break;case 'Month':to=$21.addMonths(1);to=to.firstDayOfMonth();var $7F=(DayPilot.DateUtil.diff(to,$21)/(1000.0*60))%$7E===0;while(!$7F){to=to.addHours(1);$7F=(DayPilot.DateUtil.diff(to,$21)/(1000.0*60))%$7E===0;};break;case 'Year':to=$21.addYears(1);to=to.firstDayOfYear();var $7F=(DayPilot.DateUtil.diff(to,$21)/(1000.0*60))%$7E===0;while(!$7F){to=to.addHours(1);$7F=(DayPilot.DateUtil.diff(to,$21)/(1000.0*60))%$7E===0;};break;case 'None':to=$0r;break;case 'Cell':var $P=this.$ag($21);if($P.current){to=$P.current.end;}else{if($P.past){to=$P.previous.end;}else{to=$P.next.start;}};break;default:throw 'Invalid cellGroupBy value';};if(to.getTime()>$0r.getTime()){to=$0r;};return to;};this.$eo=function(x,y){var $6B=this.nav.timeHeader;var p=this.timeHeader[y][x];var $7G=y<this.timeHeader.length-1;var top=y*$0a.headerHeight();var $N=p.left;var $z=p.width;var $R=$0a.headerHeight();var $P=document.createElement("div");$P.style.position="absolute";$P.style.top=top+"px";$P.style.left=$N+"px";$P.style.width=$z+"px";$P.style.height=$R+"px";if(p.toolTip){$P.title=p.toolTip;};$P.setAttribute("unselectable","on");$P.style.KhtmlUserSelect='none';$P.style.MozUserSelect='none';$P.style.webkitUserSelect='none';$P.oncontextmenu=function(){return false;};$P.cell={};$P.cell.start=p.start;$P.cell.end=p.end;$P.cell.level=y;$P.cell.th=p;$P.onclick=this.$d2;$P.style.overflow='hidden';if(!$i.timeHeaderTextWrappingEnabled){$P.style.whiteSpace="nowrap";};var $05=document.createElement("div");$05.setAttribute("unselectable","on");$05.innerHTML=p.innerHTML;if(p.backColor){$05.style.background=p.backColor;};if(this.cssOnly){var cl=this.$9S("_timeheadercol");var $7H=this.$9S("_timeheadercol_inner");if($7G){cl=this.$9S("_timeheadergroup");$7H=this.$9S("_timeheadergroup_inner");};DayPilot.Util.addClass($P,cl);DayPilot.Util.addClass($05,$7H);};$P.appendChild($05);DayPilot.list(p.areas).each(function($J){if($J.start||$J.end){$J.left=$i.getPixels(new DayPilot.Date($J.start)).left-$N;$J.width=$i.getPixels(new DayPilot.Date($J.end)).left-$J.left-$N;}});DayPilot.Areas.attach($P,p,{"areas":p.areas});this.$97.timeHeader[x+"_"+y]=$P;$6B.appendChild($P);};this.$aE=function(){for(var i=0;i<this.rowlist.length;i++){var $I=this.rowlist[i];var $6X=$I.getHeight()+$I.marginBottom+$I.marginTop;if($I.height!==$6X){this.$aW=true;};$I.height=$6X;}};this.$9q=function(){var $6B=this.divHeader;if(!$6B){return false;};var $2p=this.rowlist.length;var $1O=this.rowHeaderCols?this.rowHeaderCols.length:1;var j=0;for(var i=0;i<$2p;i++){var $I=this.rowlist[i];if($I.hidden){continue;};var $1t=this.$cO?i:j;if(!$6B.rows[$1t]){continue;};for(var c=0;c<$6B.rows[$1t].cells.length;c++){var $7I=$6B.rows[$1t].cells[c];if(this.$cO){$7I.style.top=$I.top+"px";};var $7J=$I.height;if($7I&&$7I.firstChild&&parseInt($7I.firstChild.style.height,10)!==$7J){$7I.firstChild.style.height=$7J+"px";}};j++;};if(this.$cO){if($i.nav.resScrollSpace){$i.nav.resScrollSpace.style.top=$i.$96+"px";}}};this.$e1=function($1t){var s=this.separators[$1t];s.location=s.location||s.Location;s.color=s.color||s.Color;s.layer=s.layer||s.Layer;s.width=s.width||s.Width;s.opacity=s.opacity||s.Opacity;var $0G=new DayPilot.Date(s.location);var $28=s.color;var $z=s.width?s.width:1;var $2b=s.layer?s.layer==='AboveEvents':false;var $7K=s.opacity?s.opacity:100;if($0G.getTime()<this.$a6().getTime()){return;};if($0G.getTime()>=this.$aa().getTime()){return;};var $x=this.getPixels($0G);if($x.cut){return;};if($x.left<0){return;};if($x.left>this.$9T()*this.cellWidth){return;};var $0u=document.createElement("div");$0u.style.width=$z+'px';$0u.style.height=$i.$96+'px';$0u.style.position='absolute';$0u.style.left=($x.left-1)+'px';$0u.style.top='0px';$0u.style.backgroundColor=$28;$0u.style.opacity=$7K/100;$0u.style.filter="alpha(opacity="+$7K+")";if($2b){this.divSeparatorsAbove.appendChild($0u);}else{this.divSeparators.appendChild($0u);};this.elements.separators.push($0u);};this.$dU=function(ev){if($i.timeRangeDoubleClickHandling==='Disabled'){return false;};if(DayPilotScheduler.timeRangeTimeout){clearTimeout(DayPilotScheduler.timeRangeTimeout);DayPilotScheduler.timeRangeTimeout=null;};var $1l={};if(!$i.coords){var $7o=$i.$9H;$i.coords=DayPilot.mo3($7o,ev);};ev=ev||window.event;ev.stopPropagation&&ev.stopPropagation();ev.cancelBubble=true;if($i.$eq($i.coords)){var $1m=$i.$b9(DayPilotScheduler.rangeHold);$i.$be($1m.start,$1m.end,$1m.resource);}else{DayPilotScheduler.range=$i.$ek();if(DayPilotScheduler.range){DayPilotScheduler.rangeCalendar=$i;var $1m=$i.$b9(DayPilotScheduler.range);$i.$be($1m.start,$1m.end,$1m.resource);}};DayPilotScheduler.rangeHold=DayPilotScheduler.range;DayPilotScheduler.range=null;};this.$dQ=function(ev){if($0I.start||$0I.active){return;};if(DayPilotScheduler.timeRangeTimeout&&false){clearTimeout(DayPilotScheduler.timeRangeTimeout);DayPilotScheduler.timeRangeTimeout=null;};$i.$dG();$i.$dO();if(!$i.coords){var $7o=$i.$9H;$i.coords=DayPilot.mo3($7o,ev);};if(DayPilotScheduler.rectangleSelect){return false;};ev=ev||window.event;var $7k=DayPilot.Util.mouseButton(ev);if($7k.middle||($7k.right&&$i.$eq($i.coords))){return false;};if($i.timeRangeSelectedHandling==='Disabled'){return false;};var $17=ev.ctrlKey||ev.metaKey;if($i.allowMultiRange&&!$17){mr.clear();};var $1w=ev.shiftKey;if($i.multiSelectRectangle!=="Disabled"&&$1w){var $3N={};$3N.start=$i.coords;$3N.calendar=$i;DayPilotScheduler.rectangleSelect=$3N;return false;};var i=$i.$bK($i.coords.y).i;var $I=$i.rowlist[i];if($I.isNewRow){return false;};DayPilotScheduler.range=$i.$ek();if(DayPilotScheduler.range){DayPilotScheduler.range.ctrl=$17;DayPilotScheduler.rangeCalendar=$i;};return false;};this.$ek=function(){var $1l={};var cx=this.$ae($i.coords.x).x;$1l.start={y:$i.$bK($i.coords.y).i,x:cx};$1l.end={x:cx};if(this.$bU($i.$bK($i.coords.y).i)){return null;};$1l.calendar=$i;$i.$bc($1l);return $1l;};this.$cB=function(){$i.$cp();var $1U=DayPilotScheduler.resizingShadow;var ev=DayPilotScheduler.resizing;(function(){var $0C=$i.$er;if($0C&&$0C.start.getTime()===$1U.start.getTime()&&$0C.end.getTime()===$i.$ax($1U.end).getTime()){return;};var $l={};$l.start=$1U.start;$l.end=$i.$ax($1U.end);$l.duration=new DayPilot.Duration($l.start,$l.end);$l.e=ev.event;$l.allowed=true;$l.left={};$l.left.html=$l.start.toString($i.eventResizingStartEndFormat);$l.left.enabled=$i.eventResizingStartEndEnabled;$l.right={};$l.right.html=$l.end.toString($i.eventResizingStartEndFormat);$l.right.enabled=$i.eventResizingStartEndEnabled;$l.multiresize=DayPilot.list($0Y.list);var $0Z={};$0Z.event=ev;$0Z.start=$l.start;$0Z.end=$l.end;$l.multiresize.splice(0,0,$0Z);$i.$er=$l;if(typeof $i.onEventResizing==='function'){$i.onEventResizing($l);};$1U.allowed=$l.allowed;$i.$cD(DayPilotScheduler.resizingShadow,$l);$i.$cE(DayPilotScheduler.resizingShadow,$l);})();};this.$dS=function(ev){if(DayPilotScheduler.rectangleSelect){var ev=ev||window.event;ev.cancelBubble=true;ev.preventDefault&&ev.preventDefault();DayPilotScheduler.gMouseUp(ev);return false;};$0J={};};this.$dR=function(ev){if($0I.active){return;};DayPilotScheduler.activeCalendar=$i;ev=ev||window.event;var $7L=DayPilot.mc(ev);$i.coords=DayPilot.mo3($i.$9H,ev);ev.insideMainD=true;if(window.event){window.event.srcElement.inside=true;};if($0J.start){if($0J.originalMouse.x!==$7L.x||$0J.originalMouse.y!==$7L.y){DayPilot.Util.copyProps($0J,DayPilotScheduler);document.body.style.cursor='move';$0J={};}};if(DayPilotScheduler.resizing&&DayPilotScheduler.resizing.event.calendar===$i){$i.$es();}else if(DayPilotScheduler.moving&&(DayPilotScheduler.moving.event.calendar===$i||DayPilotScheduler.moving.event.calendar.dragOutAllowed)){$i.$et();}else if(DayPilotScheduler.range&&DayPilotScheduler.range.calendar===$i){$i.$eu();}else if($20.source){var $0i=$20.source;$1c.drawShadow($0i.coords,$i.coords);}else if(DayPilotScheduler.rectangleSelect){$0O.draw();}else if($i.crosshairType!=='Disabled'){$i.$ev();};$i.$ew();var $7M=ev.insideEvent;if(window.event){$7M=window.event.srcElement.insideEvent;};if($i.cellBubble&&$i.coords&&$i.rowlist&&$i.rowlist.length>0&&!$7M){var x=$i.$ae($i.coords.x);var y=$i.$bK($i.coords.y).i;if(0<=y&&y<$i.rowlist.length&&0<=x&&x<$i.itline.length){var $P={};$P.calendar=$i;$P.start=$i.itline[x].start;$P.end=$i.itline[x].end;$P.resource=$i.rowlist[y].id;$P.toJSON=function(){var $1D={};$1D.start=this.start;$1D.end=this.end;$1D.resource=this.resource;return $1D;};$i.cellBubble.showCell($P);}};if(DayPilotScheduler.drag){$i.$dG();if(DayPilotScheduler.gShadow){document.body.removeChild(DayPilotScheduler.gShadow);};DayPilotScheduler.gShadow=null;if(!DayPilotScheduler.movingShadow&&$i.coords&&$i.rowlist.length>0){if(!DayPilotScheduler.moving){DayPilotScheduler.moving={};var event=DayPilotScheduler.drag.event;if(!event){var $7N=$i.itline[0].start;var ev={'id':DayPilotScheduler.drag.id,'start':$7N,'end':$7N.addSeconds(DayPilotScheduler.drag.duration),'text':DayPilotScheduler.drag.text};var $q=DayPilotScheduler.drag.data;if($q){var $6M=['duration','element','id','text'];for(var name in $q){if(DayPilot.contains($6M,name)){continue;};ev[name]=$q[name];}};event=new DayPilot.Event(ev);event.calendar=$i;event.part.external=true;};DayPilotScheduler.moving.event=event;};DayPilotScheduler.movingShadow=$i.$bT(DayPilotScheduler.moving,DayPilotScheduler.drag.shadowType);};ev.cancelBubble=true;};if($i.autoScroll==="Always"||($i.autoScroll==="Drag"&&(DayPilotScheduler.moving||DayPilotScheduler.resizing||DayPilotScheduler.range))){var $7O=$i.nav.scroll;var $1T={x:$i.coords.x,y:$i.coords.y};$1T.x-=$7O.scrollLeft;$1T.x+=$L.shiftX;$1T.y-=$7O.scrollTop;var $z=$7O.clientWidth;var $R=$7O.clientHeight;var $3b=30;var $N=$1T.x<$3b?$1T.x:0;var $O=$z-$1T.x<$3b?$z-$1T.x:0;var top=$1T.y<$3b?$1T.y:0;var $W=$R-$1T.y<$3b?$R-$1T.y:0;var x=0;var y=0;var $7P=50;if($N){x=-$7P*invertedPct($N,$3b);};if($O){x=$7P*invertedPct($O,$3b);};if(top){y=-$7P*invertedPct(top,$3b)/2;};if($W){y=$7P*invertedPct(top,$3b)/2;};if(DayPilotScheduler.resizing||DayPilotScheduler.range){y=0;};if(x||y){$i.$ex(x,y);}else{$i.$dO();}}};function invertedPct($5V,$y){return 1-$5V/$y;};this.$eu=function(){var $1l=DayPilotScheduler.range;$1l.end={x:$i.$ae($i.coords.x).x};$i.$bc($1l);};this.$es=function(){if(!DayPilotScheduler.resizingShadow){DayPilotScheduler.resizingShadow=$i.$bT(DayPilotScheduler.resizing,$i.shadow);};$i.$cz();};this.$et=function(){if(DayPilotScheduler.movingShadow&&DayPilotScheduler.movingShadow.calendar!==$i){DayPilotScheduler.movingShadow.calendar=null;DayPilot.de(DayPilotScheduler.movingShadow);DayPilotScheduler.movingShadow=null;};if(!DayPilotScheduler.movingShadow){var mv=DayPilotScheduler.moving;DayPilotScheduler.movingShadow=$i.$bT(mv,$i.shadow);};$i.$cm();DayPilotScheduler.moving.target=$i;$i.$co();};this.$ey={};var $0O=this.$ey;$0O.start=function(){var $3N={};$3N.start=$i.coords;$3N.calendar=$i;DayPilotScheduler.rectangleSelect=$3N;};$0O.draw=function(){var $3N=DayPilotScheduler.rectangleSelect;var $K=DayPilotScheduler.rectangleSelect.start;var end=$i.coords;$0O.clear();var $0l={"x":$3N.x,"y":$3N.y,"width":$3N.width,"height":$3N.height};var $N,top,$z,$R;var $S,$U,$T,$V;(function rectifyStartEnd(){$S=Math.min($K.x,end.x);$T=Math.max($K.x,end.x);if($i.multiSelectRectangle==="Free"){$U=Math.min($K.y,end.y);$V=Math.max($K.y,end.y);}else if($i.multiSelectRectangle==="Row"){$U=$K.y;$V=$K.y;}})();if($i.multiSelectRectangle==="Free"){$N=$S;top=$U;$z=$T-$S;$R=$V-$U;}else if($i.multiSelectRectangle==="Row"){var y=$i.$bK($U).i;var $I=$i.rowlist[y];top=$I.top;$R=$I.height;var $3o=$i.$ae($S).cell;$N=$3o.left;var $3p=$i.$ae($T).cell;$z=$3p.left+$3p.width-$N;}else{throw "Invalid DayPilot.Scheduler.multiSelectRectangle value: "+$i.multiSelectRectangle;};var $02=DayPilot.Util.div($i.divRectangle,$N,top,$z,$R);$02.style.boxSizing="border-box";$02.style.backgroundColor="#0000ff";$02.style.border="1px solid #000033";$02.style.opacity=0.4;$3N.x=$N;$3N.y=top;$3N.width=$z;$3N.height=$R;if($3N.x!==$0l.x||$3N.y!==$0l.y||$3N.width!==$0l.width||$3N.height!==$0l.height){if(typeof $i.onRectangleEventSelecting==="function"){var $l={};$l.events=$Q.eventsInRectangle($3N.x,$3N.y,$3N.width,$3N.height).map(function($00){return $00.event;});$l.start=$i.getDate($3N.x,true);$l.end=$i.getDate($3N.x+$3N.width,true);$i.onRectangleEventSelecting($l);}}};$0O.clear=function(){$i.divRectangle.innerHTML='';$i.elements.rectangle=[];};this.$ez=function(){var x,y;if($i.coords&&$i.rowlist&&$i.rowlist.length>0&&$i.itline&&$i.itline.length>0){x=$i.$ae($i.coords.x).x;y=$i.$bK($i.coords.y).i;if(y>=$i.rowlist.length){return;}}else{return null;};var $M=$i.cells.findXy(x,y);return $M[0];};this.$ew=function(){var $P=this.$ez();if(this.hover.cell){if(this.hover.cell.x===$P.x&&this.hover.cell.y===$P.y){return;};this.$dP();};this.hover.cell=$P;if(typeof this.onCellMouseOver==='function'){var $l={};$l.cell=$P;this.onCellMouseOver($l);}};this.$dP=function(){if(!this.hover.cell){return;};if(typeof this.onCellMouseOut==='function'){var $l={};$l.cell=this.hover.cell;this.onCellMouseOut($l);};this.hover.cell=null;};this.hover={};this.$ev=function(){var $P=this.$ez();if(this.hover.cell){if(this.hover.cell.x===$P.x&&this.hover.cell.y===$P.y){return;}};this.$eA();};this.$dG=function(){this.divCrosshair.innerHTML='';this.$eB=null;this.$eC=null;if(this.crosshairTop&&this.crosshairTop.parentNode){this.crosshairTop.parentNode.removeChild(this.crosshairTop);this.crosshairTop=null;};if(this.crosshairLeft){for(var i=0;i<this.crosshairLeft.length;i++){var ch=this.crosshairLeft[i];if(ch.parentNode){ch.parentNode.removeChild(ch);}};this.crosshairLeft=null;};this.$94=-1;this.$93=-1;};this.$eA=function(){var x,y;if($i.coords&&$i.rowlist&&$i.rowlist.length>0){x=$i.$ae($i.coords.x).x;y=$i.$bK($i.coords.y).i;if(y>=$i.rowlist.length){return;}}else{return;};var $X=this.crosshairType;var $I=$i.rowlist[y];if($X==='Full'){var $0F=this.itline[x];var $N=$0F.left;var $0u=this.$eB;if(!$0u){var $0u=document.createElement("div");$0u.style.height=$i.$96+'px';$0u.style.position='absolute';$0u.style.top='0px';$0u.style.backgroundColor=this.crosshairColor;$0u.style.opacity=this.crosshairOpacity/100;$0u.style.filter="alpha(opacity="+this.crosshairOpacity+")";this.$eB=$0u;this.divCrosshair.appendChild($0u);};$0u.style.left=$N+'px';$0u.style.width=$0F.width+'px';var top=$I.top;var $R=$I.height;var $z=this.$cA();var $0u=this.$eC;if(!$0u){var $0u=document.createElement("div");$0u.style.width=$z+'px';$0u.style.height=$R+'px';$0u.style.position='absolute';$0u.style.top=top+'px';$0u.style.left='0px';$0u.style.backgroundColor=this.crosshairColor;$0u.style.opacity=this.crosshairOpacity/100;$0u.style.filter="alpha(opacity="+this.crosshairOpacity+")";this.$eC=$0u;this.divCrosshair.appendChild($0u);};$0u.style.top=top+'px';$0u.style.height=$R+'px';};var $7Q=this.$eD(this.coords.x);if($7Q&&this.$94!==$7Q.x){if(this.crosshairTop&&this.crosshairTop.parentNode){this.crosshairTop.parentNode.removeChild(this.crosshairTop);this.crosshairTop=null;};var $0u=document.createElement("div");$0u.style.width=$7Q.cell.width+"px";$0u.style.height=$0a.headerHeight()+"px";$0u.style.left='0px';$0u.style.top='0px';$0u.style.position='absolute';$0u.style.backgroundColor=this.crosshairColor;$0u.style.opacity=this.crosshairOpacity/100;$0u.style.filter="alpha(opacity="+this.crosshairOpacity+")";this.crosshairTop=$0u;var $7z=this.divNorth;var $7R=this.timeHeader?this.timeHeader.length-1:1;if(this.nav.timeHeader){this.$97.timeHeader[$7Q.x+"_"+$7R].appendChild($0u);}else{if($7z.firstChild.rows[$7R].cells[x]){$7z.firstChild.rows[$7R].cells[x].firstChild.appendChild($0u);}}};if(this.$93!==y){if(this.crosshairLeft){for(var i=0;i<this.crosshairLeft.length;i++){var ch=this.crosshairLeft[i];if(ch.parentNode){ch.parentNode.removeChild(ch);}};this.crosshairLeft=null;};var $1O=this.rowHeaderCols?this.rowHeaderCols.length:1;this.crosshairLeft=[];if(this.divHeader.rows[y]){for(var i=0;i<this.divHeader.rows[y].cells.length;i++){var $z=$i.$9V();var $0u=document.createElement("div");$0u.style.width=$z+"px";$0u.style.height=$I.height+"px";$0u.style.left='0px';$0u.style.top='0px';$0u.style.position='absolute';$0u.style.backgroundColor=this.crosshairColor;$0u.style.opacity=this.crosshairOpacity/100;$0u.style.filter="alpha(opacity="+this.crosshairOpacity+")";this.crosshairLeft.push($0u);this.divHeader.rows[y].cells[i].firstChild.appendChild($0u);}}};if($7Q){this.$94=$7Q.x;};this.$93=y;};this.$cu=function(y,$x){var $I=$i.timeHeader[y];if(!$I){return null;};for(var i=0;i<$I.length;i++){var $P=$I[i];if($x>=$P.left&&$x<$P.left+$P.width){var $j={};$j.cell=$P;$j.x=i;return $j;}};return null;};this.$eD=function($x){return $i.$cu($i.timeHeader.length-1,$x);};this.$dT=function(ev){ev=ev||window.event;if($i.timeRangeSelectedHandling==='Disabled'){return false;};if(!$i.$eq($i.coords)){$i.$eE(ev);};if($i.contextMenuSelection){var $7S=null;if($i.$eq($i.coords)){$7S=$i.$b9(DayPilotScheduler.rangeHold);}else{$7S=$i.$b9();};$7S.end=$i.$ax($7S.end);$i.contextMenuSelection.show($7S);};ev.cancelBubble=true;if(!$i.allowDefaultContextMenu){return false;}};this.$eq=function($1T){var $1l=DayPilotScheduler.rangeHold;if(!$1l||!$1l.start||!$1l.end){return false;};var $I=this.$c0($1l.start.y);var $7T=$1l.start.x<$1l.end.x;var $7U=($7T?$1l.start.x:$1l.end.x)*this.cellWidth;var $7V=($7T?$1l.end.x:$1l.start.x)*this.cellWidth+this.cellWidth;var $7W=$I.top;var $7X=$I.bottom;if($1T.x>=$7U&&$1T.x<=$7V&&$1T.y>=$7W&&$1T.y<=$7X){return true;};return false;};this.$bc=function($1l,$7Y){var $1l=$1l||DayPilotScheduler.range;if(!$1l){return;};function draw($1l){var $S=$1l.end.x>$1l.start.x?$1l.start.x:$1l.end.x;var $T=($1l.end.x>$1l.start.x?$1l.end.x:$1l.start.x);var y=$1l.start.y;var $I=$i.rowlist[y];var $K=$i.itline[$S];var end=$i.itline[$T];var $N=$K.left;var $O=end.left+end.width;var $z=$O-$N;var $P=$i.elements.range2;if(!$P){$P=document.createElement("div");$P.style.position='absolute';$P.setAttribute("unselectable","on");$P.className=$i.$9S("_shadow");var $05=document.createElement("div");$05.className=$i.$9S("_shadow_inner");$P.appendChild($05);$i.divRange.appendChild($P);};$P.style.left=($K.left)+"px";$P.style.top=$i.rowlist[y].top+"px";$P.style.width=$z+"px";$P.style.height=($i.rowlist[y].height-1)+"px";$i.elements.range2=$P;(function checkOverlap(){var $I=$i.rowlist[y];var $1U=$P;var $N=$K.left;$i.$cx($P,$I,$N,$z,null);})();return $P;};(function(){var $S=$1l.end.x>$1l.start.x?$1l.start.x:$1l.end.x;var $T=($1l.end.x>$1l.start.x?$1l.end.x:$1l.start.x);var y=$1l.start.y;var $I=$i.rowlist[y];var $K=$i.itline[$S];var end=$i.itline[$T];var $0C=$i.$eF;var $7Z=$K.start.addTime($I.data.offset);var $80=end.end.addTime($I.data.offset);if(!$7Y&&$0C&&$0C.start.getTime()===$7Z.getTime()&&$0C.end.getTime()===$80.getTime()&&$0C.resource===$i.rowlist[y].id){return;};var $0l={"start":$7Z,"end":$i.$ax($80)};var $l={};$l.start=$0l.start;$l.end=$0l.end;$l.duration=new DayPilot.Duration($0l.start,$0l.end);$l.resource=$i.rowlist[y].id;$l.allowed=true;$l.left={};$l.left.html=$l.start.toString($i.timeRangeSelectingStartEndFormat);$l.left.enabled=$i.timeRangeSelectingStartEndEnabled;$l.right={};$l.right.html=$l.end.toString($i.timeRangeSelectingStartEndFormat);$l.right.enabled=$i.timeRangeSelectingStartEndEnabled;$i.$eF=$l;if(typeof $i.onTimeRangeSelecting==='function'&&!$7Y){$i.onTimeRangeSelecting($l);};var $81=$i.$eG($1l);$i.$bb($81,$l.start,$l.end);var $P=draw($81);$i.$cD($P,$l);$1l.$em=$81;$1l.disabled=!$l.allowed;$i.$cE($P,$l);$l.start=$0l.start;$l.end=$0l.end;})();};this.$eG=function($1l){return{"start":{"x":$1l.start.x,"y":$1l.start.y},"end":{"x":$1l.end.x},"disabled":$1l.disabled}};this.range={};this.range.all=function(){return mr.get();};this.$eH={};var mr=this.$eH;this.$eH.list=[];this.$eH.clear=function(){DayPilot.de(DayPilot.list(mr.list).map(function($00){return $00.div;}));mr.list=[];};this.$eH.add=function($1l){$1l.div=$i.elements.range2;$i.elements.range2=null;$i.$cF();mr.list.push($1l);};this.$eH.get=function(){return DayPilot.list(mr.list).map(function($00){return $i.$b9($00);});};this.$eH.dispatch=function(){if(!$i.allowMultiRange){return;};if(DayPilotScheduler.range){return;};var $0C=DayPilot.list(mr.list).last();$i.$b8($0C);};this.$eE=function(ev){if($i.timeRangeSelectedHandling==='Disabled'){return false;};if($0I.active||$0I.start){return;};ev=ev||window.event;var $7k=DayPilot.Util.mouseButton(ev);if(DayPilotScheduler.range){return;};if(DayPilotScheduler.rectangleSelect){return;};if(DayPilotScheduler.rangeHold&&$i.$eq($i.coords)&&($7k.right||$7k.middle)){return;};if($i.$bU($i.$bK($i.coords.y).i)){return;};var $1l={};var cx=$i.$ae($i.coords.x).x;$1l.start={y:$i.$bK($i.coords.y).i,x:cx};$1l.end={x:cx};$i.$bc($1l);$i.$b8($1l);DayPilotScheduler.rangeHold=$1l;};this.timeouts={};this.timeouts.drawEvents=null;this.timeouts.drawCells=null;this.timeouts.click=null;this.$9F=function(ev){$i.$9e();if($L.isEnabled()&&!$L.active&&$i.$aU&&$i.cellWidthSpec!="Auto"){if($i.nav.scroll.scrollLeft<$i.$90){$L.active=true;setTimeout(function(){$L.shiftStart(-$i.$91);},100);}else if($i.nav.scroll.scrollWidth-($i.nav.scroll.scrollLeft+$i.nav.scroll.clientWidth)<$i.$90){$L.active=true;setTimeout(function(){$L.shiftStart($i.$91);},100);}};if($i.dynamicLoading){$i.$eI();return;};var $82=$i.nav.scroll;$i.$cs=$82.scrollLeft;$i.$cr=$82.scrollTop;$i.$ct=$82.clientWidth;$i.divTimeScroll.scrollLeft=$i.$cs;$i.divResScroll.scrollTop=$i.$cr;if($i.timeouts.drawEvents){clearTimeout($i.timeouts.drawEvents);$i.timeouts.drawEvents=null;};if($i.scrollDelayEvents>0){$i.timeouts.drawEvents=setTimeout($i.$eJ(),$i.scrollDelayEvents);}else{$i.$9z();};if($i.timeouts.drawCells){clearTimeout($i.timeouts.drawCells);$i.timeouts.drawCells=null;};if($i.scrollDelayCells>0){$i.timeouts.drawCells=setTimeout($i.$eK(),$i.scrollDelayCells);}else{var f=$i.$eK();f();};if($i.timeouts.updateFloats){clearTimeout($i.timeouts.updateFloats);$i.timeouts.updateFloats=null;};if($i.scrollDelayFloats>0){$i.timeouts.updateFloats=setTimeout(function(){$i.$9D();},$i.scrollDelayFloats);}else{$i.$9D();};$i.onScrollCalled=true;};this.$eK=function(){return function(){$i.$9C();$i.$9x();};};this.$eJ=function(){var $1g=true;var $83=$i.dynamicEventRenderingCacheSweeping;var $84=$i.dynamicEventRenderingCacheSize;return function(){if($i.$e9()){window.setTimeout(function(){if($83)$i.$e6($84);window.setTimeout(function(){$i.$9z($1g);},50);},50);}else{$i.$9O();}};};this.$9e=function(){this.$97.eventHeight=null;this.$97.drawArea=null;};this.show=function(){this.visible=true;$i.nav.top.style.display='';this.$9o();this.$9p();$i.$9F();};this.hide=function(){this.visible=false;$i.nav.top.style.display='none';};this.$eI=function(){var $82=$i.nav.scroll;$i.$cs=$82.scrollLeft;$i.$cr=$82.scrollTop;$i.$ct=$82.clientWidth;$i.divTimeScroll.scrollLeft=$i.$cs;$i.divResScroll.scrollTop=$i.$cr;if($i.refreshTimeout){window.clearTimeout($i.refreshTimeout);};var $09=$i.scrollDelayDynamic;$i.refreshTimeout=window.setTimeout($i.$eL($82.scrollLeft,$82.scrollTop),$09);$i.$9D();};this.$eM=function(e){var $85=e.id;var $2Y=new DayPilot.Date(e.start).toString();for(var j=0;j<this.events.list.length;j++){var ex=this.events.list[j];var $86=ex.id;if($86===$85){if(DayPilot.Util.isNullOrUndefined($85)&&!DayPilot.Util.isNullOrUndefined(e.recurrentMasterId)){var $87=new DayPilot.Date(ex.start).toString();if(ex.recurrentMasterId!==e.recurrentMasterId||$2Y!==$87){continue;}};var $j={};$j.ex=ex;$j.index=j;$j.modified=!$i.$eN(e,ex);return $j;}};return null;};this.$eN=function($5F,$88){for(var name in $5F){if(typeof $5F[name]==='object'){continue;};if($5F[name]!==$88[name]){return false;}};for(var name in $88){if(typeof $88[name]==='object'){continue;};if($5F[name]!==$88[name]){return false;}};return true;};this.$9A=function($4Y,$89){var $4V=[];for(var i=0;i<$4Y.length;i++){var e=$4Y[i];var $4Z=$i.$eM(e);var $22=$4Z&&$4Z.modified;var $4X=!$4Z;if($22){this.events.list[$4Z.index]=e;var $15=$i.events.$aB($4Z.ex);$4V=$4V.concat($15);}else if($4X){this.events.list.push(e);};if($22||$4X){$4V=$4V.concat($i.events.$aC(e));}};$i.$aD($4V);$i.$aE();$i.$9n();$i.$9s();var $8a=false;if($8a){$i.$aF($4V,false,$89);}else{$i.$9t();$i.$9q();$i.$9x();$i.$aZ();var f=$i.$eJ();f();}};this.$eL=function(scrollX,scrollY){if(!$i.$a2()){return function(){if(typeof $i.onScroll==='function'){var $22=function($Z){var $89=function(){if($i.$9G()){if(typeof $i.onAfterRender==='function'){var $l={};$l.isCallBack=false;$l.isScroll=true;$l.data=null;$i.onAfterRender($l);}}};$i.$9A($Z,$89);};var $J=$i.$bE(scrollX,scrollY);var $1l=$i.$bF($J);var $1G=$i.$bG($J);var $l={};$l.viewport={};$l.viewport.start=$1l.start;$l.viewport.end=$1l.end;$l.viewport.resources=$1G;$l.async=false;$l.events=[];$l.loaded=function(){if(this.async){$22(this.events);}};$i.onScroll($l);if(!$l.async){$22($l.events);}}};}else{return function(){$i.scrollX=scrollX;$i.scrollY=scrollY;$i.$ak('Scroll');};}};this.$eO=function(){var $J=this.$9L();var $8b=$J.xStart;var $8c=$J.xEnd-$J.xStart;var $3j=$J.yStart;var $8d=$J.yEnd-$J.yStart;if(!this.cellProperties){this.cellProperties={};};for(var i=0;i<=$8c;i++){var x=$8b+i;for(var j=0;j<$8d;j++){var y=$3j+j;if(!this.rowlist[y].hidden){this.$cc(x,y);}};this.$eP(x);};var $8e=this.$cI();for(var y=$8e.start;y<$8e.end;y++){if(!this.rowlist[y].hidden){this.$eQ(y);}}};this.$9x=function(){if($i.progressiveRowRendering){this.$cS();};if(this.rowlist!==null&&this.rowlist.length>0){var $8f=this.cellSweeping;if($8f){var $84=this.cellSweepingCacheSize;this.$e8($84);};this.$eO();this.$eR();$1r.$de();};var $z=this.$cA();this.$9H.style.height=this.$96+"px";this.$9H.style.width=$z+"px";if($i.cellWidthSpec==="Auto"&&!$i.$dM){$i.nav.scroll.style.overflowX="hidden";$i.nav.scroll.scrollLeft=0;}else{$i.nav.scroll.style.overflowX="auto";};this.$aW=false;};this.$eR=function(){var $J=this.$9L();for(var x=$J.xStart;x<$J.xEnd;x++){var $8g=(x<this.itline.length-1)?this.itline[x+1].breakBefore:false;if($8g){this.$eS(x);}}};this.$eS=function(x){var $1t="x"+x;if(this.$97.breaks[$1t]){return;};var $N=this.itline[x+1].left-1;var $R=this.$96;var $0u=document.createElement("div");$0u.style.left=$N+"px";$0u.style.top="0px";$0u.style.width="1px";$0u.style.height=$R+"px";$0u.style.fontSize='1px';$0u.style.lineHeight='1px';$0u.style.overflow='hidden';$0u.style.position='absolute';$0u.setAttribute("unselectable","on");if(this.cssOnly){$0u.className=this.$9S("_matrix_vertical_break");}else{$0u.style.backgroundColor=this.timeBreakColor;};this.divBreaks.appendChild($0u);this.elements.breaks.push($0u);this.$97.breaks[$1t]=$0u;};this.$9L=function(){if($i.$97.drawArea){return $i.$97.drawArea;};if(!this.nav.scroll){return null;};var $8h=$i.$cr;var $J={};var $8i=this.dynamicEventRenderingMargin;var $8i=this.dynamicEventRenderingMarginX!=null?this.dynamicEventRenderingMarginX:this.dynamicEventRenderingMargin;var $8j=this.dynamicEventRenderingMarginY!=null?this.dynamicEventRenderingMarginY:this.dynamicEventRenderingMargin;var $N=$i.$cs-$8i-$L.shiftX;var $O=$N+$i.$ct+2*$8i;var $K=0;var end=0;if($i.itline&&$i.itline.length>0){$K=$i.$ae($N).x;end=$i.$ae($O,true).x;var $3l=this.$9T();end=Math.min(end,$3l);$K=Math.max($K,0);};var top=$8h-$8j;var $W=$8h+this.nav.scroll.offsetHeight+2*$8j;var $3j=this.$bK(top).i;var $3k=this.$bK($W).i;if($3k<this.rowlist.length){$3k++;};$J.xStart=$K;$J.xEnd=end;$J.yStart=$3j;$J.yEnd=$3k;$J.pixels={};$J.pixels.left=this.nav.scroll.scrollLeft-$L.shiftX;$J.pixels.right=this.nav.scroll.scrollLeft-$L.shiftX+this.nav.scroll.clientWidth;$J.pixels.top=this.nav.scroll.scrollTop;$J.pixels.bottom=this.nav.scroll.scrollTop+this.nav.scroll.clientHeight;$J.pixels.width=this.nav.scroll.scrollWidth;$i.$97.drawArea=$J;return $J;};this.$cA=function(){var $j=0;var $0C=this.itline[this.itline.length-1];if(!$0C){$j=0;}else{$j=$0C.left+$0C.width;};if($j<0||isNaN($j)){$j=0;};return $j;};this.$eQ=function(y){var $1t="y"+y;if(this.$97.linesHorizontal[$1t]){return;};var top=this.rowlist[y].top+this.rowlist[y].height-1;var $z=this.$cA();var $0u=document.createElement("div");$0u.style.left="0px";$0u.style.top=top+"px";$0u.style.width=$z+"px";$0u.style.height="1px";$0u.style.fontSize='1px';$0u.style.lineHeight='1px';$0u.style.overflow='hidden';$0u.style.position='absolute';$0u.setAttribute("unselectable","on");$0u.className=this.$9S("_matrix_horizontal_line");this.divLines.appendChild($0u);this.$97.linesHorizontal[$1t]=$0u;};this.$eP=function(x){var $0F=this.itline[x];if(!$0F){return;};var $1t="x"+x;if(this.$97.linesVertical[$1t]){return;};var $N=$0F.left+$0F.width-1;var $0u=document.createElement("div");$0u.style.left=$N+"px";$0u.style.top="0px";$0u.style.width="1px";$0u.style.height=$i.$96+"px";$0u.style.fontSize='1px';$0u.style.lineHeight='1px';$0u.style.overflow='hidden';$0u.style.position='absolute';$0u.setAttribute("unselectable","on");$0u.className=this.$9S("_matrix_vertical_line");this.divLines.appendChild($0u);this.elements.linesVertical.push($0u);this.$97.linesVertical[$1t]=$0u;};this.$cn=function($1t){var $I=this.rowlist[$1t];var $8k=!$I.expanded;$I.expanded=$8k;if($I.resource){$I.resource.expanded=$8k;};var $15=this.$eT($1t,$I.expanded);if(!$8k){for(var i=0;i<$15.length;i++){var ri=$15[i];this.$aX(ri);}};this.$9n();this.$9l();this.$9s();this.$9e();if($8k){for(var i=0;i<$15.length;i++){var ri=$15[i];this.$aY(ri);};this.$9O();};this.$aZ();$1c.load();this.$9t();this.$9x();this.$9z();this.$9C();var r=this.$bm($I,$1t);if($8k){this.$bt(r);}else{this.$bs(r);};this.$9e();};this.$d1=function(i){var $0Q={};$0Q.index=i;if(typeof this.onLoadNode==='function'){var $l={};var $1k=this.rowlist[i].resource;$l.resource=$1k;$l.async=false;$l.loaded=function(){if(this.async){$1k.dynamicChildren=false;$1k.expanded=true;$i.update();}};this.onLoadNode($l);if(!$l.async){$1k.dynamicChildren=false;$1k.expanded=true;this.update();}}else{this.$ak('LoadNode',$0Q);}};this.$eT=function(i,$8l){var $I=this.rowlist[i];var $6m=[];if($I.children===null||$I.children.length===0){return $6m;};for(var k=0;k<$I.children.length;k++){var $1t=$I.children[k];var $8m=this.rowlist[$1t];var $6Z=$8l&&$I.expanded&&!$8m.$dr;$8m.hidden=!$6Z;if($8l===!$8m.hidden){$6m.push($1t);};var $8n=this.$eT($1t,$8l);if($8n.length>0){$6m=$6m.concat($8n);}};return $6m;};this.$ex=function($8o,$8p){this.$dO();this.$eU($8o,$8p);};this.$eV=function($E){if(!$E){return false;};var $0d=this.nav.scroll.scrollWidth;var $K=this.nav.scroll.scrollLeft;var $z=this.nav.scroll.clientWidth;var $O=$K+$z;if($E<0&&$K<=0){return false;};if($E>0&&$O>=$0d){return false;};this.nav.scroll.scrollLeft+=$E;$i.coords.x+=$E;$i.$eW();return true;};this.$eX=function($E){if(!$E){return false;};var $0d=this.nav.scroll.scrollHeight;var $K=this.nav.scroll.scrollTop;var $R=this.nav.scroll.clientHeight;var $W=$K+$R;if($E<0&&$K<=0){return false;};if($E>0&&$W>=$0d){return false;};this.nav.scroll.scrollTop+=$E;$i.coords.y+=$E;$i.$eW();return true;};this.$eW=function(){if(DayPilotScheduler.resizing&&DayPilotScheduler.resizing.event.calendar===$i){$i.$es();}else if(DayPilotScheduler.moving&&(DayPilotScheduler.moving.event.calendar===$i||DayPilotScheduler.moving.event.calendar.dragOutAllowed)){$i.$et();}else if(DayPilotScheduler.range&&DayPilotScheduler.range.calendar===$i){$i.$eu();}};this.$eU=function($8o,$8p){var $8q=this.$eV($8o)||this.$eX($8p);if(!$8q){return;};var $8r=function($8o,$8p){return function(){$i.$eU($8o,$8p);};};this.$eY=window.setTimeout($8r($8o,$8p),100);};this.$dO=function(){if($i.$eY){window.clearTimeout($i.$eY);$i.$eY=null;}};this.$9n=function(){var top=0;for(var i=0;i<this.rowlist.length;i++){var $I=this.rowlist[i];if(!$I.hidden){$I.top=top;top+=$I.height;}};this.$96=top;};this.$9t=function(){this.elements.cells=[];this.elements.linesVertical=[];this.elements.breaks=[];this.$97.cells=[];this.$97.linesVertical={};this.$97.linesHorizontal={};this.$97.breaks=[];this.divCells.innerHTML='';this.divLines.innerHTML='';this.divBreaks.innerHTML='';};this.$b0=function(y){var $Y=DayPilot.list();for(var name in $i.$97.cells){$Y.push($i.$97.cells[name]);};$Y.filter(function($00){return $00&&$00.coords&&$00.coords.y===y;}).each(function($00){$i.$cb($00);});};this.$eZ=0;this.$f0=['html','cssClass','backColor','backImage','backRepeat','business','areas'];this.$cc=function(x,y){if(!this.$aU){return;};var $0F=$i.$am(x);if(!$0F){return;};var $1t=x+'_'+y;if(this.$97.cells[$1t]){return;};var p=this.$cd(x,y);if(typeof this.onBeforeCellRender==='function'&&x>=0){var $I=$i.rowlist[y];var $1k=$I.id;var $1p=$I.start.getTime()-this.$a6().getTime();var $K=$0F.start.addTime($1p);var end=$0F.end.addTime($1p);var $P=$i.cells.findXy(x,y)[0];var $l={};$l.cell=$P;$l.getPixels=function($u){var $u=new DayPilot.Date($u);var $8s=$i.getPixels($u).left;return $8s-$0F.left;};this.onBeforeCellRender($l);DayPilot.Util.copyProps($l.cell,$l.cell.properties,$i.$f0);};if(!this.drawBlankCells){var $8t=false;if(this.cssOnly&&this.$ck(y)){$8t=false;}else if(!this.$f1(p,$i.$f0)){$8t=true;};if($8t){return;}};var $P=document.createElement("div");$P.style.left=($0F.left)+"px";$P.style.top=this.rowlist[y].top+"px";$P.style.width=($0F.width)+"px";$P.style.height=(this.rowlist[y].height)+"px";$P.style.position='absolute';if(p&&p.backColor){$P.style.backgroundColor=p.backColor;};$P.setAttribute("unselectable","on");$P.className=this.cssOnly?this.$9S('_cell'):this.$9S('cellbackground');$P.coords={};$P.coords.x=x;$P.coords.y=y;if(this.cssOnly&&this.$ck(y)){DayPilot.Util.addClass($P,this.$9S("_cellparent"));};if(p){if(p.cssClass){if(this.cssOnly){DayPilot.Util.addClass($P,p.cssClass);}else{DayPilot.Util.addClass($P,$i.$9S(p.cssClass));}};if(!DayPilot.Util.isNullOrUndefined(p.html)){$P.innerHTML=p.html;};if(p.backImage){$P.style.backgroundImage="url(\"" + p.backImage + "\")";};if(p.backRepeat){$P.style.backgroundRepeat=p.backRepeat;};if(p.business){DayPilot.Util.addClass($P,$i.$9S("_cell_business"));};DayPilot.list(p.areas).each(function($J){if($J.start||$J.end){$J.left=$i.getPixels(new DayPilot.Date($J.start)).left-$0F.left;$J.width=$i.getPixels(new DayPilot.Date($J.end)).left-$J.left-$0F.left;}});var c=$i.cells.findXy(x,y)[0];DayPilot.Areas.attach($P,c,{"areas":p.areas});};$P.onmouseup=this.$dS;this.divCells.appendChild($P);this.elements.cells.push($P);this.$97.cells[$1t]=$P;};this.$f1=function($1R,$23){if($23){for(var i=0;i<$23.length;i++){if(!DayPilot.Util.isNullOrUndefined($1R[$23[i]])){return true;}}}else{for(var name in $1R){if(!DayPilot.Util.isNullOrUndefined($1R[name])){return true;}}};return false;};this.clearSelection=function(){this.$9B();mr.clear();};this.cleanSelection=this.clearSelection;this.$b4=function(){DayPilot.de(DayPilotScheduler.movingShadow);DayPilotScheduler.movingShadow=null;$i.$cF();$i.$cy.clear();};this.$9B=function(){this.divRange.innerHTML='<div style="position:absolute; left:0px; top:0px; width:0px; height:0px;"></div>';this.elements.range=[];this.elements.range2=null;this.$cF();DayPilotScheduler.rangeHold=null;};this.$bS={};var $0a=this.$bS;$0a.locale=function(){return DayPilot.Locale.find($i.locale);};$0a.timeFormat=function(){if($i.timeFormat!=='Auto'){return $i.timeFormat;};return $0a.locale().timeFormat;};$0a.weekStarts=function(){if($i.weekStarts==='Auto'){var $5N=$0a.locale();if($5N){return $5N.weekStarts;}else{return 0;}}else{return $i.weekStarts;}};$0a.rounded=function(){return $i.eventCorners==='Rounded';};$0a.layout=function(){var $8u=/MSIE 6/i.test(navigator.userAgent);if($i.layout==='Auto'){if($8u){return 'TableBased';}else{return 'DivBased';}};return $i.layout;};$0a.notifyType=function(){var $X;if($i.notifyCommit==='Immediate'){$X="Notify";}else if($i.notifyCommit==='Queue'){$X="Queue";}else{throw "Invalid notifyCommit value: "+$i.notifyCommit;};return $X;};$0a.isResourcesView=function(){return $i.viewType!=='Days';};$0a.useBox=function($8v){if($i.useEventBoxes==='Always'){return true;};if($i.useEventBoxes==='Never'){return false;};return $8v<$i.cellDuration*60*1000;};$0a.eventHeight=function(){if($i.$97.eventHeight){return $i.$97.eventHeight;};var $R=$i.$dX("_event_height").height;if(!$R){$R=$i.eventHeight;};$i.$97.eventHeight=$R;return $R;};$0a.headerHeight=function(){if($i.$97.headerHeight){return $i.$97.headerHeight;};var $R=$i.$dX("_header_height").height;if(!$R){$R=$i.headerHeight;};$i.$97.headerHeight=$R;return $R;};$0a.splitterWidth=function(){if($i.rowHeaderScrolling){return $i.rowHeaderSplitterWidth;};return 1;};this.$f2=function(x,y){var $1t=x+'_'+y;if(this.cellProperties&&this.cellProperties[$1t]){return this.cellProperties[$1t].backColor;};return null;};this.$cd=function(x,y){var $1t=x+'_'+y;if(!this.cellProperties){this.cellProperties={};};if(this.cellProperties[$1t]){return this.cellProperties[$1t];};if(this.$8W){this.cellProperties[$1t]=$i.$f3(x,y);};if(!this.cellProperties[$1t]){var $I=$i.rowlist[y];var $1k=$I.id;var $1p=$I.start.getTime()-$i.$a6().getTime();var $0F=$i.$am(x);var $K=$0F.start.addTime($1p);var end=$0F.end.addTime($1p);var $8w={};$8w.start=$K;$8w.end=end;$8w.resource=$1k;var $P={};$P.business=$i.isBusiness($8w);this.cellProperties[$1t]=$P;};return this.cellProperties[$1t];};this.$f4=function($1u,x,y){var $1t=x+'_'+y;this.cellProperties[$1t]={};DayPilot.Util.copyProps($1u,this.cellProperties[$1t],$i.$f0);return this.cellProperties[$1t];};this.$f3=function(x,y){if(!this.cellConfig){return null;};var $8x=this.cellConfig;var $P=this.cellProperties[x+"_"+y];if(!$P&&$8x.vertical){$P=this.cellProperties[x+"_0"];};if(!$P&&$8x.horizontal){$P=this.cellProperties["0_"+y];};if(!$P&&$8x["default"]){$P=$8x["default"];};var $81={};DayPilot.Util.copyProps($P,$81,$i.$f0);return $81;};this.$9j=function(){if(this.$8W){return;};if(this.$8X){return;};this.$8X=true;if(!this.cellConfig){return;};var $8x=this.cellConfig;if($8x.vertical){for(var x=0;x<$8x.x;x++){var $8y=this.cellProperties[x+"_0"];if(!$8y){continue;};for(var y=1;y<$8x.y;y++){this.$f4($8y,x,y);}}};if($8x.horizontal){for(var y=0;y<$8x.y;y++){var $8y=this.cellProperties["0_"+y];if(!$8y){continue;};for(var x=1;x<$8x.x;x++){this.$f4($8y,x,y);}}};if($8x["default"]){var $8y=$8x["default"];for(var y=0;y<$8x.y;y++){for(var x=0;x<$8x.x;x++){if(!this.cellProperties[x+"_"+y]){this.$f4($8y,x,y);}}}}};this.isBusiness=function($P){var $K=$P.start;var end=$P.end;var $7E=(end.getTime()-$K.getTime())/(1000*60);if($7E<=1440){if((!$i.businessWeekends)&&($P.start.dayOfWeek()===0||$P.start.dayOfWeek()===6)){return false;}};if($7E<720){var $8z=$K.getHours();$8z+=$K.getMinutes()/60.0;$8z+=$K.getSeconds()/3600.0;$8z+=$K.getMilliseconds()/3600000.0;if($8z<this.businessBeginsHour){return false;};if(this.businessEndsHour>=24){return true;};if($8z>=this.businessEndsHour){return false;}};return true;};this.$9o=function(){if(this.nav.top.style.visibility==='hidden'){this.nav.top.style.visibility='visible';}};this.$cL=function(){var el=$i.nav.top;return el.offsetWidth>0&&el.offsetHeight>0;};this.$f5=function(){var $6Z=$i.$cL;if(!$6Z()){$i.debug.message("Not visible during init, starting visibilityInterval");$i.$f6=setInterval(function(){if($6Z()){$i.debug.message("Made visible, calling .show()");$i.show();$i.$cK();clearInterval($i.$f6);}},100);}};this.$f7=function($x){if(this.heightSpec!=="Parent100Pct"){this.heightSpec="Fixed";};this.height=$x-(this.$9U()+2);this.$9s();};this.setHeight=this.$f7;this.$9J=function(id){for(var i=0;i<this.rowlist.length;i++){if(this.rowlist[i].id===id){return this.rowlist[i];}};return null;};this.$dx=function(){if(this.id&&this.id.tagName){this.nav.top=this.id;}else if(typeof this.id==="string"){this.nav.top=document.getElementById(this.id);if(!this.nav.top){throw "DayPilot.Scheduler: The placeholder element not found: '"+id+"'.";}}else{throw "DayPilot.Scheduler() constructor requires the target element or its ID as a parameter";}};this.$f8=function(){this.$dW();this.$9i();this.$9p();this.$dZ();this.$bO();DayPilotScheduler.register(this);this.$9c(this.afterRenderData,false);this.$e0();this.$f5();this.$9b();this.$ak("Init");};this.init=function(){this.$f9();};this.$f9=function(){this.$dx();if(this.nav.top.dp){return;};this.$dw();var $8A=this.$c1();if($8A){this.$f8();this.$aU=true;this.$9e();return;};this.$dZ();this.$bO();DayPilotScheduler.register(this);this.$e0();this.$aI();this.$aU=true;if($i.scrollToDate){$i.scrollTo($i.scrollToDate);}else if($i.scrollX||$i.scrollY){$i.setScroll($i.scrollX,$i.scrollY);}else{$i.$9F();};if($i.scrollToResourceId){$i.scrollToResource($i.scrollToResourceId);$i.scrollToResourceId=null;};var $8B=function(){if($i.scrollY){$i.setScroll($i.scrollX,$i.scrollY);}};window.setTimeout($8B,200);if(this.messageHTML){window.setTimeout(function(){$i.message($i.messageHTML);},0);};this.$f5();this.$9b();this.$9e();this.$9c(this.afterRenderData,false);if($i.$92){setTimeout(function(){$i.$ak("Init");});};this.$fa();};this.$fb=null;this.$fc=function($h){var $8C={"events":{"preInit":function(){var $Z=this.data;if(!$Z){return;};if(DayPilot.isArray($Z.list)){$i.events.list=$Z.list;}else{$i.events.list=$Z;}},"postInit":function(){}},"scrollTo":{"preInit":function(){},"postInit":function(){if(this.data){$i.scrollTo(this.data,$h.scrollToAnimated,$h.scrollToPosition);}}}};this.$fb=$8C;for(var name in $h){if($8C[name]){var $00=$8C[name];$00.data=$h[name];if($00.preInit){$00.preInit();}}else{$i[name]=$h[name];}}};this.$fa=function(){var $8C=this.$fb;for(var name in $8C){var $00=$8C[name];if($00.postInit){$00.postInit();}}};this.temp={};this.temp.getPosition=function(){var x=Math.floor($i.coords.x/$i.cellWidth);var y=$i.$bK($i.coords.y).i;if(y<$i.rowlist.length){var $P={};$P.start=$i.itline[x].start;$P.end=$i.itline[x].end;$P.resource=$i.rowlist[y].id;return $P;}else{return null;}};this.temp.img=$i.$cq;this.internal={};this.internal.initialized=function(){return $i.$aU;};this.internal.invokeEvent=this.$av;this.internal.eventMenuClick=this.$b7;this.internal.timeRangeMenuClick=this.$bf;this.internal.resourceHeaderMenuClick=this.$bh;this.internal.linkMenuClick=this.$bg;this.internal.bubbleCallBack=this.$b5;this.internal.findEventDiv=this.$bZ;this.internal.rowtools=this.$bq;this.internal.getNodeChildren=this.$bM;this.internal.callback=function(){$i.$ak.apply($i,arguments);};this.internal.createRowObject=this.$bm;this.internal.adjustEndIn=$i.$b1;this.internal.adjustEndNormalize=$i.$b2;this.internal.touch=$i.$ej;this.Init=this.init;this.$fc($h);};debug=new DayPilot.Scheduler().v==="${v\u007d";DayPilot.Row=function($I,$i){if(!$I){throw "Now row object supplied when creating DayPilot.Row";};if(!$i){throw "No parent control supplied when creating DayPilot.Row";};var $1t=DayPilot.indexOf($i.rowlist,$I);var r=this;r.isRow=true;r.menuType='resource';r.start=$I.start;r.name=$I.name;r.value=$I.id;r.id=$I.id;r.tags=$I.tags;r.index=$1t;r.level=$I.level;r.calendar=$i;r.$fd=$I;r.$={};r.$.row=$I;r.toJSON=function($54){var $1D={};$1D.start=this.start;$1D.name=this.name;$1D.value=this.value;$1D.id=this.id;$1D.index=this.index;return $1D;};r.parent=function(){if(!r.$fd.$ds){return null;};return $i.$bm(r.$fd.$ds);};r.children=function(){return DayPilot.list(r.$fd.children).map(function($00){return $i.$bm($00);});};r.cells={};r.cells.all=function(){var $Y=[];var $1J=$i.itline.length;var y=r.index;for(var x=0;x<$1J;x++){var $P=$i.cells.findXy(x,y);$Y.push($P[0]);};return $i.$ce($Y);};r.events={};r.events.all=function(){var $Y=[];for(var i=0;i<r.$fd.events.length;i++){$Y.push(r.$fd.events[i]);};return DayPilot.list($Y);};r.events.totalDuration=function(){var $0v=0;r.events.all().each(function($00){$0v+=$00.part.end.getTime()-$00.part.start.getTime();});return new DayPilot.Duration($0v);};r.groups={};r.groups.collapseAll=function(){for(var i=0;i<r.$fd.blocks.length;i++){var $59=r.$fd.blocks[i];var $8D=new $8E($59);$8D.$fe();};$i.$aE();$i.$aF(r.index);$i.$9s();};r.groups.expandAll=function(){for(var i=0;i<r.$fd.blocks.length;i++){var $59=r.$fd.blocks[i];var $8D=new $8E($59);$8D.$ff();};$i.$aE();$i.$aF(r.index);$i.$9s();};r.groups.expanded=function(){var $Y=[];for(var i=0;i<r.$fd.blocks.length;i++){var $59=r.$fd.blocks[i];if($59.expanded&&$59.lines.length>$i.groupConcurrentEventsLimit){$Y.push(new $8E($59));}};return DayPilot.list($Y);};r.groups.collapsed=function(){var $Y=[];for(var i=0;i<r.$fd.blocks.length;i++){var $59=r.$fd.blocks[i];if(!$59.expanded){$Y.push(new $8E($59));}};return DayPilot.list($Y);};r.groups.all=function(){var $Y=[];for(var i=0;i<r.$fd.blocks.length;i++){var $59=r.$fd.blocks[i];$Y.push(new $8E($59));};return DayPilot.list($Y);};r.events.collapseGroups=r.groups.collapseAll;r.events.expandGroups=r.groups.expandAll;r.column=function(i){return new $8F(r,i);};r.toggle=function(){$i.$cn(r.index);};r.addClass=function($46){var $I=r;var $4A=$i.divHeader;var $I=$4A.rows[$I.index];if($I){var $M=DayPilot.list($I.cells).map(function($P){return $P.cellDiv;});DayPilot.Util.addClass($M,$46);};r.$.row.cssClass=DayPilot.Util.addClassToString(r.$.row.cssClass,$46);};r.removeClass=function($46){var $I=r;var $4A=$i.divHeader;var $I=$4A.rows[$I.index];if($I){var $M=DayPilot.list($I.cells).map(function($P){return $P.cellDiv;});DayPilot.Util.removeClass($M,$46);};r.$.row.cssClass=DayPilot.Util.removeClassFromString(r.$.row.cssClass,$46);};var $8E=function($59){var $8G=function($59){for(var i=0;i<$i.elements.events.length;i++){var $02=$i.elements.events[i];if($02.event===$59){return $02;}};return null;};this.$ff=function(){$59.expanded=true;var $Y=$i.$d8;DayPilot.list($59.events).each(function(e){$Y.push(e.id());});var $02=$8G($59);if($02){$i.$e5($02);var $74=DayPilot.indexOf($i.elements.events,$02);if($74!==-1){$i.elements.events.splice($74,1);}}};this.expand=function(){this.$ff();$i.$aE();$i.$aF($59.row.index);$i.$9s();};this.$fe=function(){if($59.lines.length>$i.groupConcurrentEventsLimit){$59.expanded=false;var $38=DayPilot.list($59.events).map(function(e){return e.id()});$i.$d8=$i.$d8.filter(function($00){return !DayPilot.contains($38,$00);});}};this.collapse=function(){this.$fe();$i.$aE();$i.$aF($59.row.index);$i.$9s();};};var $8F=function($I,i){this.html=function($08){var $4A=$I.calendar.divHeader;var $P=$4A.rows[$I.index].cells[i];var $1s=$P.textDiv;if(typeof $08==="undefined"){return $1s.innerHTML;}else{$1s.innerHTML=$08;}};};};DayPilotScheduler.moving=null;DayPilotScheduler.originalMouse=null;DayPilotScheduler.resizing=null;DayPilotScheduler.globalHandlers=false;DayPilotScheduler.timeRangeTimeout=null;DayPilotScheduler.selectedCells=null;DayPilotScheduler.dragStart=function(element,$0H,id,$1s,$X){DayPilot.us(element);var $8H=DayPilotScheduler.drag={};$8H.element=element;$8H.duration=$0H;$8H.text=$1s;$8H.id=id;$8H.shadowType=$X?$X:'Fill';$8H.data={"id":id,"text":$1s,"duration":$0H,"externalHtml":$1s};return false;};DayPilot.Scheduler.startDragging=function($h){var $h=$h||{};var element=$h.element;var $8I=$h.keepElement?null:element;DayPilot.us(element);var $8H=DayPilotScheduler.drag={};$8H.element=$8I;$8H.id=$h.id;$8H.duration=$h.duration||60;$8H.text=$h.text||"";$8H.shadowType='Fill';$8H.data=$h;return false;};DayPilot.Scheduler.makeDraggable=function($h){var element=$h.element;var $8I=$h.keepElement?null:element;DayPilot.us(element);DayPilot.re(element,"mousedown",function(ev){startDragging();var element=(ev.target||ev.srcElement);if(element.tagName){var $8J=element.tagName.toLowerCase();if($8J==="textarea"||$8J==="select"||$8J==="input"){return false;}};ev.preventDefault&&ev.preventDefault();return false;});element.ontouchstart=function(ev){var $7l=0;window.setTimeout(function(){startDragging();DayPilotScheduler.gTouchMove(ev);ev.preventDefault();},$7l);ev.preventDefault();};function startDragging(){var $8H=DayPilotScheduler.drag={};$8H.element=$8I;$8H.id=$h.id;$8H.duration=$h.duration||60;$8H.text=$h.text||"";$8H.shadowType='Fill';$8H.data=$h;}};DayPilot.Scheduler.stopDragging=function(){DayPilotScheduler.dragStop();if(DayPilotScheduler.resizing){DayPilot.de(DayPilotScheduler.resizingShadow);DayPilotScheduler.resizing=null;DayPilotScheduler.resizingShadow=null;};if(DayPilotScheduler.moving){var $i=DayPilotScheduler.moving.event.calendar;DayPilot.Util.removeClass(DayPilotScheduler.moving,$i.$9S("_event_moving_source"));DayPilot.de(DayPilotScheduler.movingShadow);DayPilotScheduler.moving=null;DayPilotScheduler.movingShadow=null;};if(DayPilotScheduler.range){var $i=DayPilotScheduler.range.calendar;$i.clearSelection();DayPilotScheduler.range=null;};document.body.style.cursor='';DayPilot.list(DayPilotScheduler.registered).each(function($i){$i.$dO();$i.$cF();});};DayPilotScheduler.dragStop=function(){if(DayPilotScheduler.gShadow){document.body.removeChild(DayPilotScheduler.gShadow);DayPilotScheduler.gShadow=null;};DayPilotScheduler.drag=null;};DayPilotScheduler.register=function($i){if(!DayPilotScheduler.registered){DayPilotScheduler.registered=[];};for(var i=0;i<DayPilotScheduler.registered.length;i++){if(DayPilotScheduler.registered[i]===$i){return;}};DayPilotScheduler.registered.push($i);};DayPilotScheduler.unregister=function($i){var a=DayPilotScheduler.registered;if(a){var i=DayPilot.indexOf(a,$i);if(i!==-1){a.splice(i,1);};if(a.length===0){a=null;}};if(!a){DayPilot.ue(document,'mousemove',DayPilotScheduler.gMouseMove);DayPilot.ue(document,'mouseup',DayPilotScheduler.gMouseUp);DayPilot.ue(document,'keyup',DayPilotScheduler.gKeyUp);DayPilot.ue(document,'touchmove',DayPilotScheduler.gTouchMove);DayPilot.ue(document,'touchend',DayPilotScheduler.gTouchEnd);DayPilotScheduler.globalHandlers=false;}};function calendarFromTouchEvent(ev){var $8K=ev.touches[0].clientX;var $8L=ev.touches[0].clientY;var el=document.elementFromPoint($8K,$8L);while(el&&el.parentNode){el=el.parentNode;if(el.daypilotMainD){return el.calendar;}};return false;};function touchMousePos(ev){var x=ev.touches[0].pageX;var y=ev.touches[0].pageY;var $7L={};$7L.x=x;$7L.y=y;return $7L;};DayPilotScheduler.gTouchMove=function(ev){if(DayPilotScheduler.resizing){var $i=DayPilotScheduler.resizing.event.calendar;$i.coords=$i.$ej.relativeCoords(ev);$i.$ej.updateResizing();ev.preventDefault();};if(DayPilotScheduler.moving){var $i=DayPilotScheduler.moving.event.calendar;$i.coords=$i.$ej.relativeCoords(ev);$i.$ej.updateMoving();ev.preventDefault();};if(DayPilotScheduler.drag){ev.preventDefault();var $7L=touchMousePos(ev);var $i=calendarFromTouchEvent(ev);if($i){if(DayPilotScheduler.gShadow){document.body.removeChild(DayPilotScheduler.gShadow);};DayPilotScheduler.gShadow=null;$i.coords=$i.$ej.relativeCoords(ev);if(!DayPilotScheduler.movingShadow&&$i.rowlist.length>0){if(!DayPilotScheduler.moving){DayPilotScheduler.moving={};var event=DayPilotScheduler.drag.event;if(!event){var $7N=$i.itline[0].start;var ev={'id':DayPilotScheduler.drag.id,'start':$7N,'end':$7N.addSeconds(DayPilotScheduler.drag.duration),'text':DayPilotScheduler.drag.text};var $q=DayPilotScheduler.drag.data;if($q){var $6M=['duration','element','id','text'];for(var name in $q){if(DayPilot.contains($6M,name)){continue;};ev[name]=$q[name];}};event=new DayPilot.Event(ev);event.calendar=$i;event.part.external=true;};DayPilotScheduler.moving.event=event;};DayPilotScheduler.movingShadow=$i.$bT(DayPilotScheduler.moving,DayPilotScheduler.drag.shadowType);};if(DayPilotScheduler.moving){$i.$ej.updateMoving();}}else{DayPilot.de(DayPilotScheduler.movingShadow);var $8M=DayPilotScheduler.moving;DayPilotScheduler.moving=null;DayPilotScheduler.movingShadow=null;if(!DayPilotScheduler.gShadow){DayPilotScheduler.gShadow=DayPilotScheduler.createGShadow(DayPilotScheduler.drag.data);DayPilotScheduler.gShadow.source=$8M;};var $1U=DayPilotScheduler.gShadow;$1U.style.left=$7L.x+'px';$1U.style.top=$7L.y+'px';}}};DayPilotScheduler.gTouchEnd=function(ev){DayPilotScheduler.gMouseUp(ev);};DayPilotScheduler.gMouseMove=function(ev){if(typeof(DayPilotScheduler)==='undefined'){return;};ev=ev||window.event;if(ev.insideMainD){return;}else if(ev.srcElement){if(ev.srcElement.inside){return;}};var $7L=DayPilot.mc(ev);if(DayPilotScheduler.drag){document.body.style.cursor='move';if(!DayPilotScheduler.gShadow){DayPilotScheduler.gShadow=DayPilotScheduler.createGShadow(DayPilotScheduler.drag.data);};var $1U=DayPilotScheduler.gShadow;$1U.style.left=$7L.x+'px';$1U.style.top=$7L.y+'px';DayPilotScheduler.moving=null;if(DayPilotScheduler.movingShadow){var $8N=DayPilotScheduler.movingShadow.calendar;if($8N){$8N.$cF();DayPilotScheduler.movingShadow.calendar=null;DayPilot.de(DayPilotScheduler.movingShadow);DayPilotScheduler.movingShadow=null;}}}else if(DayPilotScheduler.moving&&DayPilotScheduler.moving.event.calendar.dragOutAllowed&&!DayPilotScheduler.drag){var $8N=DayPilotScheduler.moving.event.calendar;var ev=DayPilotScheduler.moving.event;DayPilotScheduler.moving.target=null;document.body.style.cursor='move';if(!DayPilotScheduler.gShadow){DayPilotScheduler.gShadow=DayPilotScheduler.createGShadow(ev.data);DayPilotScheduler.gShadow.source=DayPilotScheduler.moving;};var $1U=DayPilotScheduler.gShadow;$1U.style.left=$7L.x+'px';$1U.style.top=$7L.y+'px';DayPilotScheduler.drag={};var $8H=DayPilotScheduler.drag;$8H.element=null;$8H.duration=(ev.rawend().getTime()-ev.start().getTime())/1000;$8H.text=ev.text();$8H.id=ev.value();$8H.shadowType=$8N.shadow;$8H.event=ev;$8N.$cF();DayPilot.de(DayPilotScheduler.movingShadow);DayPilotScheduler.movingShadow.calendar=null;DayPilotScheduler.movingShadow=null;};for(var i=0;i<DayPilotScheduler.registered.length;i++){if(DayPilotScheduler.registered[i].$cP){DayPilotScheduler.registered[i].$cP();}}};DayPilotScheduler.gUnload=function(ev){if(!DayPilotScheduler.registered){return;};for(var i=0;i<DayPilotScheduler.registered.length;i++){var c=DayPilotScheduler.registered[i];DayPilotScheduler.unregister(c);}};DayPilotScheduler.gMouseDown=function(ev){if(DayPilotScheduler.editing){DayPilotScheduler.editing.blur();}};DayPilotScheduler.gKeyUp=function(ev){var ev=ev||window.event;var $54=ev.keyCode;if($54===17){if(DayPilotScheduler.rangeCalendar){var $i=DayPilotScheduler.rangeCalendar;$i.$eH.dispatch();}}};DayPilotScheduler.gMouseUp=function(ev){DayPilot.list(DayPilotScheduler.registered).each(function($i){$i.$dO();});if(DayPilotScheduler.resizing){if(!DayPilotScheduler.resizingShadow){document.body.style.cursor='';DayPilotScheduler.resizing=null;return;};var e=DayPilotScheduler.resizing.event;var $i=e.calendar;$i.$cp();var $0m=DayPilotScheduler.resizingShadow.start;var $0V=DayPilotScheduler.resizingShadow.end;var $4u=DayPilotScheduler.resizingShadow.overlapping;var $7n=!DayPilotScheduler.resizingShadow.allowed;DayPilot.de(DayPilotScheduler.resizingShadow);DayPilotScheduler.resizing=null;DayPilotScheduler.resizingShadow=null;$i.$cF();$i.$cw.clear();document.body.style.cursor='';if($4u||$7n){return;};$i.$aw(e,$0m,$0V);}else if(DayPilotScheduler.moving){var $8O=function(){if(DayPilotScheduler.movingShadow){DayPilot.de(DayPilotScheduler.movingShadow);DayPilotScheduler.movingShadow.calendar=null;};document.body.style.cursor='';DayPilotScheduler.moving=null;DayPilotScheduler.drag=null;};if(!DayPilotScheduler.movingShadow){$8O();return;};var e=DayPilotScheduler.moving.event;var $i=DayPilotScheduler.moving.target;if(!$i){$8O();return;};DayPilot.Util.removeClass(DayPilotScheduler.moving,$i.$9S("_event_moving_source"));if(!DayPilotScheduler.movingShadow.row){$8O();return;};clearTimeout($i.$cl.timeout);var $0m=DayPilotScheduler.movingShadow.start;var $0V=DayPilotScheduler.movingShadow.end;var $10=($i.viewType!=='Days')?DayPilotScheduler.movingShadow.row.id:null;var external=(DayPilotScheduler.drag?true:false)&&e.part.external;var $0u=DayPilotScheduler.movingShadow.line;var $4u=DayPilotScheduler.movingShadow.overlapping;var $7n=!DayPilotScheduler.movingShadow.allowed;if(DayPilotScheduler.drag){if(!$i.todo){$i.todo={};};$i.todo.del=DayPilotScheduler.drag.element;DayPilotScheduler.drag=null;};DayPilotScheduler.movingShadow.calendar=null;document.body.style.cursor='';DayPilotScheduler.moving=null;if($4u||$7n||$i.$cy.forbidden||$i.$cy.invalid){$i.$b4();return;};var ev=ev||window.event;$i.$b3(e,$0m,$0V,$10,external,ev,$0u);}else if(DayPilotScheduler.range){ev=ev||window.event;var $7k=DayPilot.Util.mouseButton(ev);var $1l=DayPilotScheduler.range;var $i=$1l.calendar;$i.$eF=null;var $17=ev.ctrlKey||ev.metaKey;if($i.allowMultiRange){if(!$i.elements.range2.overlapping){$i.$eH.add($1l);}else{DayPilot.de($i.elements.range2);$i.elements.range2=null;$i.$cF();};DayPilotScheduler.range=null;if(!$17){$i.$eH.dispatch();};return;};if(DayPilotScheduler.timeRangeTimeout){clearTimeout(DayPilotScheduler.timeRangeTimeout);DayPilotScheduler.timeRangeTimeout=null;return;};DayPilotScheduler.rangeHold=$1l;DayPilotScheduler.range=null;var $8r=function($1l){return function(){DayPilotScheduler.timeRangeTimeout=null;var $1U=$i.elements.range2;if($1U&&$1U.overlapping){$i.clearSelection();return;};$i.$b8($1l);if($i.timeRangeSelectedHandling!=="Hold"&&$i.timeRangeSelectedHandling!=="HoldForever"){$c();}else{DayPilotScheduler.rangeHold=$1l;}};};var rc=$i.$eG($1l);if(!$7k.left){DayPilotScheduler.timeRangeTimeout=null;return;};if($i.timeRangeDoubleClickHandling==='Disabled'){$8r(rc)();var ev=ev||window.event;ev.cancelBubble=true;return false;}else{DayPilotScheduler.timeRangeTimeout=setTimeout($8r(rc),$i.doubleClickTimeout);}}else if($4M.row){var $i=$4M.calendar;if($i){$i.$di();}}else if($20.source){var $i=$20.calendar;$i.$bV.clearShadow();$i.$bV.hideLinkpoints();$20.source=null;$20.calendar=null;}else if(DayPilotScheduler.splitting){var $6o=DayPilotScheduler.splitting;$6o.cleanup();DayPilotScheduler.splitting=null;}else if(DayPilotScheduler.rectangleSelect){var $3N=DayPilotScheduler.rectangleSelect;var $i=$3N.calendar;var x=$3N.x;var y=$3N.y;var $z=$3N.width;var $R=$3N.height;var $4W=false;var $Z=$i.$9P.eventsInRectangle(x,y,$z,$R).map(function($00){return $00.event;});if(typeof $i.onRectangleEventSelect==="function"){var $l={};$l.events=$Z;$l.append=false;$l.start=$i.getDate(x,true);$l.end=$i.getDate(x+$z,true);$l.preventDefault=function(){this.preventDefault.value=true;};$i.onRectangleEventSelect($l);if($l.preventDefault.value){$i.$ey.clear();DayPilotScheduler.rectangleSelect=null;return;};$4W=$l.append;};if(!$4W){$i.multiselect.clear(true);};$Z.each(function(e){$i.multiselect.add(e,true);});$i.multiselect.redraw();setTimeout(function(){$i.$ey.clear();DayPilotScheduler.rectangleSelect=null;},0);if(typeof $i.onRectangleEventSelected==="function"){var $l={};$l.events=$Z;$i.onRectangleEventSelected($l);}};if(DayPilotScheduler.drag){if(DayPilotScheduler.drag.event&&DayPilotScheduler.drag.event.part){delete DayPilotScheduler.drag.event.part.external;};DayPilotScheduler.drag=null;document.body.style.cursor='';};if(DayPilotScheduler.gShadow){if(DayPilotScheduler.gShadow.source){var $i=DayPilotScheduler.gShadow.source.event.calendar;DayPilot.Util.removeClass(DayPilotScheduler.gShadow.source,$i.$9S("_event_moving_source"));};document.body.removeChild(DayPilotScheduler.gShadow);DayPilotScheduler.gShadow=null;};DayPilotScheduler.moveOffsetX=null;DayPilotScheduler.moveDragStart=null;};DayPilotScheduler.createGShadow=function($h){var $h=$h||{};var $1U=document.createElement('div');$1U.setAttribute('unselectable','on');$1U.style.position='absolute';$1U.style.width='100px';$1U.style.height='20px';$1U.style.zIndex=101;$1U.style.pointerEvents="none";$1U.style.backgroundColor="#aaaaaa";$1U.style.opacity=0.5;$1U.style.filter="alpha(opacity=50)";$1U.className=$h.externalCssClass;if($h.externalHtml){$1U.innerHTML=$h.externalHtml;};document.body.appendChild($1U);return $1U;};var $4M={};DayPilot.Global.rowmoving=$4M;var $20={};DayPilot.Global.linking=$20;DayPilot.SchedulerVisible.dragStart=DayPilotScheduler.dragStart;DayPilot.SchedulerVisible.dragStop=DayPilotScheduler.dragStop;DayPilot.SchedulerVisible.Scheduler=DayPilotScheduler.Scheduler;DayPilot.SchedulerVisible.globalHandlers=DayPilotScheduler.globalHandlers;if(typeof jQuery!=='undefined'){(function($){$.fn.daypilotScheduler=function($h){var $5F=null;var j=this.each(function(){if(this.daypilot){return;};var $8P=new DayPilot.Scheduler(this.id,$h);$8P.init();this.daypilot=$8P;if(!$5F){$5F=$8P;}});if(this.length===1){return $5F;}else{return j;}};})(jQuery);};(function registerAngularModule(){var $8Q=DayPilot.am();if(!$8Q){return;};$8Q.directive("daypilotScheduler",function(){return{"restrict":"E","template":"<div id='{{id}};'></div>","compile":function compile(element,$8R){element.replaceWith(this["template"].replace("{{id}};",$8R["id"]));return function link($8S,element,$8R){var $i=new DayPilot.Scheduler(element[0]);$i.$c6.scope=$8S;$i.init();var $8T=$8R["id"];if($8T){$8S[$8T]=$i;};var $8U=$8S["$watch"];$8U.call($8S,$8R["daypilotConfig"],function($5V,$8V){$i.debug.message("daypilot-config value change detected, updating.");$i.$fc($5V);$i.update();$i.$fa();},true);$8U.call($8S,$8R["daypilotEvents"],function($5V){$i.debug.message("daypilot-events value change detected, updating.");$i.events.list=$5V;$i.$aI({"eventsOnly":true});},true);};}};});})();if(typeof Sys!=='undefined'&&Sys.Application&&Sys.Application.notifyScriptLoaded){Sys.Application.notifyScriptLoaded();}})();

if(typeof DayPilot==='undefined'){var DayPilot={};};if(typeof DayPilot.Global==='undefined'){DayPilot.Global={};};(function(){if(typeof DayPilot.Year!=='undefined'){return;};DayPilot.Year=function(id,$a){this.v='1925';var $b=this;this.startDate=new DayPilot.Date();this.cssOnly=true;this.cssClassPrefix=null;this.columns=4;this.cellWidth=20;this.showWeekNumbers=false;this.$i=[];this.$j=function(){this.root.dp=this;this.$k=new DayPilot.Date(this.startDate.toString("yyyy-01-01","en-us"));};this.$l=function($c){if(this.cssClassPrefix){return this.cssClassPrefix+$c;}else{return "";}};this.$m=function(){if(this.showWeekNumbers){return this.cellWidth;};return 0;};this.$n=function(){this.$i=[];var $d=this.columns;var $e=12/$d;this.root.className=this.$l('_main');this.root.style.width=$d*(this.cellWidth*7+this.$m())+'px';for(var y=0;y<$e;y++){for(var x=0;x<$d;x++){var m=y*$d+x;var id=id+"_nav_"+m;var $f=document.createElement("div");$f.id=id;$f.style.float='left';this.root.appendChild($f);var navigator=new DayPilot.Navigator(id);navigator.startDate=this.$k.addMonths(m);navigator.cssOnly=this.cssOnly;navigator.cssClassPrefix=this.cssClassPrefix;navigator.cellWidth=this.cellWidth;navigator.showWeekNumbers=this.showWeekNumbers;navigator.internal.showLinks={};navigator.selectMode='none';navigator.timeRangeSelectedHandling="JavaScript";navigator.onTimeRangeSelected=this.$o;navigator.init();navigator.root.className='';this.$i.push(navigator);};var $g=document.createElement("div");$g.style.clear='left';this.root.appendChild($g);}};this.$o=function($h){alert("clicked: "+$h.day);};this.init=function(){this.root=document.getElementById(id);if(this.root.dp){return;};this.$j();this.$n();};};})();
